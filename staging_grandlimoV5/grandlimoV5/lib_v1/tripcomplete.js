    ...
    apimodel
      ...
      .then(function (detailsresults) {
        if (detailsresults.length > 0) {
          ...
          var wallet_deduction = detailsresults[0].wallet_deduction;
          var bookby = detailsresults[0].bookby;
              ...
              apimodel
                ...
                .then(function (fareresults) {
                  ...
                  try {
                    ...
                    ////console.log("total_fare 1",total_fare);
                    ...
                    ////console.log("total_fare 2",total_fare);
                  ...
                  calculate_discount(q, promocode, total_fare).then(function (
                    fareresults
                  ) {
                    if (
                      (fareresults.passenger_discount > 0 ||
                        fareresults.corporate_discount > 0) &&
                      fareresults.fixed_fare_apply == 0
                    ) {
                    ...
                    var promo_fixed_fare_apply = (promo_fixed_fare_amt = 0);
                    if (
                      fareresults.fixed_fare_apply &&
                      fareresults.fixed_fare_apply == 1 &&
                      airport_type != 1 &&
                      airport_type != 2 &&
                      ...
                      if (
                        fareresults.fixed_fare_amt &&
                        fareresults.fixed_fare_amt > 0
                      ) {
                        var promo_fixed_fare_apply = 1;
                        var promo_fixed_fare_amt = fareresults.fixed_fare_amt;
                        promo_trip_fare = trip_fare;
                        trip_fare = total_fare = promo_fixed_fare_amt;
                        passenger_discount = promo_fixed_fare_amt;
                        total_fare = total_fare - passenger_discount;

                        if (global.settings.fare_calculation_type == 2) {
                          minutes_fare = promo_fixed_fare_amt;
                        } else {
                          distance_fare = promo_fixed_fare_amt;
                        }
                      }
                    }
                    ...
                    console.log(
                      "herrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
                    ...
                    if (
                      ...
                      typeof fixed_estimate_result == "object" &&
                      fixed_estimate_result.estimate_model == model_id &&
                      global.settings.fare_calculation_type == 1
                    ) {
                      //console.log('fixed estimate fare---->innn');

                      var estimate_km = parseFloat(
                        fixed_estimate_result.estimate_km
                      );
                      var estimate_fare = fixed_estimate_result.estimate_fare;
                      var differance_km = distance - estimate_km;
                      if (
                        distance >= estimate_km &&
                        grace_km >= differance_km
                      ) {
                        ...
                        if (
                          parseInt(waiting_minutes) >
                          parseInt(grace_waiting_time)
                        ) {
                    ...
                    try {
                      ...
                      actual_pickup_time = convert_timezone(actual_pickup_time);
                    ...
                    try {
                      ...
                      var details = {
                        ...
                        promo_fixed_fare_apply: parseInt(
                          promo_fixed_fare_apply
                        ),
                        promo_trip_fare: parseFloat(promo_trip_fare),
                      };
                    ...
                    if (wallet_deduction == 1 || bookby == 2) {
                    } else {
                      passenger_wallet_amount = 0;
                    }

                    //console.log(passenger_wallet_amount,'-------------->passenger_wallet_amount1111');
                    //apply fixed promo discount
                    ...
                    if (promo_fixed_fare_apply == 1) {
                                                    ...
                                                    .then(function (
                                                      ...
                                                      apimodel
                                                        ...
                                                        .then(function (
                                                          ...
                                                          message.message =
                                                            req.__(
                                                              "fare_update_by_fixed_promocode"
                                                            ) +
                                                            " Fare : KWD " +
                                                            promo_fixed_fare_amt;
                                                          message.status =
                                                            details;
                                                          message.status = 5;
                                                          deferred.resolve(
                      ...
                      (vip_user == 1 &&
                        passenger_wallet_amount >=
                          global.settings.wallet_advance_limit &&
                        current_time.getTime() < lateral_end_date.getTime() &&
                        global.settings.wallet_enable == 1)
                    ) {
                      //console.log("heree0015");
                      try {
                      ...
                      //console.log(passenger_wallet_amount,'----passenger_wallet_amount2222');
                      ...
                      apimodel.gateway_details(q).then(function (fareresults) {
                        ...
                        fareresults.forEach(function (val) {
                          ...
                          if (pay_mode_id == 3) {
                            pass_gateway_details = fareresults[i];
                          }
                          i++;
                        });
                        ...
                        if (travel_status != 5) {
                          try {
                            ...
                            pay_details.gateway_details.push(
                          ...
                          common.sendPush(
                            passenger_id,
                            req.app.locals.passenger_i18n.__("trip_completed")
                          );

                          apimodel
                            .insert_trip_pay_details(q, details)
                            .then(function (checkresults) {
                              message.message = req.__("trip_completed_driver");
...
function calculate_discount(q, promocode, total_fare) {
  ...
  if (promocode == "") {
    ...
    details.fixed_fare_amt = 0;
    details.fixed_fare_apply = 0;
  ...
  apimodel
    ...
    .then(function (promocoderesults) {
      ...
      //console.log(promocoderesults,"promocode001");
      ...
      if (promocoderesults.length > 0) {
        ...
        var fixed_fare_amt = promocoderesults[0].fixed_fare_amt;
        ...
        apimodel
          ...
          .then(function (packageresults) {
            ...
            if (packageresults.length > 0) {
              ...
              var fixed_fare_apply = packageresults[0].fixed_fare_apply;

              ////console.log("promocode004");

              if (total_applied < promo_limit) {
                if (fixed_fare_apply && fixed_fare_apply == 1) {
                  var valid_fixed_fare = /^\d+$/.test(fixed_fare_amt);
                  if (valid_fixed_fare) {
                    details.fixed_fare_amt = fixed_fare_amt;
                    details.fixed_fare_apply = 1;
                  } else {
                    details.fixed_fare_amt = 0;
                    details.fixed_fare_apply = 0;
                  }
