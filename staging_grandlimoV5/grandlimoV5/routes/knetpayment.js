...
module.exports = function (app) {
              ...
              if (tripdetailsresults.length > 0) {
                ...
                try {
                  ...
                  var fare_calculation_type =
                    tripdetailsresults[0].fare_calculation_type;
                                                    ...
                                                    apimodel
                                                      ...
                                                      .then(function (
                                                        ...
                                                        try {
                                                          ...
                                                          // }
                                                          ////console.log('Passenger Socket Msg', socket_msg);
  ...
  router.get("/wallet_cancel", function (req, res) {
    ...
    console.log("wallet_cancel---->start");
    console.log(req.query);
    console.log("wallet_cancel---->end");
  ...
  router.get("/wallet_success", function (req, res) {
    ...
    var paymentId = req.query.PaymentId;
    apimodel.checkIfPaymentTokenExists(paymentToken).then(function (walletLog) {
...
function update_wallet_failed_logs(
  q,
  passenger_id,
  add_amt,
  negative,
...
/* Sasidharan Nov 3 2022 Added paymentToken and paymentId */
...
function update_gift_card_logs(
  ...
  var insert_array = {
    ...
    trip_id: parseInt(trip_id),
    status_description: "Used giftcard in Knet trip",
