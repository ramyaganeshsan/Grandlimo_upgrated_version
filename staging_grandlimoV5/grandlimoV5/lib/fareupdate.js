...
exports.tripfare_update = function (q, req) {
  ...
  if (validate_error != undefined) {
    ...
    var cardAmount =
      typeof inputParams.card_amount !== "undefined"
        ? inputParams.card_amount
        : 0;
    var cashAmount =
      typeof inputParams.cash_amount !== "undefined"
        ? inputParams.cash_amount
        : 0;
          ...
          if (
            ...
            if (pay_mod_id == 1 || pay_mod_id == 2 || pay_mod_id == 6) {
              ...
              if (
                ...
                await update_wallet_used_amount(
                  q,
                  passenger_id,
                  wallet_amount_used,
                  trip_id
                );
                await update_passenger_pending_amt(
                  q,
                  passenger_id,
                                ...
                                .then(function (checkresults) {
                                  apimodel
                                    ...
                                    .then(function (checkresults) {
                                      ...
                                      common
                                        .update_completed_trip_det(q, trip_id)
                                        .then(function (checkresults) {
                                          ...
                                          //static maps
                                          common
                                            .generate_static_maps(q, trip_id)
                                            .then(function (checkresults) {});
                                                  ...
                                                  try {
                                                    ...
                                                    let couponAmount =
                                                      detailsresults[0]
                                                        .couponAmount;
                                                    let startDate =
                                                      global.settings.couponStartDate
                                                        .toISOString()
                                                        .substring(0, 10);
                                                    let endDate =
                                                      global.settings.couponEndDate
                                                        .toISOString()
                                                        .substring(0, 10);
                                                    let isValidCoupon =
                                                      shared.isCurrentDateBetween(
                                                        startDate,
                                                        endDate
                                                      );
                                                    if (
                                                    ...
                                                    // Sasidharan Jan 17 2025
                                                    details.showCouponBox =
                                                      showCouponBox;
                                                    details.numberOfCoupons =
                                                      numberOfCoupons;
