...
exports.recent_trip_places= function(q,req){
	...
	else
	{
		...
		{
		var passenger_id = inputParams.passenger_id;
		var place_type = inputParams.place_type;
		var pending_fav = 10;
...
exports.get_recent_places= function(q,req){
	...
	else
	{
		...
		console.log("Coming third",placeresults.length);
    		if(placeresults.length > 0)
    		{
    			var details = placeresults;
				console.log("Coming fourth",details);
				message.message = req.__('success');
				message.detail = details;
				message.status = 1;
				deferred.resolve(message);
