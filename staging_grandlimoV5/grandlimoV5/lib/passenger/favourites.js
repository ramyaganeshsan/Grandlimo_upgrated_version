...
exports.get_favourite_list= function(q,req){
	...
	else
	{
		...
		apimodel.get_favourite_list(q,passenger_id).then(function(favourite_results){
				var details =[]
...
exports.delete_favourite= function(q,req){
	...
	else
	{
		...
		apimodel.check_fav_exists_id(q,p_favourite_id).then(function(check_fav){
			if(check_fav.length > 0)
			{
				apimodel.delete_favourites(q,p_favourite_id).then(function(delete_fav){
					//console.log(delete_fav)
					if(delete_fav.result.n == 1)
					{
