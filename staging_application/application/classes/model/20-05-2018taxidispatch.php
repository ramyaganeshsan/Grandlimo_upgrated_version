    ...
    public function get_all_booking_list_all($array)
    {
      ...
      $project_query = array(      array(
                '$project' => array(
                    ...
                    'passenger_wallet_amount'=>array('$ifNull'=>array('$trans.passenger_wallet_amount',0)),
                )
            ));
...
$mat['updatetime_difference'] = array( '$lte' => (int)LOCATIONUPDATESECONDS);
 ...
 public function search_upcoming_trips()
  ...
  $arguments = array(array(
    ...
    {
    $update_trans_array = array('add_amt'=>(double)$post['add_amt'],'pending_amt'=>(double)$pending_pay,'driver_edit_status'=>(int)$driver_edit_status,'actual_paid_amt'=>$actual_paid_amt,'payment_type'=>(int)$payment_type,"dispatcher_fare_edit"=>(int)1);
    }
    else
    {
