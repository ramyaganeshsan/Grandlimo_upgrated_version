  ...
  /*  public function free_driver_list_count($cid = 0)
	...
	*/
	...
	$field_arguments = array(
     ...
     public function admin_push_notification($pushmessage) {
	...
	//wallet Logs
	public function passenger_wallet_logs($keyword = "", $status = "", $company = "", $offset = "", $val = "", $find_count = FALSE)
    {
		$user_createdby                  = $this->userid;
		$keyword       = str_replace("%", "!%", $keyword);
        $keyword       = str_replace("_", "!_", $keyword);
    ...
    public function driver_shift_logs($keyword = "", $status = "",$search_date, $company = "",$offset = "", $val = "", $find_count = FALSE)
    {
        $user_createdby                  = $this->userid;
        $keyword       = str_replace("%", "!%", $keyword);
        $keyword       = str_replace("_", "!_", $keyword);
