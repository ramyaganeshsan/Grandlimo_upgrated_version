...
facebook_secretkey,facebook_share,twitter_share,site_logo FROM " . SITEINFO . " limit 0,1 ";*/
    ...
    {
		$result = $this->mongo_db->find_one(MDB_PASSENGERS,['_id'=> (int)$passid],['_id','name','lastname','salutation','email','profile_image','phone','civilid','civilid_front','civilid_back','civilid_front_thumb','civilid_back_thumb','user_status','login_from','wallet_amount','vip_user']);
       return (!empty($result)) ? $result: [];		
    }
