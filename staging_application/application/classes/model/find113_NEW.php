...
class Model_Find113 extends Model
{
    ...
    public function search_driver_mobileapp($params)
    {
        ...
        $flag            = '';
        $unit_conversion = "";
        $assigned_driver1 = $this->free_availabletaxisearch_list($params['motor_company'], $params['motor_model'], $params['company_id']);
		//echo '<pre>';
        ...
        $result1 = $this->mongo_db->find_one(MDB_MOTOR_MODEL,["_id"=>(int)$params['motor_model']],['priority']);
        //print_r($result1);
        //echo "ssss".
        ...
        $match1['updatetime_difference'] =  ['$lte'=> LOCATIONUPDATESECONDS];
