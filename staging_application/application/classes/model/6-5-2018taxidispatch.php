...
$mat['updatetime_difference'] = array( '$lte' => (int)LOCATIONUPDATESECONDS);
 ...
 public function search_upcoming_trips()
  ...
  $arguments = array(array(
    ...
    $update_trans_array = array('add_amt'=>(double)$post['add_amt'],'pending_amt'=>(double)$pending_pay);
     ...
     public function get_total_sum($operator_id)
    {
        ...
        $currentdate = date('Y-m-01 05:00:00',strtotime(Commonfunction::getCurrentTimeStamp()));
            ...
            $match_array['operator_id']=(int)$operator_id;
                ...
                $arguments = array(array('$match'=>$match_array),array('$lookup'=>array(
                        ...
                        array('$project' => array(
                            ...
                            'tripfare'=>array('$sum'=>array('$trans.fare','$trans.wallet_amount_used','$trans.add_amt'))
                        )),
                        array('$group' => array(
                        '_id'=>'',
