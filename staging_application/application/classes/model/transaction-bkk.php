            ...
            $field_arguments = [              
                [
                    '$project' => [
                        ...
                        'cash_amt' =>['$arrayElemAt'=> ['$fare_detail', 0 ] ],
                        'card_amt' =>['$arrayElemAt'=> ['$fare_detail', 1 ] ],
                        'knet_amt' =>['$arrayElemAt'=> ['$fare_detail', 2 ] ],
                        'add_amt' =>['$arrayElemAt'=> ['$fare_detail', 3 ] ],
                        'pend_amt' =>['$arrayElemAt'=> ['$fare_detail', 4 ] ],
                        'wallet_amt' =>['$arrayElemAt'=> ['$fare_detail', 5 ] ],
                       // 'wallet_amount_used'=>'$trans.wallet_amount_used',
                ...
                [
                    '$group' => [
                       ...
                       //  'pickup_time' => array('$push'=>'$pickup_time'),
                        'total_amount' => ['$sum' => '$fare'],
                        'total_pending_amt' => ['$sum' => '$pending_amt'],
                        'total_cash_amt' => ['$sum' => '$cash_amt.value'],
                        'total_card_amt' => ['$sum' => '$card_amt.value'],
                        'total_knet_amt' => ['$sum' => '$knet_amt.value'],
                        'total_wallet_amt' => ['$sum' => '$wallet_amt.value'],
                        'total_add_amt' => ['$sum' => '$add_amt.value'],
                        'total_count' => ['$sum' => 1]
                    ]
                ],
        ...
        if ($find_count == TRUE) {
           ...
           // $merge_arguments = array_merge($common_arguments, $count_arguments);
            ...
            $field_arguments = [
                ...
                [
                    '$project' => [
                        'fare'=>['$sum'=>['$trans.fare','$trans.wallet_amount_used']],
                       // 'wallet_amount_used'=>'$trans.wallet_amount_used',
                        'pending_amt'=>'$trans.pending_amt',
