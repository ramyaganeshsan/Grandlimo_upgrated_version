            ...
            array('$unwind' => '$model'),
                array(
                    '$project' => array(
                        ...
                        'updatetime_difference' =>  array( '$divide' => array( array('$subtract' =>array(new MongoDate(strtotime($company_current_time)),'$driver_driverinfo.update_date')), 1000)),
  ...
  $arguments = array(array(
    ...
    if(isset($ifCorporateLogExists['tripId'])) {
        ...
        // if($previousAmount != $corporate_amount) {
            ...
            $updateArray = [
                ...
                'updatedAt' => new MongoDate(strtotime($current_date))
            ];
        ...
        if(count($tripInfo) > 0) {
            ...
            $insertArray = [
                ...
                "airport_trip" => 0,
                "createdAt" => new MongoDate(strtotime($current_date)),
   ...
   /* }
    ...
    public function get_total_sum($operator_id)
    {
        ...
        //$match_array = array('pickup_time' => array('$gte' => new MongoDate(strtotime($currentdate))),'travel_status'=>(int)1);
        // if($operator_id != '')
        // {
        //     $match_array['operator_id']=(int)$operator_id;
        // }

        $match_array = array( "\$and" => array( array('pickup_time' => array('$gte' => new MongoDate(strtotime($currentdate)))), array('pickup_time' =>array('$lte' => new MongoDate(strtotime($current_date_last))) ), array('travel_status'=>(int)1 )) );
    ...
    public function check_trip_requests_exits($driver_id)
    {
        ...
        $arguments = array(
            ...
            array(
                '$project' => array(
                    '_id' => 1,
                    'updatetime_difference' => array('$subtract' => array(new MongoDate(strtotime($company_current_time)), '$createdate'))
                )
            ),
            array(
                '$match' => array(
