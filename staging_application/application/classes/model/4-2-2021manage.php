...
//					'city_model_fare' => $cityindex['city_model_fare'],
	...
	*/
	...
	public function all_freetaxi_list($keyword,$offset, $val, $cid = 0, $find_count = FALSE)
    {
		...
		if($keyword != "") {			
			$match_query['taxi.taxi_no'] = new MongoRegex("/$keyword/i");
		}
		//echo "<pre>"; print_r($match_query); exit;
		$common_arguments = array(
			array(
  ...
  /*  public function free_driver_list_count($cid = 0)
	...
	public function all_free_driver_list($keyword,$offset, $val, $cid = 0,$find_count=false)
    {
        $usertype       = $this->usertype;
        $country_id     = $this->country_id;
        $state_id       = $this->state_id;
        ...
        if($keyword != "") {			
			$match_query['name'] = new MongoRegex("/$keyword/i");
		}
		//echo "<pre>"; print_r($match_query); exit;
		$common_arguments = array(
			array(
   ...
   public function delete_id_image($passenger_id)
	...
	public function pending_customer_trips_record($keyword = "", $status = "",$recharge_type="",$start_date="",$end_date="", $company = "", $offset = "", $val = "", $find_count = FALSE)
    {
		...
		$match_query["recharge_type"] = array('$in'=> array(1,2,3,5,7,8) );
...
//echo $start_date.'---'.$end_date;exit;
 ...
 //print_r($result);exit;
    ...
    public function all_driver_rating_list($offset, $val,$find_count=false)
    {
		if($find_count) {
			$ops = array(
