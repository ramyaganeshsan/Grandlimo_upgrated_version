...
//        print_r($match_query);exit;
    ...
    public function limo_sales_report($keyword = "", $status = "",$start_date = "",$end_date = "",$year="",$month="",$company = "",$offset = "", $val = "", $find_count = FALSE)
    {
     ...
     public function daily_sales_report($keyword = "", $status = "",$search_date, $company = "",$offset = "", $val = "", $find_count = FALSE)
    {
        $user_createdby                  = $this->userid;
        $keyword       = str_replace("%", "!%", $keyword);
        $keyword       = str_replace("_", "!_", $keyword);
       ...
       $match_query['pickup_time'] = [
        ...
        $common_arguments = [
            ...
            [
                 '$unwind' =>['path'=>'$fare_detail','preserveNullAndEmptyArrays'=>true]
            ],
            [
                '$match' => $srch_query
            ],
            ...
            $field_arguments = [
                ...
                [
                    '$group' => [
                       ...
                       // //'total_edited_fare' => array('$addToSet'=>'$total_edited_fare'),
