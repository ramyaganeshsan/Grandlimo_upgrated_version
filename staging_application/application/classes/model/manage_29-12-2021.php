...
;
  ...
  /*  public function free_driver_list_count($cid = 0)
	...
	*/
    ...
    public function update_wallet_amount($id,$add_amt,$negative,$notes)
    {
    ...
    public function getuser_details($like, $type)
    {
        ...
        /*if($company_id!=0){
            ...
            $results = $this->mongo_db->find(MDB_PASSENGERS,$condition,array('_id','name','phone','email','wallet_amount'))->sort(array('name'=>1));
            return (!empty($results))?iterator_to_array($results):array();
        //}
    }
