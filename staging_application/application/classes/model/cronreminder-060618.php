...
class Model_Cronreminder extends Model
{
	...
	public function get_notification_passengers_list(){			
            ...
            $field_arguments = array(
                array(
                      '$match'=>array('notification_status' => 0, 'user_status'=>'A','device_type'=>array('$in'=>['1','2']),'device_token'=>array('$ne'=>''))
                    ),
    ...
    public function update_passenger_status($passengers_ids){
	      ...
	      if(count($passengers_ids)){
	            ...
	            $result = $this->mongo_db->update(MDB_PASSENGERS,array('_id'=>array('$in'=>$passengers_ids)),array('$set'=>array('notification_status' => 1)),array('multiple'=>true) );
	      }
    }
