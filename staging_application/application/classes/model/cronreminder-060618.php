...
class Model_Cronreminder extends Model
{
	...
	public function get_notification_passengers_list(){			
            ...
            $field_arguments = [
                [
                      '$match'=>['notification_status' => 0, 'user_status'=>'A','device_type'=>['$in'=>['1','2']],'device_token'=>['$ne'=>'']]
                    ],
    ...
    public function update_passenger_status($passengers_ids){
	      ...
	      if(count($passengers_ids)){
	            ...
	            $result = $this->mongo_db->update(MDB_PASSENGERS,['_id'=>['$in'=>$passengers_ids]],['$set'=>['notification_status' => 1]],['multiple'=>true] );
	      }
    }
