...
Class Model_Cms extends Model
{
    ...
    public function get_model_list(){
        ...
        $arguments = [['$match'=>['model_status'=> 'A']],
                               ['$project'=>[
                                    ...
                                    'category_name'=>'$category_name',
                                    'airport_pickup_fare'=>['$ifNull'=>['$airport_pickup_fare','']],
                                    'airport_drop_fare'=>['$ifNull'=>['$airport_drop_fare','']],
    ...
    public function get_home_page_drivers(){
        ...
        $lang=isset($_SESSION['lang'])?$_SESSION['lang']:"en";
        if($lang=='ar'){           
            $description = ['$ifNull'=>['$driver_description_arabic','']];
        }else{           
            $description = ['$ifNull'=>['$driver_description','']];
        }

        $arguments = [
            ['$match'  => ['website_show' => 1, 'user_type' => 'D']],
            [
                '$project' => [
                    'id' => '$_id',
                    'name'=>'$name',
    ...
    public function get_testimonials(){
        ...
        $lang=isset($_SESSION['lang'])?$_SESSION['lang']:"en";
        if($lang=='ar'){           
            $description = ['$ifNull'=>['$description_arabic','']];
        }else{           
    ...
    public function get_website_page_content($type=''){
        ...
        if($type=='home_page'){
            ...
            if($lang=='ar'){ 
                ...
                $project = ['banner_content'=>'$pricing_page.banner_content_arabic','pricing'=>'$pricing_page.pricing_arabic','pricing_description'=>'$pricing_page.pricing_description_arabic'];          
               
            }else{           
                $project = ['banner_content'=>'$pricing_page.banner_content','pricing'=>'$pricing_page.pricing','pricing_description'=>'$pricing_page.pricing_description'];
            }
            ...
            if($lang=='ar'){ 
                ...
                $project = ['banner_content'=>'$careers_page.banner_content_arabic','career'=>'$careers_page.career_arabic','career_description'=>'$careers_page.career_description_arabic'];          
               
            }else{           
                $project = ['banner_content'=>'$careers_page.banner_content','career'=>'$careers_page.career','career_description'=>'$careers_page.career_description'];
            }
            ...
            if($lang=='ar'){ 
                ...
                $project = ['content'=>'$about_us_page.content_arabic'];          
               
            }else{           
                $project = ['content'=>'$about_us_page.content'];
            }
            ...
            if($lang=='ar'){ 
                ...
                $project = ['content'=>'$terms_and_conditions_page.content_arabic'];          
               
            }else{           
                $project = ['content'=>'$terms_and_conditions_page.content'];
            }
            ...
            if($lang=='ar'){ 
                ...
                $project = ['confirm_title'=>'$confirm_page.confirm_title_arabic','confirm_description'=>'$confirm_page.confirm_description_arabic','confirm_contact_us'=>'$confirm_page.confirm_contact_us_arabic'];          
               
            }else{           
                $project = ['confirm_title'=>'$confirm_page.confirm_title','confirm_description'=>'$confirm_page.confirm_description','confirm_contact_us'=>'$confirm_page.confirm_contact_us'];
            }
    ...
    public function get_website_certificate(){
        ...
        $lang=isset($_SESSION['lang'])?$_SESSION['lang']:"en";
        if($lang=='ar'){           
            $certificate_name = ['$ifNull'=>['$certificate_name_arabic','']];
            $certificate_description = ['$ifNull'=>['$certificate_description_arabic','']];            
        }else{           
            $certificate_name = ['$ifNull'=>['$certificate_name','']];
            $certificate_description = ['$ifNull'=>['$certificate_description','']];            
        }


        $field_arguments = [      
                                    ['$project' => ['certificate_name'=>$certificate_name,'certificate_description'=>$certificate_description,'image'=>'$image','status'=>'$status'] ],
                                    ['$match' => ['status'=> 1] ],                              
                                    ['$limit' => 3]
                            ];          
    ...
    {   $arr['pickup_date'] = $arr['p_date'];
       ...
       return Validation::factory($arr)
                ...
                ->rule('pickup_date_time', 'Model_Cms::check_date_valid', [':value'])
    ...
    public function save_booking_request($post=[]){
        ...
        $pass_condition = ['phone'=>$post['phone'],'country_code'=>$post['country_code']]; //(!empty($post['email'])) ? array('email'=>$post['email'],'phone'=>$post['phone']) : array('phone'=>$post['phone']);
