...
"airport_type"=>'$airport_type',
    ...
    public function get_driver_current_status($id, $company_id = '')
    {
        ...
        //print_r($result);              
        return $result;*/
		$res = $this->mongo_db->find(MDB_DRIVER_INFO,array('_id'=>(int)$id),array('status', 'loc.coordinates'))->sort(array('_id'=>1));
		$result = iterator_to_array($res);
		return (isset($result)? reset($result) :array());  
    }
...
public function update_dropstatus_trippaydetails($id, $drop_latitude, $drop_longitude, $drop_location)
    ...
    public function update_wallet_without_log($id,$add_amt,$negative,$trip_id)
    {
        $result = $this->mongo_db->find_one(MDB_PASSENGERS,array('_id' => (int)$id),array('wallet_amount'));
