...
define("COUPON_STATUS", $result['couponStatus']);
define("COUPON_START_DATE", $result['couponStartDate']);
define("COUPON_END_DATE", $result['couponEndDate']);
define("COUPON_REDEEN_AMOUNT", $result['couponRedeemAmount']);
...
//DEFINE('GOOGLE_MAP_API_KEY', "AIzaSyBse91pUlY1yIXAydiq2DJ_kout5zHz4Dw");
//DEFINE('GOOGLE_GEO_API_KEY',"AIzaSyCO-f2RoRqVdpYSuMwG6a9wuYwv_wcDQug");
//DEFINE('GOOGLE_GEO_API_KEY', "AIzaSyDdydGR3q3bHXv8MC95xhpEYFqxP1SvmPA");

DEFINE('GOOGLE_GEO_API_KEY', "AIzaSyBxP4UEHJFGCbF-1inY3w79p1Kj95swe8Y");
//DEFINE('GOOGLE_MAP_API_KEY',"AIzaSyDdydGR3q3bHXv8MC95xhpEYFqxP1SvmPA");
DEFINE('GOOGLE_MAP_API_KEY',"AIzaSyBxP4UEHJFGCbF-1inY3w79p1Kj95swe8Y");
//AIzaSyBqFaslJcZDVDv1NbUc6yNESe0YOUhknQw
DEFINE('GOOGLE_CLIENT_KEY',"gme-caesarsforwebsite");
...
define("CORPORATEVIEW", "corporate/");
define("VIEW_PATH", "pages/");
define("SCRIPTPATH", URL_BASE . "public/js/");
define("REPLACE_PARENTID","##PARENTID##");
...
define("TRIP_FARE_NOTIFICATION_EMAILS" , $result['trip_fare_notification_emails']);

define("COMMON_ANDROID_PASSENGER_APP", $result['android_passenger_app_url']);
define("COMMON_IOS_PASSENGER_APP", $result['ios_passenger_app_url']);
define("COMMON_ANDROID_DRIVER_APP", 'https://play.google.com/store/apps/details?id=com.taximobility.driver');
define("CUS_ANDROID_KEY", $result['customer_android_key']);
define("DRI_ANDROID_KEY", $result['driver_android_key']);
define("TAB_ANDROID_KEY", $result['tab_android_key']);

/* Sasidharan june 20 2022 */
define("REGISTER_PROMOCODE",isset($result['register_promocode']) ? Commonfunction::convertphpdate('Y-m-d H:i:s',$result['register_promocode']) : "");

/* Sasidharan Feb 07 2022 */
define("SURGE_PRICE_ON_WEEK_DAYS", isset($result['surge_on_week_days']) ? json_encode($result['surge_on_week_days']) : []);

/*** Gift Card Configuration */
define( "GIFT_CARD_URL", isset( $result["gift_card_url"] ) ? $result["gift_card_url"] : '');
define( "GIFT_CARD_TOKEN", isset( $result["gift_card_token"] ) ? $result["gift_card_token"] : '');
define( "GIFT_CARD_STORE", isset( $result["gift_card_store_id"] ) ? $result["gift_card_store_id"] : '');
define( "GIFT_CARD_VENDOR", isset( $result["gift_card_vendor_id"] ) ? $result["gift_card_vendor_id"] : '');
define( "GIFT_CARD_ENABLE", isset( $result["gift_card_enable"] ) ? $result["gift_card_enable"] : 0);


// CRON_DISPATCH_TIME_INTERVAL // 
define("CRON_DISPATCH_TIME_INTERVAL", $result['cron_dispatch_time_interval']);
// CRON_DISPATCH_TIME_INTERVAL //
...
define("REPLACE_DRIVER_CODE", "##DRIVER_CODE##");
...
define('VIDEOPATH', 'public/video/');
define('SITE_LOGO_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . SITE_LOGOIMG);
define('SITEAD_IMG', "sitead_image/");
define('SITEAD_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . SITEAD_IMG);
define('BANNER_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . BANNER_IMG);
/// Slider Settings ////
define('HOME_SLIDER_IMG', "slider/home_slider/");
define('MOBILE_SLIDER_IMG', "slider/mobile_slider/");
define('HOME_SLIDER_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . HOME_SLIDER_IMG);
define('MOBILE_SLIDER_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . MOBILE_SLIDER_IMG);
/// Slider Settings ////
define('TAXI_IMG', "taxi_image/");
define('MODEL_IMG', "model_image/");
define('COMPANY_IMG', "company/");
define('TAXI_IMG_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . TAXI_IMG);
define('MODEL_IMG_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . MODEL_IMG);
...
define('PASS_CIVIL_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . PASS_IMG . 'civilid/');
...
define('CIVIL_THUMBIMG_WIDTH',150);
define('CIVIL_THUMBIMG_HEIGHT',150);
...
define('MODEL_THUMBIMG_WIDTH', 100);
define('MODEL_THUMBIMG_HEIGHT', 100);
define('ICONIC_THUMBIMG_WIDTH', 180);
define('ICONIC_THUMBIMG_HEIGHT', 100);
define('SITE_LOGO_WIDTH', 190);
define('SITE_LOGO_HEIGHT', 50);
...
define('CORPORATE_IMG', "corporate_image/");

define('SITE_DRIVER_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . DRIVER_IMG);
define('SITE_CORPORATE_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/' . CORPORATE_IMG);
//Taxi Dispatch
...
define('CURRENCY', $default_currency['currency_symbol']);
define('CURRENCY_FORMAT', $default_currency['currency_code']);
define('REC_PER_PAGE', $result['pagination_settings']);
define('FARE_SETTINGS', $result['price_settings']);
define('ADMIN_NOTIFICATION_TIME', $result['notification_settings']);
define('DISPATCHER_NOTIFICATION_TIME', $result['dispatcher_notification_time']);
define('CONTINOUS_REQUEST_TIME', $result['continuous_request_time']);
define('FB_KEY', $result['facebook_key']);
define('DEFAULT_COUNTRY', $result['site_country']);
define('DEFAULT_STATE', $result['site_state']);
define('DEFAULT_CITY', $result['site_city']);
define('APP_DESCRIPTION', $result['app_description']);
define('TOTAL_RATING', 5);
define('REMINDER_TIME', 1);
define('ADMIN_COMMISSON', $result['admin_commission']);
define('MOB_API_URL', $result['mobile_api_url']);
define('TAX', $result['tax']);
define('MIN_FUND', "");
define('MAX_FUND', "");
define('SITE_NAME', $result['app_name']);
define('SITE_COPYRIGHT', $result['site_copyrights']);
define('BOOK_LATERAL_TIME', $result['book_later_time']);
define('FB_SHARE', $result['facebook_share']);
define('TW_SHARE', $result['twitter_share']);
define('GOOGLE_SHARE', $result['google_share']);
define('LINKEDIN_SHARE', $result['linkedin_share']);
define('SMS', $result['sms_enable']);
define('DRIVER_TELL_TO_FRIEND_MESSAGE', $result['driver_tell_to_friend_message']);
define('REFERRAL_DISCOUNT', $result['referral_discount']);
define('SITE_EMAIL_CONTACT', $result['email_id']);
define('SHOW_MAP', $result['show_map']);
define('TAXI_CHARGE', $result['taxi_charge']);
define('SITE_FARE_CALCULATION_TYPE', $result['fare_calculation_type']);
define('BOOK_BY_PASSENGER', 1);
define('BOOK_BY_CONTROLLER', 2);
define('CURRENCY_SYMB', $default_currency['currency_symbol']);
define('REPLACE_COMPANYNAME', '##COMPANYNAME##');
define('REPLACE_COMPANYDOMAIN', '##COMPANYDOMAIN##');
define('LOCATIONUPDATESECONDS', 15);
define('DEFAULTMILE', 50);
define('DEFAULT_DRIVER_MILE', 3);
define('TRAILEXPIRY', 10);
define('DEFAULT_CONNECTION', 'default');

define('SMSBOX_USERNAME',$result['smsbox_username']);
define('SMSBOX_PASSWORD',$result['smsbox_password']);
define('SMSBOX_CUSTOMER_ID',$result['smsbox_customerid']);
define('SMSBOX_SENDERTXT',$result['smsbox_senderid']);
...
define('TAXI_PARKING_CHARGE', $result['airport_parking_charge']);
define('TWILIO_ACCOUNT_SID', $result['twilio_accout_sid']);
define('TWILIO_AUTH_TOKEN', $result['twilio_auth_token']);
define('TWILIO_NUMBER', $result['twilio_number']);
define('KNET_RESPONSE_URL',$payment_knet['knet_response_url'] );
define('KNET_ERROR_URL', $payment_knet['knet_error_url']);
define('KNET_RESOURCE_PATH',$_SERVER['DOCUMENT_ROOT'].$payment_knet['knet_resource_path']);
define('KNET_ALIAS',$payment_knet['knet_alias']);
/* changes on 19-may-2016 */

///////////SERVICE///////////
define("REPLACE_KM", "##KM##");
define("REPLACE_LABEL", "##LABEL##");
define("REPLACE_BOOKING_KEY", "##BOOKING_KEY##");
///////////SERVICE///////////

define('ADDRESS_ONE', $result['address_one']);
define('ADDRESS_ONE_ARABIC', $result['address_one_arabic']);
define('ADDRESS_TWO', $result['address_two']);
define('ADDRESS_TWO_ARABIC', $result['address_two_arabic']);
define('WEB_COUNTRY', $result['country']);
define('WEB_COUNTRY_ARABIC', $result['country_arabic']);
define('WEB_EMAIL_CONTACT', $result['web_email_contact']);
define('WEB_PHONE', $result['web_phone']);


//03 Feb 2020
$surge_pricing = isset($result['surge_pricing']) ? $result['surge_pricing'] : 0;
define('SURGE_PRICING', $surge_pricing);
//03 Feb 2020


$subdomainname = '.' . $_SERVER["HTTP_HOST"];
define("SUB_DOMAIN_NAME", $subdomainname);
define("DOMAIN_NAME", 'q8grandlimo.com');
define("DOMAIN_URL_NAME", 'www.q8grandlimo.com');
$url = URL_BASE;
$url = "http://www.q8grandlimo.com";
//$url="http://512rides.taximobility.com";
//$subdomain = getUrlSubdomain($url);
$subdomain = "q8grandlimo";
define("SUBDOMAIN", $subdomain);
//define("LIVECHATSTATUS","0");
if ($_SERVER["HTTP_HOST"] == DOMAIN_URL_NAME) {
    // TO get the livechat status		 
    $url = "https://api.livechatinc.com/status";
    $ch  = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_USERPWD, "nandakumar@ndot.in:23e139ff7346643fa378d302277dbe0f");
...
if (COMPANY_CID != 0) {
    ...
    $email_logo = URL_BASE . SITE_LOGO_IMGPATH . '/email_site_logo.png';
}
...
if (COMPANY_CID != 0) {
    ...
    $ops = array(
        ...
        array('$project' =>
            array('_id' => 0,
                ...
                'company_twitter_share' => '$cdetails.companyinfo.company_twitter_share',
                'company_google_share' => '$cdetails.companyinfo.company_google_share',
                'company_linkedin_share' => '$cdetails.companyinfo.company_linkedin_share',
                'customer_app_url' => '$cdetails.companyinfo.customer_app_url',
                'company_app_name' => '$cdetails.companyinfo.company_app_name',
                'driver_app_url' => '$cdetails.companyinfo.driver_app_url',
                'company_api_key' => '$cdetails.companyinfo.company_api_key',
                'company_facebook_key' => '$cdetails.companyinfo.company_facebook_key',
                'company_facebook_secretkey' => '$cdetails.companyinfo.company_facebook_secretkey',
                'company_notification_settings' => '$cdetails.companyinfo.company_notification_settings',
                'company_name' => '$cdetails.companydetails.company_name',
                'header_bgcolor' => '$cdetails.companydetails.header_bgcolor',
                'menu_color' => '$cdetails.companydetails.menu_color',
                'mouseover_color' => '$cdetails.companydetails.mouseover_color',
                'company_phone_number' => '$cdetails.companyinfo.company_phone_number',
                'company_meta_title' => '$cdetails.companyinfo.company_meta_title',
                'company_meta_keyword' => '$cdetails.companyinfo.company_meta_keyword',
                'company_meta_description' => '$cdetails.companyinfo.company_meta_description',
                'company_copyrights' => '$cdetails.companyinfo.company_copyrights',
                'default_unit' => '$cdetails.companyinfo.default_unit',
                'skip_credit_card' => '$cdetails.companyinfo.skip_credit_card',
                'fare_calculation_type' => '$cdetails.companyinfo.fare_calculation_type',
                'company_app_description' => '$cdetails.companyinfo.company_app_description',
                'cancellation_fare' => '$cdetails.companyinfo.cancellation_fare',
                'name' => '$name',
                'lastname' => '$lastname',
                'email' => '$email',
                'address' => '$address',
   ...
   //print_r($res['result'][0]); echo '</pre>';exit;
    $rs = $res['result'][0];
    define("COMPANY_LOGO_URL_PATH", URL_BASE . PUBLIC_UPLOADS_FOLDER . '/' . SITE_LOGOIMG . '/' . $rs['company_logo'][0]);
    define("COMPANY_LOGO_FILE_PATH", DOCROOT . PUBLIC_UPLOADS_FOLDER . '/' . SITE_LOGOIMG . '/' . $rs['company_logo'][0]);
    define("COMPANY_LOGO_NAME", $rs['company_logo'][0]);
    define("COMPANY_FAV_URL_PATH", URL_BASE . PUBLIC_UPLOADS_FOLDER . '/' . FAVICON_IMG . '/' . $rs['company_favicon'][0]);
    define("COMPANY_FAV_FILE_PATH", DOCROOT . PUBLIC_UPLOADS_FOLDER . '/' . FAVICON_IMG . '/' . $rs['company_favicon'][0]);
    define("COMPANY_FAV_NAME", $rs['company_favicon'][0]);
    define("COMPANY_APP_NAME", $rs['company_app_name'][0]);
    define("COMPANY_FACEBOOK_LINK", $rs['company_facebook_share'][0]);
    define("COMPANY_TWITTER_LINK", $rs['company_twitter_share'][0]);
    define("COMPANY_GOOGLE_LINK", $rs['company_google_share'][0]);
    define("COMPANY_LINKED_LINK", $rs['company_linkedin_share'][0]);
    define("COMPANY_CUSTOMER_APP_URL", $rs['customer_app_url'][0]);
    define("COMPANY_DRIVER_APP_URL", $rs['driver_app_url'][0]);
    define("COMPANY_API_KEY", $rs['company_api_key'][0]);
    define("COMPANY_FB_KEY", $rs['company_facebook_key'][0]);
    define("COMPANY_FB_SECRET", $rs['company_facebook_secretkey'][0]);
    define("COMPANY_NOTIFICATION_TIME", $rs['company_notification_settings'][0]);
    define("COMPANY_NAME", $rs['company_name'][0]);
    define("COMPANY_HEADER_BGCOLOR", $rs['header_bgcolor'][0]);
    define("COMPANY_HEADER_MENUCOLOR", $rs['menu_color'][0]);
    define("COMPANY_HEADER_MOUSEOVERCOLOR", $rs['mouseover_color'][0]);
    define("COMPANY_CONTACT_PHONE_NUMBER", $rs['company_phone_number'][0]);
    define("COMPANY_META_TITLE", $rs['company_meta_title'][0]);
    define("COMPANY_META_KEYWORD", $rs['company_meta_keyword'][0]);
    define("COMPANY_META_DESCRIPTION", $rs['company_meta_description'][0]);
    define("COMPANY_COPYRIGHT", $rs['company_copyrights'][0]);
    define("COMPANY_SITENAME", $rs['company_app_name'][0]);
    define("DEFAULT_UNIT", $rs['default_unit'][0]);
    define("DEFAULT_SKIP_CREDIT_CARD", $rs['skip_credit_card'][0]);
    define("COMPANY_FARE_CALCULATION_TYPE", $rs['fare_calculation_type'][0]); //
    define("COMPANY_CURRENCY", $company_curency_symbol); //eg: $
    define("COMPANY_CURRENCY_FORMAT", $company_curency_code); //eg: USD
    define("TELL_TO_FRIEND_MESSAGE", $rs['company_app_description'][0]);
   // define("CANCELLATION_FARE", $rs['cancellation_fare'][0]);
     define("CANCELLATION_FARE", $result['cancellation_fare_setting']);
    define("COMPANY_FIRST_NAME", $rs['name']);
    define("COMPANY_LAST_NAME", $rs['lastname']);
    define("COMPANY_CONTACT_EMAIL", $rs['email']);
    define("COMPANY_STREET_ADDR", $rs['address']);
    define("COMPANY_LOGIN_CITY", isset($rs['login_city']) ? $rs['login_city'] : DEFAULT_CITY);
    define("COMPANY_LOGIN_STATE", isset($rs['login_state']) ? $rs['login_state'] : DEFAULT_STATE);
    define("COMPANY_LOGIN_COUNTRY", isset($rs['login_country']) ? $rs['login_country'] : DEFAULT_COUNTRY);
    ...
    if(!empty(COMPANY_LOGIN_CITY) && !empty(COMPANY_LOGIN_STATE) && !empty(COMPANY_LOGIN_COUNTRY)){
        ...
        define("COMPANY_ZIPCODE", $result[0]['zipcode']);
        define("COMPANY_LOGIN_STATE_NAME", $result[0]['state_name']);
        define("COMPANY_LOGIN_ISO_COUNTRYCODE", $result[0]['iso_country_code']);
    }
} else {
    ...
    define('TELL_TO_FRIEND_MESSAGE', $result['tell_to_friend_message']);
    define("DEFAULT_UNIT", $result['default_unit']);
    define("DEFAULT_SKIP_CREDIT_CARD", $result['skip_credit_card']);
    define("COMPANY_CURRENCY", CURRENCY);
    define("CANCELLATION_FARE", $result['cancellation_fare_setting']);
    define("COMPANY_COPYRIGHT", SITE_COPYRIGHT);
    define("CONTACT_EMAIL", SITE_EMAIL_CONTACT);
    define("SITE_FAVICON", $result['site_favicon']);
}
...
function currency_conversion($company_currency, $amt)
{
    try {
        return $amt;
        /*$from   = $company_currency; /*change it to your required currencies *
        $to     = CURRENCY_FORMAT;
        if($from != $to)
        {
...
if (COMPANY_CID != 0) {
     //$res = $mongodb->find(MDB_PACKAGE_REPORT,array('upgrade_companyid'=>(int)COMPANY_CID),array('upgrade_packageid','upgrade_companyid'))->sort(array('_id'=>-1))->limit(1);    
    //$result = (!empty($result))?iterator_to_array($res):array();
    //if (count($result) > 0) {
       // $resultSet = recursive_array_search($result,'upgrade_companyid',COMPANY_CID);
        //if ($resultSet[0]['upgrade_packageid'] == PAID_PACKAGE) { //6 as PAID PACKAGE
...
function recursive_array_search($array, $key, $value)
{
    ...
    if (is_array($array)) {
        ...
        foreach ($array as $subarray) {
            $results = array_merge($results, recursive_array_search($subarray, $key, $value));
        }
    }
    return $results;
}

define('CURRENCY_NEW', ' KD');
define('NOTIFY_IMG_IMGPATH', PUBLIC_UPLOADS_FOLDER . '/notification_image');
// define('NODE_URL', 'http://35.184.206.12:4000');
define('NODE_URL', 'http://34.28.184.113:4000');
define('TAXI_DISPATCH_NODE', "admin/taxi_dispatch_node/");
define('CERTIFICATE_PATH', PUBLIC_UPLOADS_FOLDER . '/certificates/');
