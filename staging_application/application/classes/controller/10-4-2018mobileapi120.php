                                ...
                                $trip_details['paid_amt'] = round($paid_amt,2);
                                 ...
                                 $trip_id = $journey['passengers_log_id'];
                                     if (file_exists(DOCROOT.PUBLIC_UPLOADS_FOLDER.'/static_maps/'.$trip_id.'.png')) {
                                        ...
                                        $mapurl   = "http://maps.googleapis.com/maps/api/staticmap?size=".MAP_WIDTH."x".MAP_HEIGHT."&markers=color:red%7C$marker_start&markers=color:green%7C$marker_end";
                                    ...
                                    if($airport_pickup!=1){
                                      ...
                                      foreach($gateway_details as $k => $g){
                                        ...
                                        */
                                        ...
                                        if(($passenger_wallet >= $total_fare && $passenger_wallet != 0) || ($vip_user == 1 && $passenger_wallet <= WALLET_ADVANCE_LIMIT))
                                        {
                ...
                case 'tripfare_update':
                    ...
                    if ($validator->check()) {
                       ...
                       // $paid_amt                  = $array['paid_amt'];
                        //s$edit_status               = $array['edit_status'];
