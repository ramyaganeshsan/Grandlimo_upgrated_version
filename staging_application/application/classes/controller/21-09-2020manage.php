        ...
        if ($signup_submit) {
            ...
            if ($validator->check()) { 
                ...
                if (!empty($_FILES['notification_image']['name'])) {
                    ...
                    $path1            = $image_name;
                    Commonfunction::imageresize($logo_image,720,1280, $path11."720*1280/", $image_name, 90);                    
                    Commonfunction::imageresize($logo_image,480,800, $path11."480*800/", $image_name, 90);                    
                    Commonfunction::imageresize($logo_image,320,480, $path11."320*480/", $image_name, 90);                    
                    Commonfunction::imageresize($logo_image,240,320, $path11."240*320/", $image_name, 90);                    

                }

                $notification_status = $this->manage_model->admin_add_notification($pushmessage,$image_name,$template,$title,$sub_title,$start_date,$expire_date,$image_only);
