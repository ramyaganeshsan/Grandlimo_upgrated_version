 ...
 public function action_ratings()
 ...
 
    {
        ...
        if (isset($_REQUEST['keyword'])) {
            ...
            $count_company_list = $this->manage_model->passenger_wallet_logs(trim(Html::chars($_REQUEST['keyword'])), trim(Html::chars($_REQUEST['status'])),$recharge_type, $company,NULL,NULL,TRUE);
        }
        else
        {
        ...
        if (isset($_REQUEST['keyword']))
        {
            $all_company_list = $this->manage_model->passenger_wallet_logs(trim(Html::chars($_REQUEST['keyword'])), trim(Html::chars($_REQUEST['status'])),$recharge_type, $company, $offset, REC_PER_PAGE);
        }
        else
        {
