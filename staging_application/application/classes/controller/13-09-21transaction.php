    ...
    public function action_sales_report()
    {
       ...
       // $availabilitycount         = $this->add_model->validate_packagedriver($cid);
        ...
        if (isset($_REQUEST['keyword'])) {
            ...
            $count_unused_list = $this->transaction_model->passengers_unused_wallet_report(trim(Html::chars($_REQUEST['keyword'])), trim(Html::chars($_REQUEST['status'])),$start_date,$end_date,$company,NULL,NULL,TRUE);

        }
        else
        {
           $count_company_list = $this->transaction_model->sales_report('','',$start_date,$end_date,'',NULL,NULL,TRUE);  
           $count_unused_list = $this->transaction_model->passengers_unused_wallet_report('','',$start_date,$end_date,'',NULL,NULL,TRUE);  
