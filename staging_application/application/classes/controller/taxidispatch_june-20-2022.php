...
?>" id="no_passengers" />
	...
	$bk_type = isset($_GET['bk_t']) ? $_GET['bk_t'] : "";
		...
		if(isset($listings['dispatch_time']) && $listings['dispatch_time']!=''){
                ...
                $op[] .= '<td width="7%"><span>' . ucfirst($passenger_name).'<br/>'.$pass_notes_img.'</span>'.$passenger_pending_amt_txt.$passenger_corporate_name_text.'</td>';
               /* if ($this->usertype == "A") {
