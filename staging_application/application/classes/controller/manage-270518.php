 ...
 public function action_ratings()
 ...
 
    {
        ...
        // }
            ...
            {
                $all_company_list = $this->manage_model->passenger_wallet_logs(trim(Html::chars($keyword)), trim(Html::chars($status)),$recharge_type,$start_date,$end_date, $company,0,1000);
