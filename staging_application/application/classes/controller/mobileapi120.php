               ...
               // $get_passenger_log_details = $api->get_passenger_log_detail('249');
                ...
                if ($array['id'] != null) {
                        ...
                        if($current_lat!='' && $current_lng=!''){
                            ...
                            $message = ["message" => __('success'),"detail"=>$get_recent,"status"=>1];
                ...
                if ($array['id'] != null) {
                        ...
                        if(count($get_promo)){
                            ...
                            $message = ["message" => __('success'),"detail"=>$get_promo,"status"=>1];

                        }else{

                            $message = ["message" => __('no promocode available'),"status"=>-1];
                        }
                    ...
                    if($check_promo==2){
                        ...
                        if ($check_promo == 0) {
                            ...
                            if($added==1){
                                 ...
                                 $msg = ["message" => __('promo_applied_successfully'),"status" => 1];                                

                            }else{

                                $msg = ["message" => __('promocode_not_found'),"status" => -1];
                            }
                ...
                if ($passenger_id!='') {
                    ...
                    $promo_list = $api->get_added_promocodes($passenger_id);
                        ...
                        if(count($promo_list)){
                            ...
                            $message = ["message" => __('success'),"detail"=>$promo_list,"status"=>1];

                        }else{

                            $message = ["message" => __('no_promocode_available'),"status"=>-1];
                        }
                ...
                case 'get_passenger_notifications':
                    ...
                    if(count($notification_list)){
                        ...
                        $message = ["message" => __('push_messags'),"notifications"=>$notification_list,"status" => 1];

                    }else{                    

                        $message = ["message" => __('no_notification'),"status" => -1];
                    }
                    echo json_encode($message);
                    break;
                ...
                if($trip_id!='' && $drop_location!='' && $drop_latitude !='' && $drop_longitude!='') {
                    ...
                    $update_data = ['trip_id'=>$trip_id,'drop_location'=> urldecode($drop_location),'drop_latitude'=>$drop_latitude,'drop_longitude'=>$drop_longitude];
                    $res = $api->passenger_update_drop_location($update_data);

                    if($res==1){

                         $message = ["message" => __('drop_location_update_sucessfully'),"status" => 1];

                    }else if($res==2){

                         $message = ["message" => __('trip_not_found'),"status" => -1];

                    }else if($res==3){

                         $message = ["message" => __('drop_location_already_update'),"status" => -1];

                    }else{

                         $message = ["message" => __('connection_error'),"status" => -1];
                    }
                }else{
                     $message = ["message" => __('invalid_drop_location'),"status" => -1];
                }
                echo json_encode($message);
                break;
