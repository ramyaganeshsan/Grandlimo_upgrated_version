 ...
 
    {
        ...
        else
        {
            ...
            if(isset($_SESSION['download_set']))
            {
                ...
                $export_table_header = [__('passenger_name'),__('passenger_phone'),__('current_wallet_amt'),__('amount_credit'),__('amount_debit'),__('recharge_type'),__('created_date')];
                $export_table_field_select = ['passenger_name','passenger_phone','wallet_amount','amount_credit','amount_debit','recharge_type','created_date'];
