...
$iosmessage = '';
                ...
                case 'add_favourite':
                    ...
                    if ($validator->check()) {
                        ...
                        $p_fav_locationtype = trim($add_fav_array['p_fav_locationtype']);
                ...
                case 'check_passenger_trip':
                   ...
                   case 'savebooking': // As Per Mongo DB Conversion
                    ...
                    if ($validator->check()) {
                        ...
                        if($passenger_wallet < WALLET_NEGATIVE_LIMIT)
                        {
                             $msg = array(
...
$intq = array(
                        ...
                        if ($search_array['latitude'] != '0' && $search_array['longitude'] != '0') {
                            ...
                            if ($total_count > 0) {
                                ...
                                $new_detail[$newcnt1]['bearing'] = (double)$driver_details[$newcnt1]['_id']['bearing'];
    ...
    $taxi_manufacturer  = (isset($get_passenger_log_details[0]['taxi_manufacturer']) ? $get_passenger_log_details[0]['taxi_manufacturer'] :0);
                               ...
                               $trip_details['waiting_time_mins'] = $trip_details['waiting_time'] * 60;
                                ...
                                $trip_details['paid_amt'] = round($paid_amt,2);
                                 ...
                                 $trip_id = $journey['passengers_log_id'];
                                     if (file_exists(DOCROOT.PUBLIC_UPLOADS_FOLDER.'/static_maps/'.$trip_id.'.png')) {
                                        ...
                                        {
                                            $mapurl   = "https://maps.googleapis.com/maps/api/staticmap?size=".MAP_WIDTH."x".MAP_HEIGHT."&markers=icon:".URL_BASE."ic.png?s=32%26d=identicon%26r=PG|$marker_start&markers=icon:".URL_BASE."ic.png?s=32%26d=identicon%26r=PG|$marker_end";
            ...
            unset(MangoDB::$instances['default']);
                ...
                case 'getpassenger_update':
                            ...
                            else
                            {
                               $driver_image = URL_BASE . "/public/images/noimages109.png";
                                ...
                                if (count($current_driver_status) > 0) {
                                    ...
                                    $bearing       = $current_driver_status['bearing'];
 				   ...
 				   if($remove_later == 1)
                                   {
                                       $pay_types = isset($trip_pay_details['gateway_details'])?$trip_pay_details['gateway_details']:array();
                            ...
                            if ($array['pay_mod_id'] == 1 || $array['pay_mod_id'] == 6 || $array['pay_mod_id'] == 2) 
                            {
                               ...
                               // try {
                                    ...
                                    $insert_array = array(
                                        ...
                                        "wallet_amount_used" => abs($array['wallet_amount_used']),
                                        "amt" => (double)$amount,
                                        "nightfare_applicable" => $nightfare_applicable,
                                        "nightfare" => (double)$nightfare,
                                        "eveningfare_applicable" => $eveningfare_applicable,
                                        ...
                                        "payment_basis" => (int)3,
                                        "notify_status" => (int)0,
                                        "driver_edit_status" => $array['driver_edit_status'],
                                        "actual_paid_amt" => $array['actual_paid_amt'],
                                    ...
                                    if($passenger_pending_amt > 0)
                                    {
                                        ...
                                        $passenger_id = isset($get_passenger_log_details[0]['passengers_id']) ? $get_passenger_log_details[0]['passengers_id'] : '';
                                        $update_wallet = $api->update_wallet_without_log($passenger_id,$passenger_pending_amt,0,$passenger_log_id,6);
                                    }
...
unset(MangoDB::$instances['default']);
                ...
                case 'cancel_trip':
                    ...
                    if ($check_travelstatus != 9 && $check_travelstatus != 0 && $check_travelstatus != 7 && $check_travelstatus != 3) {
                        $message = array(
                            "message" => __('Not_Cancel').$check_travelstatus,
                            "status" => -1
                        );
                        echo json_encode($message);
                        break;
                ...
                if ($array['id'] != null) {
                    ...
                    if ($validator->check()) {
                        ...
                        foreach ($past_bookings as $key => $val) {
                            ...
                            $past_bookings[$key]['trip_fare'] = CURRENCY." ".$trip_fare;
                            $minutes_fare = $trip_fare - $waiting_cost; 
                            $past_bookings[$key]['minutes_fare'] = CURRENCY." ".$minutes_fare;
