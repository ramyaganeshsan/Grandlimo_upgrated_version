...
****************************************************************/
Class Controller_Mobileapi120 extends Controller_Mobile101
{
                                    ...
                                    if($airport_pickup!=1){
                                      ...
                                      foreach($gateway_details as $k => $g){
                                        ...
                                        */
                                        ...
                                        if(($passenger_wallet >= $total_fare && $passenger_wallet != 0) || ($vip_user == 1 && $passenger_wallet >= WALLET_ADVANCE_LIMIT && $lateral_end_date_sec < strtotime($this->currentdate)))
                                        {
                                        ...
                                        else if($passenger_wallet != 0 && $passenger_wallet > 0)
                                        {
