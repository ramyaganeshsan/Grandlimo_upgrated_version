    ...
    public function action_tap_success()
    {
        ...
        if ($_GET['Result'] == 1) {
            ...
            if($used_wallet_amount > 0)
            {
                ...
                $update_wallet = $api_model->update_wallet_without_log($passenger_id,$used_wallet_amount,1,$passenger_log_id);
            }
            ...
            if($passenger_pending_amt > 0)
            {
                ...
                $update_wallet = $api_model->update_wallet_without_log($passenger_id,$passenger_pending_amt,0,$passenger_log_id,6);
            }
            ...
            if($pending_amt > 0)
            {
                ...
                {
                $passenger_id = isset($passenger_log_details[0]['passengers_id']) ? $passenger_log_details[0]['passengers_id'] : '';
                $update_wallet = $api_model->update_wallet_without_log($passenger_id,$pending_amt,1,$passenger_log_id,5);
                }
            }
