       ...
       // $availabilitycount         = $this->add_model->validate_packagedriver($cid);
        ...
        if(isset($_SESSION['download_set']))
        {
           ...
           foreach($all_company_list as $key => $val)
            ...
            $export_table_header = [__('trip_id'),__('passenger_name'),__('mobile'),__('pickupplace'),__('payment_type'),__('fare'),__('pending_amt'),__('wallet_amount'),__('fare_notes')];
            $export_table_field_select = ['trip_id','pass_name','phone','pickup','payment_type','fare','pending_amt','wallet_amount_used','fare_notes'];
    ...
    public function action_consolidated_driver_report()
    {
       ...
       // $availabilitycount         = $this->add_model->validate_packagedriver($cid);
        ...
        if(isset($_SESSION['download_set']))
        {
            ...
            $xls_output = $all_company_list;
            $export_table_header = [__('driver_name')];
        ...
        if(isset($_SESSION['download_set']))
            {
                ...
                $export_table_header = [__('passenger_name'),__('total_amount'),__('total_pending_amt'),__('total_wallet_amt'),__('total_trips')];
                $export_table_field_select = ['driver_name','total_amount','total_pending_amt','total_count'];
...
// exit();
        ...
        if(isset($_SESSION['download_set']))
        {
            ...
            $export_table_header = [__('trip_id'),__('passenger_name'),__('mobile'),__('pickupplace'),__('payment_type'),__('fare'),__('pending_amt'),__('fare_notes'),__('DriverCode'),__('PassengerWalletBeforeTrip')];
            $export_table_field_select = ['trip_id','pass_name','phone','pickup','payment_type','fare','pending_amt','fare_notes','driver_code','wallet_amt_before_payment'];
