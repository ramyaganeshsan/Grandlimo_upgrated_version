 ...
 
    {
        ...
        // }
            if(isset($_SESSION['download_set']))
            {
                ...
                $export_table_header = [__('passenger_name'),__('passenger_phone'),__('current_wallet_amt'),__('amount_credit'),__('amount_debit'),__('recharge_type'),'Trip fare',__('trip_id'),__('redeem_points'),__('notes'),__('created_date')];
                $export_table_field_select = ['passenger_name','passenger_phone','wallet_amount','amount_credit','amount_debit','recharge_type','trip_fare','trip_id','redeem_points','notes','created_date'];
 ...
 public function action_delete_id_image()
    ...
    public function action_trips_ratings_drivers()
    {
        ...
        if(isset($_SESSION['download_set']))
        {
            ...
            foreach($all_company_list as $key => $listings)
            {
                 ...
                 $driver_tags = isset($listings['driver_tags']) ? $listings['driver_tags'] :[];
            ...
            $export_table_header = [__('trip_id'),__('passenger_name'),__('passenger_phone'),__('driver_name'),__('driver_phone'),__('rating_points'),__('attributes'),__('comments'),__('created_date')];
            $export_table_field_select = ['trip_id','passenger_name','passenger_phone','driver_name','driver_phone','rating_data','rating_tags','comments','created_date'];
       ...
       // $availabilitycount         = $this->add_model->validate_packagedriver($cid);
        ...
        if(isset($_SESSION['download_set']))
        {
                ...
                if(count($all_company_list)){
                    ...
                    $fields = [__('driver_code'),__('Day'),__('shift'),__('shift type')];
                    ...
                    $export_table_header = [__('driver_code'),__('Day'),__('shift'),__('shift type')];
                    $export_table_field_select = ['driver_code','create_day','shift_start','shift_type'];
                    $sub_heading = $start_date." to ".$end_date;
        ...
        else
        {
           $count_company_list = $this->manage_model->lost_customer_report('','','','',NULL,NULL,TRUE);  
            ...
            if(isset($_SESSION['download_set']))
            {
                ...
                $export_table_header = [__('country_code'),__('passenger_phone'),__('passenger_name'),__('passenger_email'),__('created_date')];
                $export_table_field_select = ['passenger_country_code','passenger_phone','passenger_name','passenger_email','created_date'];
    ...
    public function action_customer_accounts_report() 
    {
        ...
        if(isset($_SESSION['download_set']))
		{
			...
			$export_table_header = [__('passenger_name'),__('passenger_email'),__('passenger_phone'),__('opening_balance'),__('recharge'),__('transactions'),__('closing_balance')];
			$export_table_field_select = ['name','email','phone','opening_amount','total_recharge_amt','total_trip_amt','wallet_amount'];
          ...
          if(isset($_SESSION['download_set']))
            {
                ...
                $export_table_header = [__('taxi_no'),__('total_amount'),__('total_trips')];
                $export_table_field_select = ['taxi_no','total_amount','total_count'];
        ...
        else
        {
           $count_company_list = $this->manage_model->advance_customer_transactions('','','','','','',NULL,NULL,TRUE);  
            ...
            if(isset($_SESSION['download_set']))
            {
                ...
                $export_table_header = [__('passenger_name'),__('passenger_email'),__('passenger_phone'),__('available_wallet')];
                $export_table_field_select = ['passenger_name','passenger_email','passenger_phone','balance_wallet_amount'];
...
public function action_gift_card_logs()
    ...
    public function action_totalWalletCredit() {
        ...
        $export_table_header = [__('passenger_name'),__('passenger_phone'),__('amount_credit') ,__('current_wallet_amt')];
        $export_table_field_select = ['passengerName','passengerPhone','totalCredit','walletAmount'];
