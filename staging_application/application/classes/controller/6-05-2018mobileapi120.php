...
Class Controller_Mobileapi120 extends Controller_Mobile102
{
    public function __construct()
    {
        try {
            ...
            $this->app_description_ar         = 'تجوّل بأناقة مع خدامتنا الفاخرة للتنقّل. /حمّل تطبيقنا وأحجز عبر الإنترنت - تأكيد فوري / سائقين يتحدّثون الإنجليزيّة ، العربيّة. /نصطحبك من أيّ مكان في الكويت';
                ...
                if ($array['id'] != null) {
                    ...
                    if ($validator->check()) {
                        ...
                        foreach ($past_bookings as $key => $val) {
                            ...
                            if($driver_edit_status == 0 && $pending_amt > 0)
                            {
