...
$pdffile .='
    ...
    public function action_sales_export($input_table,$export_table_header,$export_table_field_select,$heading,$total_fare='',$sub_heading='',$from,$to,$xls_unused_output=array()){
