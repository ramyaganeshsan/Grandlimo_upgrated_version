...
****************************************************************/
Class Controller_Mobileapi119 extends Controller_Mobile101
{
                     ...
                     $update_driver_array = array(
                            ...
                            if ($check_new_request > 0) {
                                ...
                                if (count($get_passenger_log_details) > 0) {
                                    ...
                                    $travel_status = 0;
                                    if (count($get_passenger_log_details) > 0) {
                                        $payment_type  = isset($get_passenger_log_details[0]['payment_type'])?$get_passenger_log_details[0]['payment_type']:1;
                                        $payment_chosen_flag  = isset($get_passenger_log_details[0]['payment_chosen_flag'])?$get_passenger_log_details[0]['payment_chosen_flag']:1;
                                        $travel_status  = isset($get_passenger_log_details[0]['travel_status'])?$get_passenger_log_details[0]['travel_status']:'2';
                                    }
                                    /** UPDATE DRIVER IF PASSENGER CONFIRM HIS PAYMENT TYPE **/
