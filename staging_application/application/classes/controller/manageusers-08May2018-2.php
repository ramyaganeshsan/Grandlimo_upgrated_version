...
class Controller_Manageusers extends Controller_Siteadmin
{
    ...
    public function action_admin_pnotification()
    {
        ...
        if ($signup_submit) {
            ...
            $allpassenger = $this->manage_model->get_allpassenger_details();
        ...
        $view                       = View::factory(ADMINVIEW . 'admin_pnotification')->bind('errors', $errors)->bind('postvalue', $post_values)->bind('total_passengers', $total_passengers);
