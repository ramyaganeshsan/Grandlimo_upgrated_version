 ...
 public function action_ratings()
     ...
     public function action_wallet_logs()
    {
        ...
        if (isset($_REQUEST['keyword'])) {
            ...
            $count_company_list = $this->manage_model->passenger_wallet_logs(trim(Html::chars($_REQUEST['keyword'])), trim(Html::chars($_REQUEST['status'])), $company,NULL,NULL,TRUE);
        }
        else
        {
        ...
        if (isset($_REQUEST['keyword']))
        {
            $all_company_list = $this->manage_model->passenger_wallet_logs(trim(Html::chars($_REQUEST['keyword'])), trim(Html::chars($_REQUEST['status'])), $company, $offset, REC_PER_PAGE);
        }
        else
        {
     ...
     public function action_driver_shift_logs()
    {
       ...
       // $availabilitycount         = $this->add_model->validate_packagedriver($cid);
        ...
        if (isset($_REQUEST['keyword'])) {
            ...
            $count_company_list = $this->manage_model->driver_shift_logs(trim(Html::chars($_REQUEST['keyword'])), trim(Html::chars($_REQUEST['status'])),$search_date,$company,NULL,NULL,TRUE);
        }
        else
        {
           $count_company_list = $this->manage_model->driver_shift_logs('','',$search_date,'',NULL,NULL,TRUE);  
        }
            //pagination loads here
            //-------------------------
            $page_no = isset($_GET['page']) ? $_GET['page'] : 0;
        ...
        if (isset($_REQUEST['keyword']))
        {
            $all_company_list = $this->manage_model->driver_shift_logs(trim(Html::chars($_REQUEST['keyword'])), trim(Html::chars($_REQUEST['status'])),$search_date, $company, $offset, REC_PER_PAGE);
        }
        else
        {
            $all_company_list = $this->manage_model->driver_shift_logs('','',$search_date,'', $offset, REC_PER_PAGE);
        }
