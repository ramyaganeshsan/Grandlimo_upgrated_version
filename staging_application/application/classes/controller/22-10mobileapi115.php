            ...
            switch ($method) {
				...
				*/
				case 'passenger_account_registration_step1':
					...
					$requireIndex = ['phone','devicetoken','deviceid','devicetype'];
					sort($fromIndex);
					sort($requireIndex);
				...
				case 'passenger_account_registration_step3':
					...
					$requireIndex = ['phone','firstname','lastname','email','civilid','creditcard_no','expdatemonth','expdateyear','creditcard_cvv','cardholder_name','civilid_front','civilid_back'];
					sort($fromIndex);
					sort($requireIndex);
