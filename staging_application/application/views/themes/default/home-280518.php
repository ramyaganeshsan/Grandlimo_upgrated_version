			...
			<div class="banner_content_inner">
				<div class="col-md-12">
					<ul class="nav nav-pills">
					    <li class="active"><a data-toggle="pill" href="#picknow" title="Airport  Pickup/Drop Off" class="picknow" onclick="ChangeForm(1);"><i class="picknow_ico"></i>Airport  Pickup/Drop Off</a></li>
					    <li><a data-toggle="pill" href="#picknow" title="Pickup Later" class="picklater" onclick="ChangeForm(2);"><i class="picklater_ico"></i>Pickup Later</a></li>
					</ul>    
						...
						<div id="picknow" class="tab-pane fade in active">
						  	<form name="booking_form" id="booking_form" method="get" action="<?php echo URL_BASE.'users/booking_request'; ?>">
								...
								<div class="form-group width_thirty">
									...
									<span class="star">*</span>
									<input type="text" name="phone" id="phone_num" class="form-control" placeholder="Phone Number" maxlength="10" onkeypress="return isNumber();">
								...
								<div class="form-group width_twenty flight_no_div">
									...
									<input type="text" name="flight_no" id="flight_no" class="form-control hplane" placeholder="Flight No">
									<label class="required_field" id="flight_no_error"></label>
								</div>
								<div class="form-group width_twenty hauto">
									<label class="required_note">*<i>Required Field</i></label>
								</div>
					...
					<?php if(count($model_list)){ 
						...
						<div class="vehic_desc_blocks">
							...
							<div class="veh_desc_rgt">
								<ul>
									<li>Base Fare<span><?php echo $model['base_fare'].' '.CURRENCY; ?></span></li>
									<li>Fare per <?php echo $model['base_mins']; ?> minutes<span><?php echo $model['minutes_fare'].' '.CURRENCY; ?> </span></li>
									<li>Waiting charge per (hr)<span><?php echo $model['waiting_cost_per_hour'].' '.CURRENCY; ?></span></li>
									<li>Luggage<span><?php echo $model['max_luggage']; ?></span></li>
									<li>Model Size<span><?php echo $model['model_size']; ?></span></li>
								</ul>
							</div>
						</div>
					</div>
	...
	<div class="container">
		<div class="col-md-12">
			<div class="blk_title text-center">
				...
				<small>One tap and a car comes directly to you. Hope in your driver knows exactly where to go. </small>
				<a href="<?php echo URL_BASE; ?>meet_our_drivers.html" title="View More" class="view_more">View More</a>
			</div>
		</div>
	        			...
	        			<div class="car_type_lft">
	        				<div class="car_type_lft_cont">
	        					...
	        					<p>
	        						...
	        						<small>Fare per  <?php echo $model['base_mins']; ?> minutes</small>
	        					</p>
	        				</div>
