					...
					<div class="send_but forgot_cent">
											...
											<div class="signup_middle1_contact">
												...
												<span id="otp_btn"></span>
													<input name="submit_forgot_password" class="btn btn-inverse" type="button" title="<?php echo __('btn_submit');?>" value="<?php echo __('btn_submit');?>" onclick="checkpotp()" />
													<a href="<?php echo URL_BASE;?>passenger/resendotp">
													<input name="submit_forgot_password" class="btn btn-inverse" type="button" title="<?php echo __('btn_resend');?>" value="<?php echo __('btn_resend');?>"/>
													</a>
											</div>
