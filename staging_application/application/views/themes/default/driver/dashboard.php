...
function showPosition(lat,lng)
{
 ...
 DMap.prototype.bJ = function () {
	...
	if(show_map ==2)
	{
		set_height = 'height:100px;';	
		V += "<div id='startPanel' style='display:none'></div>";
		V += "<div id='headerPanel' style='display:none'></div>";
		V += "<div id='directionsPanel' style='display:none;overflow:auto "+set_height+"'></div>";
		V += "<div id='mapPanel' style='display:none; "+set_height+"'></div>";
     ...
     return angle;
        ...
        window.onresize=resizePage;
			...
			?>
							...
							<?php if($driver_earnings[0]['total_amount'] > 0)
							  { 
								  $driver_total_earn = CURRENCY.round($driver_earnings[0]['total_amount'],2);
								  $total_earn = round($driver_earnings[0]['total_amount'],2);
							 }else{
								 $driver_total_earn = CURRENCY.'0';
								 $total_earn = '0';
								 }
								// print_r($driver_comments);
								 $today_transaction = 0;
			...
			<!-- content starts -->			
				...
				<a data-rel="tooltip" title="<?php echo ($total_earn > 0)?$driver_total_earn:0;?>" class="well span3 top-block" href="#">
					<span class="icon32 icon-color icon-suitcase"></span>
					<div><?php echo __('total_earnings');?></div>
					<div><?php echo $driver_total_earn;?></div>
					<span class="notification red"><?php echo isset($today_transaction)?$today_transaction:0;?></span>
				</a>
			</div>
			...
			*/?>
			...
			<?php /*<div class="row-fluid sortable" id="driver_response">
						...
						<ul class="dashboard-list">
						  ...
						  <li>
							<a href="#">
							  ...
							  <span class="green"><?php echo $driver_total_earn;?></span>
				...
				<!--<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i> <?php echo __('driver_status');?></h2>
						<div class="box-icon">
					...
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo __('ratings');?></h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
					</div>
