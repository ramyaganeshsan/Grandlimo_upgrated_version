					...
					<div class="col-md-12">
							<div class="pricing_block_lft">
								...
								<?php if(SITE_FARE_CALCULATION_TYPE==1) { ?>					
										...
										<span><?php echo CURRENCY.' '.number_format((float)$model['base_fare_data'], 2, '.', ''); ?></span>
										<ul>
											<li><span class="pric_capt"><i>Base Fare</i></span><span><?php echo $model['base_fare_data'].' '.CURRENCY; ?></span></li>
											<li><span class="pric_capt"><i>Minimum fare <?php echo $model['min_km']; ?> KM </i></span><span><?php echo $model['min_fare_data'].' '.CURRENCY; ?></span></li>
									...
									<li><span class="pric_capt"><i>Waiting charge per (hr)</i></span><span><?php echo $model['waiting_cost_per_hour'].' '.CURRENCY; ?></span></li>
											<li><span class="pric_capt"><i>Airport Fare (Fixed)</i></span><span><?php echo $model['airport_pickup_fare'].' '.CURRENCY; ?></span></li>
											<li><span class="pric_capt"><i>Luggage</i></span><span><?php echo $model['max_luggage']; ?></span></li>
											<?php /*<li><span class="pric_capt"><i>Model Size</i></span><span><?php echo $model['model_size']; ?></span></li>*/ ?>
										</ul>
