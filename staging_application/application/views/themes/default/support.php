         <?php $sucessful_message=Message::get();
          ...
          <div class="find_us_container">
            <div class="col-md-12">
              <h3>Find us on</h3>
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55667.42029144124!2d47.848910838252955!3d29.305404484905818!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fcf91a9e84877f5%3A0xe0a1ec70ca12e522!2sGrand+Limo%2C+Kuwait!5e0!3m2!1sen!2sin!4v1528123330028" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
              <!--<div id="contact_map" style="width:100%;height: 300px;">
              </div>-->
...
<!--<script async defer
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDHZ3VPNsQPCarQJ7hHsMWfhSXl2BKE6Lg&libraries=places&callback=initMap">
  </script>-->
  <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDHZ3VPNsQPCarQJ7hHsMWfhSXl2BKE6Lg"></script>
   <script>
    ...
    var latlng = new google.maps.LatLng(-33.866,151.196);
    var myOptions = {
        zoom: 11,
        center: latlng,
    ...
    var marker, i;
     ...
     marker = new google.maps.Marker({
      ...
      google.maps.event.addListener(marker, 'click', (function(marker, i) {
        return function() {
          infowindow.setContent('GrandLimo');
