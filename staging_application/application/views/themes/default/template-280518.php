...
<!-- language tags ends here -->
	...
	if(COMPANY_CID == 1 ) { 
		...
		if($lang == 'en'){
	?>	
	<link rel="stylesheet" media="screen" type="text/css" href="<?php echo URL_BASE;?>public/css/style.css" />
	<link rel="stylesheet" media="screen" type="text/css" href="<?php echo URL_BASE;?>public/css/media_style.css" />  
	<?php } else { ?>
	<link rel="stylesheet" media="screen" type="text/css" href="<?php echo URL_BASE;?>public/css/style_arabic.css" />
	<link rel="stylesheet" media="screen" type="text/css" href="<?php echo URL_BASE;?>public/css/media_style_arabic.css" />  
	<?php }  }
	else { if($lang == 'en'){ ?>
