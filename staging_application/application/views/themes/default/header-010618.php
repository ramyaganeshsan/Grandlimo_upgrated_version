    ...
    <div class="container">
      <div class="header_toprgt">        
          ...
          <li>
            <div class="dropdown">             
             ...
             <?php $lang="en";$lang=isset($_SESSION['lang'])?$_SESSION['lang']:"en";
              ...
              <?php if($lang == 'ar') { ?>
                    <a href="Javascript:;" class="dropdown-toggle" data-toggle="dropdown" title="English"><span class="flag_ico flag_ar_ico"></span>Arabic</a>
               <?php }else{ ?>                
                ...
                <?php } ?>
                  <ul class="dropdown-menu">
                     <?php if($lang == 'ar') { ?>
                        <li><a href="javascript:;" title="Arabic" onclick="ChangeLanguage('en');"><span class="flag_ico flag_eng_small_ico"></span>English</a> </li>
                         <?php }else{ ?>                
                         <li><a href="javascript:;" title="Arabic" onclick="ChangeLanguage('ar');"><span class="flag_ico flag_ar_small_ico"></span>Arabic</a> </li>
                    <?php } ?>
                  </ul>              
                  </div>
        ...
        <div class="responsive_menu_block">
          ...
          <?php if($lang == 'ar') { ?>
          <li class="lang_block"><a href="javascript:;" title="English" onclick="ChangeLanguage('en');"><i class="lang_flag lang_eng"></i>English</a>
          </li>
          <?php }else{ ?>                
          <li class="lang_block"><a href="javascript:;" title="Arabic" onclick="ChangeLanguage('ar');"><i class="lang_flag lang_ar"></i>Arabic</a>
          </li>                   
          <?php } ?>
