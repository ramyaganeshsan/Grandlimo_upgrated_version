            ...
            <div class="footer_top_inner">
                <div class="col-xs-6 col-sm-6 col-md-3">
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:;" title="Features">Features</a></li>
                        <li><a href="javascript:;" title="How it Works">How it Works</a></li>
                        <li><a href="javascript:;" title="Pricing">Pricing</a></li>
                    </ul>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-3">
                    <h4>Learn more</h4>
                ...
                <div class="col-xs-6 col-sm-6 col-md-2">
                    ...
                    <div class="cont_address">
                        <p>Adhiya Herafiya Block 2,<br>Kuwait<br>+965 663 07956<br>info@q8gandlimo.com</p>
                    </div>
