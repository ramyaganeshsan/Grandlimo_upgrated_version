<?php 
 ...
 ?>
	...
	<!-- Navigation End -->
			...
			<?php //echo '<pre>'; print_r($card_details);
			//echo $card_details[0]['passenger_cardid'];
			//exit; ?>
...
//$Message->message;
	...
	<div class="bread_crumb_holder">
			<ul class="breadcrumb">
				...
				<li>
					<a href="#" title="<?php echo __('edit_card_details'); ?>"><?php echo __('edit_card_details'); ?></a>
				</li>
			</ul>
		</div>
	<div class="profile_total1">		
		...
		<form class="form-horizontal" id="add_card_details" name="add_card_details" method="post" action="<?php echo URL_BASE; ?>passengers/editcard/<?php echo $card_details[0]['passenger_cardid']; ?>" enctype="multipart/form-data" > 
		  <fieldset>
			<legend><?php echo __('edit_card_details'); ?></legend>
			<div class="control-group">
			  <label class="control-label" for="name"><?php echo __('card_type'); ?> * </label>
			  <div class="controls">
				 <select name="card_type" id="card_type">
				  <option value="P" <?php if($card_details[0]['card_type'] == 'P') { echo 'selected=selected'; } ?>><?php echo __('personal'); ?></option>
				  <option value="B" <?php if($card_details[0]['card_type'] == 'B') { echo 'selected=selected'; } ?>><?php echo __('business'); ?></option>
				  </select>
			  </div>
			</div>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<input type="text" name="org_creditcard_no" id="org_creditcard_no" value="<?php 
				echo encrypt_decrypt('decrypt',$card_details[0]['creditcard_no']); ?>" maxlength="16" />
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<input type="text" name="org_creditcard_cvv" id="org_creditcard_cvv" value="<?php echo isset($card_details[0]['creditcard_cvv'])?$card_details[0]['creditcard_cvv']:'';?>" maxlength="4" />
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<?php  $now = date('Y'); ?>
			<?php 
				$expdatemonth =  isset($card_details[0]['expdatemonth']) &&!array_key_exists('expdatemonth',$data)? trim($card_details[0]['expdatemonth']):$data['expdatemonth'];
			?>
			...
			<?php 
				 $expdateyear =  isset($card_details[0]['expdateyear']) &&!array_key_exists('expdateyear',$data)? trim($card_details[0]['expdateyear']):$data['expdateyear'];
			?>
