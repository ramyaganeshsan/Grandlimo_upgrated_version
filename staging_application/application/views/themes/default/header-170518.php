      ...
      <div class="header_toprgt">        
        <ul>
          <li <?php if($manage_cms) { ?> class="active" <?php } ?>>
            <a href="<?php echo URL_BASE; ?>about-us.html" title="<?php echo __('About us');?>"><?php echo __('About us');?></a></li>
          <li><a href="contact-us.html" title="Careers">Careers</a></li>
          <li><a href="contact-us.html" title="Blog">Blog</a></li>
          ...
          <li>
            <div class="dropdown">
              <a href="Javascript:;" class="dropdown-toggle" data-toggle="dropdown" title="English"><span class="flag_ico flag_eng_ico"></span>English</a>
              <ul class="dropdown-menu">
                <li><a href="javascript:;" title="Arabic"><span class="flag_ico flag_eng_ico"></span>Arabic</a></li>
              </ul>
            </div>
        </ul>
          ...
          <ul class="responsive_menubar">
            ...
            <li class="more_menu_list"><a href="javascript:;" title="More" class="more_menu">More</a>
              <ul class="more_menu_blk">
                <li><a href="contact-us.html" title="">About Us</a></li>
                <li><a href="contact-us.html" title="">Careers</a></li>
                <li><a href="contact-us.html" title="">Blog</a></li>
                <li><a href="contact-us.html" title="">Terms &amp; Conditions</a></li>
              </ul>
            </li>
            <li class="lang_block"><a href="javascript:;" title="English"><i class="lang_flag lang_eng"></i>English</a>
              <ul>
                <li><a href="javascript:;" title="Arabic">Arabic</a></li>
              </ul>
            </li>
          </ul>          
        </div>
