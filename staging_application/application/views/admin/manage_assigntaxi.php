...
<tbody>	
        ...
        <tr class="<?php echo $trcolor; ?>">
                    <td align="center"><input type="checkbox" name="uniqueId[]" id="trxn_chk<?php echo $listings['mapping_id'];?>" value="<?php echo $listings['mapping_id']; ?>" />
                    </td>
                    <td align="center"> 
                         <?php 
		    ...
		    <td align="left"><?php echo wordwrap($listings['mapping_startdate'],30,'<br/>',1); ?></td>
		    <td align="left"><?php echo wordwrap($listings['mapping_enddate'],25,'<br />',1); ?></td>
