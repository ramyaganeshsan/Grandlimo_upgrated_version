...
}elseif($total_too_late>$total_on_time){
    $style = 'background-color:#FFA500;';
}elseif($total_late>$total_on_time){
    $style = 'background-color:#FFFF00;';
}elseif($total_on_time){
...
<?php
//background-color:#c52424; #FFA500, #FFFF00
/*
