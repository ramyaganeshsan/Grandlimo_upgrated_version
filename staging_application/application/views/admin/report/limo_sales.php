...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
        ...
        ?>       
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>/transaction/limo_sales_report">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/limo_sales_report'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<thead>
    <tr>
        ...
        <td align="left" style="text-align:left;" width="3%"><?php echo ucfirst(__('create_date')); ?></td>
    <td align="left" style="text-align:left;" width="3%"><?php echo __('total_amount'); ?></td>
    <td align="left" style="text-align:left;" width="1%"><?php echo __('total_pending_amt'); ?></td>
...
<tbody> 
        ...
        ?>     
         ...
         <td><?php echo $listings['create_day'];  ?></td>
      <td><?php echo CURRENCY.number_format($listings['total_amount'], 3, '.', ''); ?>
            <td><?php
               echo CURRENCY.number_format($listings['total_pending_amt'], 3, '.', ''); 
            ?></td>
            <td><?php echo $listings['total_count'];     ?></td>

            <?php
            $grand_total += $listings['total_amount'];
            $grand_pending_total += $listings['total_pending_amt'];
        ...
        <tr>
            ...
            <td><b><?php echo CURRENCY.number_format($grand_pending_total, 3, '.', ''); ?></b></td>
