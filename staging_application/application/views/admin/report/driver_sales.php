...
$enddate = isset($srch["end_date"]) ? $srch["end_date"] :date('Y-m-d H:i:s');  
...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
        ...
        ?>       
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>/transaction/driver_sales_report">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/driver_sales_report'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<thead>
    <tr>
        ...
        <td align="left" style="text-align:left;" width="3%"><?php echo ucfirst(__('driver_name')); ?></td>
...
<tbody> 
        ...
        ?>     
            ...
            <td align="left"><a title="<?php echo ucfirst($listings['driver_name']); ?>" href="<?php echo URL_BASE.'manage/driverinfo/'.$listings['driver_id'];?>"><?php echo wordwrap(ucfirst($listings['driver_name']),30,'<br/>',1); ?></a></td>
