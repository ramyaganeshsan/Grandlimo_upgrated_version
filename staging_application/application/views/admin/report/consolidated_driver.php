...
//===========================================================
$total_company=count($all_shift_logs);
...
<table class="list_table1" border="0" width="65%" cellpadding="5" cellspacing="0">
                    ...
                    <td valign="middle"><label><?php echo __('from_date'); ?></label></td>
                        ...
                        <div class="new_input_field_transaction">
                                  ...
                                  <input type="hidden" name="driver_exportt_id" id="driver_exportt_id" value=""/>                                 
                         <span id="startdate_error" class="error"></span>        
                         </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>transaction/consolidated_driver_report'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<div class="panel-group" id="accordion">
    <div class="panel panel-default">
        <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
                <tr>
                <td width="200px"><?php echo __('sno'); ?></td>
                <td width="80%"><b><?php echo __('driver_name'); ?></b></td>
...
foreach ($all_shift_logs as $key => $shift_val) {

    $i++;
    
    $driver_name = $shift_val['driver_name'];
    $driver_lname = $shift_val['driver_lastname'];
    $driver_id = $shift_val['driver_id'];
?>
 ...
 <!-- Attendence start -->
    ...
    <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $driver_id.'shift_logs'; ?>">
                ...
                <td width="80%"><b><?php echo ucfirst($driver_name)." ".ucfirst($driver_lname); ?>( Attendance )</b> 
                <?php $export_table_count=1;
                 //include(APPPATH.'views/admin/export_menu_consolidate.php'); ?>

                 <button type="button" class="export_me_menu greyishB" onclick="ShowExportData('<?php echo $driver_id; ?>',event);">Export</button></td>
                <?php /*<td width="10%"></td>
                <td width="15%"></td>
                <td width="15%"></td>*/?>
                </tr>
       ...
       // $driver_logs = isset($all_shift_logs[$driver_logs_key])?$all_shift_logs[$driver_logs_key]:array();
        ...
        $driver_logs['tripdet'] = $shift_val['tripdet'];
   ...
   <?php
    ...
    <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $driver_id; ?>">
                ...
                <tr>
                <td width="200px"></td>
                <td width="80%"><b><?php echo ucfirst($driver_name)." ".ucfirst($driver_lname); ?> ( Sales )</b></td>
          ...
          <div id="collapse<?php echo $driver_id; ?>" class="panel-collapse collapse">
            <div class="panel-body">
                <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
                        ...
                        <td align="left" style="text-align:left;" width="1%"><?php echo __('Pending'); ?></td>                        
                        </tr>
         <?php
        /* For Serial No */
        $sno=$Offset; 
       ...
       $payment_msg= $payment_type_msg;//commonfunction::get_payment_message($payment_type,$wallet_amount_used,$pending_amt,$advance_payment,$driver_edit_status,$add_amt) 
        ...
        <?php }else{ ?>
            <tr>
            <td colspan="9"><center>No sales</center></td>          
            </tr>
          ...
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $driver_id.'free_ride'; ?>">
                ...
                <tr>
                <td width="200px"></td>
                <td width="80%"><b><?php echo ucfirst($driver_name)." ".ucfirst($driver_lname); ?>( Free Ride )</b></td>
               <?php /* <td width="10%"></td>
                <td width="15%"></td>
                <td width="15%"></td> */ ?>
                </tr>
...
<!-- Export Start -->
<?php  $export_table_count=1;
if($export_table_count > 200){ $row_create= round(($export_table_count / 200)+0.4); }else{$row_create=1;}?>
...
<div class="export_me_menu_div"> <a class="export_me_menu_div_close"></a>
    <ul>
        <li>
            ...
            <b>:</b>
            <div class="input_box">
                <input type="radio" name="export_type" class='records_type2'  checked value="1"><span>XLS</span>&nbsp;<input type="radio" name="export_type" class='records_type1'  value="2"><span>PDF</span><br>                
            </div>
        </li>
        ...
        <li class="records_type2_select" style="display:none;">
            <label>No of rows</label>
            <b>:</b>
            <div class="input_box">
...
function ShowExportData(id,event){
