...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
        ...
        ?>       
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>transaction/sales_report_daily">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>transaction/sales_report_daily'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<div class="panel-group" id="accordion">
    <div class="panel panel-default">
        <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
                ...
                <td width="20%"><b><?php echo __('date'); ?></b></td>               
...
$i =$Offset;
//$sno=$Offset;
foreach($all_company_list as $k=>$trip_data){
...
foreach($trip_detail as $key=>$val)
{
    ...
    $pickup_time = isset($val['pickup_time'])? Commonfunction::convertphpdate('Y-m-d ',$val['pickup_time']):'';
    ...
    $fare = $fare - $passenger_pending_amt;
    $total_sales = $fare - $passenger_discount;
...
?>   
    <tr>
        <td><?php echo $i; ?></td>        
        <td><?php echo $actual_pickup_time; ?></td>
        <td><?php echo number_format($total_gross_amt,3,'.',''); ?></td>
        <td><?php echo $total_discount_promo_pay; ?></td>
        <td><?php echo number_format($total_net_pay,3,'.',''); ?></td>
        <td><?php echo $total_cash_fare; ?></td>
        <td><?php echo $total_card_fare; ?></td>
        <td><?php echo $total_knet_fare; ?></td>
        <td><?php echo $total_wallet_fare; ?></td>
        <td><?php echo $total_pending_amt; ?></td>
        <td><?php echo ''; ?></td>        
    </tr> 
<?php
}
