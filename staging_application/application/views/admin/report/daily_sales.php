...
<div class="panel-group" id="accordion">
    <div class="panel panel-default">
        <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
                ...
                <td width="15%"><b><?php echo __('total_prev_pending'); ?></b></td>
                <?php /*<td width="15%"><b><?php echo __('total_cash'); ?></b></td>
                <td width="15%"><b><?php echo __('total_card'); ?></b></td>
                <td width="15%"><b><?php echo __('total_knet'); ?></b></td>
                <td width="15%"><b><?php echo __('total_wallet'); ?></b></td>
                <td width="15%"><b><?php echo __('total_add'); ?></b></td>*/ ?>
                </tr>
                </table>
                <?php } ?>
<!-- <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive"> -->
...
foreach($all_company_list as $listings)
{
    ...
    $total_pass_pend_amt = isset($listings['total_pass_pend_amt'])?$listings['total_pass_pend_amt']:'';
    ...
    <div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $driver_id; ?>">
                <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
                <tr>
                <td width="4%"><a href="javascript(0)" title=""><?php echo $i; ?></td>
                ...
                <td width="15%"><b><?php echo CURRENCY.number_format($listings['total_pass_pend_amt'], 3, '.', ''); ?></b></td>
               <?php /* <td width="15%"><b><?php echo CURRENCY.number_format($listings['total_cash_amt'], 3, '.', ''); ?></b></td>
                <td width="15%"><b><?php echo CURRENCY.number_format($listings['total_card_amt'], 3, '.', ''); ?></b></td>
                <td width="15%"><b><?php echo CURRENCY.number_format($listings['total_knet_amt'], 3, '.', ''); ?></b></td>
                <td width="15%"><b><?php echo CURRENCY.number_format($listings['total_wallet_amt'], 3, '.', ''); ?></b></td>
                <td width="15%"><b><?php echo CURRENCY.number_format($listings['total_add_amt'], 3, '.', ''); ?></b></td>*/?>
                </tr>
                </table></a>
            </h4>
          </div>
          <div id="collapse<?php echo $driver_id; ?>" class="panel-collapse collapse">
            <div class="panel-body">
                <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
                        ...
                        <td align="left" style="text-align:left;" width="1%"><?php echo __('passenger_previous_pending'); ?></td>
                        </tr>
         <?php
        /* For Serial No */
        $sno=$Offset; 
       ...
       $payment_msg= commonfunction::get_payment_message($payment_type,$wallet_amount_used,$pending_amt,$advance_payment,$driver_edit_status,$add_amt) ;
        // if($driver_edit_status == 0  && $actual_paid_amt != '' && $actual_paid_amt != 0)
        // {
       ...
       if($add_amt != 0)
       {
        ...
        ?>     
            <td align="center"  id="<?php echo $edit_status; ?>"><?php echo $sno; ?></td>
         ...
         <td><a title="<?php echo $pass_id; ?>" href="<?php echo URL_BASE.'manage/passengerinfo/'.$pass_id;?>"><?php echo ucfirst(urldecode($pass_names))." ".ucfirst(urldecode($pass_lastnames));  ?></a></td>
         ...
         <td><?php echo CURRENCY.$fare.$add_txt;  ?></td>
         <td><?php echo CURRENCY.$pending_amt;  ?></td>
         <td><?php echo CURRENCY.$passenger_pending_amt;  ?></td>
        </tr>
        <?php } ?>
        </table>
    </div>
