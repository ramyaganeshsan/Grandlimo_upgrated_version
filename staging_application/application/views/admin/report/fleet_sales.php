...
$taxi_model = isset($srch["taxi_model"]) ? $srch["taxi_model"] :'';
...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
        ...
        ?>       
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>manage/fleet_sales_report">
<table class="list_table1" border="0" width="65%" cellpadding="5" cellspacing="0">
 <tr>
                        ...
                        <input type="hidden" name="status"  maxlength="256" id="keyword" value="1" />
                         <?php /* ?>
                         <td valign="top"><label><?php echo __('year_label'); ?></label></td>
                        <td valign="top">
            <div class="selector" id="uniform-user_type">
                            <select class="select2" name="year" id="year" onchange="change_month()">
                        ...
                        <td valign="top"><label><?php echo __('month_label'); ?></label></td>
                        <td valign="top">
            <div class="selector" id="month_list">
                            <select class="select2" name="month" id="month" onchange="">
                                <option value=""><?php echo __('select_label'); ?></option>    
                                <?php
                                for($j=1;$j<=12;$j++) { 
                                    ...
                                    ?>  
                                    <option value="<?php echo $j; ?>"   <?php echo $selected; ?>><?php echo $month_name; ?></option>
                                <?php }  ?>
                            </select>
                            </div>
                        </td>
                        <?php */ ?> 
                        <td valign="top"><label><?php echo __('select_the_taximodel'); ?></label></td>
                        <td valign="top">
                            <div class="new_input_field">
                                <select name="taxi_model" id="taxi_model" class="required" title="<?php echo __('select_the_taximodel'); ?>">
									...
									<?php foreach($model_details_new as $list) { ?>
										<option value="<?php echo $list['_id']; ?>" <?php if($taxi_model == $list['_id']) { echo 'selected=selected'; } ?>><?php echo ucfirst($list['model_name']); ?></option>
									<?php } ?>
							  </select>
                            </div>                            
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/fleet_sales_report'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<thead>
    <tr>
        ...
        <td align="left" style="text-align:left;" width="3%"><?php echo ucfirst(__('taxi_no')); ?></td>
        <td align="left" style="text-align:left;" width="3%"><?php echo ucfirst(__('model')); ?></td>
    <td align="left" style="text-align:left;" width="3%"><?php echo __('total_amount'); ?></td>    
    <td align="left" style="text-align:left;" width="1%"><?php echo __('total_trips'); ?></td>
    </tr>
</thead>
<tbody> 
        <?php
        ...
        ?>     
         ...
         <td><a href="<?php echo URL_BASE.'transaction/admintransaction_list/success/
?filter_company=1&manager_id=All&taxiid='.$listings['taxi_id'].'&driver_id=All&passengerid=All&startdate='.$startdate.'&enddate='.$enddate.'&payment_type=All&search_user=Search'; ?>"><?php echo $listings['taxi_no'];  ?></a></td>
<td><?php echo $listings['model_name'];     ?></td>
      <td><?php echo CURRENCY.number_format($listings['total_amount'], 3, '.', ''); ?>
            <td><?php echo $listings['total_count'];     ?></td>

            <?php
            $grand_total += $listings['total_amount'];
            $grand_count += $listings['total_count'];
        ...
        <tr>
            <td></td>
            <td></td>
            <td><?php echo __('grand_total'); ?></td>
            <td><b><?php echo CURRENCY.number_format($grand_total, 3, '.', ''); ?></b></td>
            <td><b><?php echo $grand_count; ?></b></td>
        </tr>
        <?php } 
