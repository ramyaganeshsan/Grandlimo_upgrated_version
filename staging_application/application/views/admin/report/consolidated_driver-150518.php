          ...
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $driver_id.'shift_logs'; ?>">
                ...
                <td width="20%"><b><?php echo ucfirst($driver_name)." ".ucfirst($driver_lname); ?>( Attendance )</b> 
                <?php $export_table_count=1;
                 //include(APPPATH.'views/admin/export_menu_consolidate.php'); ?>

                 <button type="button" class="export_me_menu greyishB" onclick="ShowExportData('<?php echo $driver_id; ?>');">Export</button></td>
                <?php /*<td width="10%"></td>
                <td width="15%"></td>
                <td width="15%"></td>*/?>
                </tr>
