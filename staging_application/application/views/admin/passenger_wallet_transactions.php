...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		...
		?>		 
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>manage/wallet_transactions">
...
<thead>
    ...
    <td align="left" style="text-align:left;" width="1%"><?php echo __('current_wallet_amt'); ?></td>
        ...
        <td align="left" style="text-align:left;" width="1%"><?php echo 'Trip fare'; ?></td>
...
<tbody>	
     ...
     <!--  <td><?php echo isset($listings['passenger_email']) ? wordwrap($listings['passenger_email'],25,'<br />',1) : '-'; ?></td> -->
      ...
      <td><?php echo CURRENCY.round($listings['wallet_amount'],3); ?>
            <td><?php
            if($listings['change_amount'] > 0)
            {
               echo CURRENCY.round($listings['change_amount'],3); 
            } 
            ?></td>
            <td><?php 
             if($listings['change_amount'] < 0)
            {
             echo CURRENCY.'<span class="negative">'.abs(round($listings['change_amount'],3)).'</span>';
            }
            ?></td>
            ...
            echo $transaction_id;
              ...
              ?></td>
            <td><?php echo isset($listings['notes'])?$listings['notes']:'-'; ?></td>
