...
<?php if ($total_users > 0) { ?>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td><a title="<?php echo isset($listings['title'])?ucfirst($listings['title']):"-"; ?>" href="<?php echo URL_BASE.'manage/userinfo/'.$listings['_id'];?>"><?php echo isset($listings['title'])?wordwrap(ucfirst($listings['title']),30,'<br/>',1):"-"; ?></a></td>
