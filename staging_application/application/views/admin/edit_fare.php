...
<div class="container_content fl clr">
	...
	<td valign="top" width="20%"><label><?php echo __('model_name');  ?></label><span class="star">*</span></td>
		   ...
		   <div class="new_input_field">
			   <?php echo isset($model_details['model_name']) ? trim($model_details['model_name']):""; ?>
              <input type="hidden" title="<?php echo __('model_name'); ?>" class="required" name="model_name" id="model_name" value="<?php echo isset($model_details['model_name']) && !array_key_exists('model_name',$postvalue)? trim($model_details['model_name']):((isset($postvalue['model_name']))?$postvalue['model_name']:""); ?>"   />
	...
	<td>
	<div class="new_input_field">
              <input type="text"  title="<?php echo __('entermodelsize'); ?>" class="required NotZero" id="model_size" name="model_size" value="<?php echo isset($model_details['model_size']) &&!array_key_exists('model_size',$postvalue)? trim($model_details['model_size']):((isset($postvalue['model_size']))?$postvalue['model_size']:""); ?>" />
	...
	<!--Fare Details start-->
	  <tr>
	   ...
	   <td><input type="hidden" name="company_model_fare_id" id="company_model_fare_id" value="<?php echo $model_details['model_id']; ?>" ></td>	          
           </tr>
           <tr>
           <td valign="top" width="20%"><label><?php echo __('base_fare'); ?>(<?php echo $company_currency; ?>)</label><span class="star">*</span></td>        
	       <td>			   
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterthebase_fare'); ?>" class="required numbersdots" name="base_fare" id="base_fare" value="<?php echo isset($model_details['base_fare']) &&!array_key_exists('base_fare',$postvalue)? trim($model_details['base_fare']):((isset($postvalue['base_fare']))?$postvalue['base_fare']:""); ?>"  minlength="1" maxlength="7" onkeypress="return onlyDotsAndNumbers(this,event)" />
	       ...
	       <td>			   
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enter_min_km'); ?>" class="required numbersdots" name="min_km" id="min_km" value="<?php echo isset($model_details['min_km']) &&!array_key_exists('min_km',$postvalue)? trim($model_details['min_km']):((isset($postvalue['min_km']))?$postvalue['min_km']:""); ?>"  minlength="1" maxlength="7"  />
	       ...
	       <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterthemin_fare'); ?>" class="required numbersdots" name="min_fare" id="min_fare" value="<?php echo isset($model_details['min_fare']) &&!array_key_exists('min_fare',$postvalue)? trim($model_details['min_fare']):((isset($postvalue['min_fare']))?$postvalue['min_fare']:""); ?>"  minlength="1" maxlength="30"  />
	       ...
	       <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterthecancellation_fare'); ?>" class="required numbersdots" name="cancellation_fare" id="cancellation_fare" value="<?php echo isset($model_details['cancellation_fare']) &&!array_key_exists('cancellation_fare',$postvalue)? trim($model_details['cancellation_fare']):((isset($postvalue['cancellation_fare']))?$postvalue['cancellation_fare']:""); ?>"  minlength="1" maxlength="30"  />
	       ...
	       <td>			   
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enter_below_and_above_km'); ?>" class="required" name="below_and_above_km" id="below_and_above_km" value="<?php echo isset($model_details['below_above_km']) &&!array_key_exists('below_and_above_km',$postvalue)? trim($model_details['below_above_km']):((isset($postvalue['below_above_km']))?$postvalue['below_above_km']:""); ?>"  minlength="1" maxlength="7" onkeypress="return onlyDotsAndNumbers(this,event)"   />
	       ...
	       <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterthebelow_km'); ?>" class="required numbersdots" name="below_km" id="below_km" value="<?php echo isset($model_details['below_km']) &&!array_key_exists('below_km',$postvalue)? trim($model_details['below_km']):((isset($postvalue['below_km']))?$postvalue['below_km']:""); ?>"  minlength="1" maxlength="30"  />
	       ...
	       <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('entertheabove_km'); ?>" class="required numbersdots" name="above_km" id="above_km" value="<?php echo isset($model_details['above_km']) &&!array_key_exists('above_km',$postvalue)? trim($model_details['above_km']):((isset($postvalue['above_km']))?$postvalue['above_km']:""); ?>"  minlength="1" maxlength="30"  />
	   ...
	   <td>
		   <div class="new_input_field">
              <input type="text" title="<?php echo __('enterwaiting_charge'); ?>" class="required numbersdots" name="waiting_time" id="waiting_time" value="<?php echo isset($model_details['waiting_time']) &&!array_key_exists('waiting_time',$postvalue)? trim($model_details['waiting_time']):((isset($postvalue['waiting_time']))?$postvalue['waiting_time']:""); ?>"    minlength="1" maxlength="20" />
	   ...
	   <td>
		   <div class="new_input_field">	
              <input type="text"  class="required numbersdots" title="<?php echo __('enter_fare_per_minute'); ?>" id="minutes_fare" name="minutes_fare" value="<?php echo isset($model_details['minutes_fare']) &&!array_key_exists('minutes_fare',$postvalue)? trim($model_details['minutes_fare']):((isset($postvalue['minutes_fare']))?$postvalue['minutes_fare']:""); ?>" minlength="1" maxlength="20" />
	       ...
	       <td>
			   <?php $nfield_type =''; $nfield_type =  isset($model_details['night_charge']) &&!array_key_exists('night_charge',$postvalue)? trim($model_details['night_charge']):((isset($postvalue['night_charge']))?$postvalue['night_charge']:""); ?>
		    <div class="formRight">
	       ...
	       <td>
		   <div class="new_input_field_charge">
              <input type="text" title="<?php echo __('enterthenight_fare'); ?>" class="required numbersdots" name="night_fare" id="night_fare" value="<?php echo isset($model_details['night_fare']) &&!array_key_exists('night_fare',$postvalue)? trim($model_details['night_fare']):((isset($postvalue['night_fare']))?$postvalue['night_fare']:""); ?>"  minlength="1" maxlength="30"  />
	   ...
	   <table border="0" cellpadding="0" cellspacing="0" width="100%">
		   <tr>
			   ...
			   <td style="padding:5px;">
				   <?php $efield_type =''; $efield_type =  isset($model_details['evening_charge']) &&!array_key_exists('evening_charge',$postvalue)? trim($model_details['evening_charge']):((isset($postvalue['evening_charge']))?$postvalue['evening_charge']:""); ?>
			   <div class="formRight">
				<div class="selector" id="uniform-user_type">
       ...
       <div id="evening_charge_det" <?php if($efield_type==1){ ?> style="display:block;" <?php }else if($efield_type==0){ ?> style="display:none;padding-left:5px;" <?php } ?>>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
			   ...
			   <div class="new_input_field_charge">
				  ...
				  <input type="text" title="<?php echo __('entertheevening_timing_from'); ?>"  readonly class="required" name="evening_timing_from" id="evening_timing_from" value="<?php echo isset($model_details['evening_timing_from']) &&!array_key_exists('evening_timing_from',$postvalue)? trim($model_details['evening_timing_from']):((isset($postvalue['evening_timing_from']))?$postvalue['evening_timing_from']:""); ?>"  minlength="7" maxlength="30"  />
			   ...
			   <td>
			   <div class="new_input_field_charge">
				  <input type="text" title="<?php echo __('entertheevening_fare'); ?>" class="required numbersdots" name="evening_fare" id="evening_fare" value="<?php echo isset($model_details['evening_fare']) &&!array_key_exists('evening_fare',$postvalue)? trim($model_details['evening_fare']):((isset($postvalue['evening_fare']))?$postvalue['evening_fare']:""); ?>"  minlength="1" maxlength="30"  />
