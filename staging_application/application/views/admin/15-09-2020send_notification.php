              ...
              <?php if(isset($errors) && array_key_exists('sub_title',$errors)){ echo "<span class='error'>".ucfirst($errors['sub_title'])."</span>";}?>
				...
				<tr>
					...
					<td>
						...
						<textarea rows="7" cols="35" style="width: 50% !important;" placeholder="Please enter text within 200 characters" maxlength="200" name="content" id="admin_push_message" title="<?php echo __('sms_message'); ?>" rows="7" cols="35"><?php echo isset($post_values['content'])?$post_values['content']:'';?></textarea>
