	...
	<table border="0" cellpadding="5" cellspacing="0" width="100%">                                                  
           ...
           <tr>
           		<td valign="top" width="20%"><label><?php echo __('total_airport_trips'); ?></label></td>    
			       	<td>
								<div class="new_input_field">
									<input type="text"  class="required onlynumbers"  name="total_airport_trips" id="total_airport_trips" value="<?php echo isset($promocode_details['total_airport_trips']) &&!array_key_exists('total_airport_trips',$postvalue)? trim($promocode_details['total_airport_trips']):$postvalue['total_airport_trips']; ?>"  minlength="1" maxlength="3"  />
