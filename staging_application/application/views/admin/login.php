            ...
            <fieldset>
                <div class="formRow">
                    ...
                    <div class="loginInput">
						...
						<input type="text" id="email" name="email" <?php /* value="admin@taximobility.com" readonly */?> maxlength="50" />
						<?php }else { ?>
...
<?php if(isset($errors) && array_key_exists('password',$errors)){ echo "<span class='error'>".ucfirst($errors['password'])."</span>";}?>
                ...
                <div class="loginControl">
                  <?php /*<div class="rememberMe"><a href="<?php echo URL_BASE; ?>admin/forgot_password" class="frgtpsd"><?php echo __('forgot_password'); ?></a></div>*/?>
