...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		...
		?>		 
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>manage/pending_customer_transactions">
					...
					<tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/pending_customer_transactions'" />
                            </div>
                        </td>
                    </tr>
                </table>
