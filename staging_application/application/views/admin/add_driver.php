...
<div class="container_content fl clr">
	...
	<tr>
		...
		<td>
		<div class="new_input_field" style="width: 100%;">
		  <input type="text"  maxlength="2" style="width: 29px;text-transform: uppercase;padding: 7px;" id="driver_code_prefix" name="driver_code_prefix" value="<?php if(isset($postvalue) && array_key_exists('driver_code_prefix',$postvalue)){ echo $postvalue['driver_code_prefix']; } else { echo $dcPrefix;}?>" />	
		  <?php if(isset($errors) && array_key_exists('driver_code_prefix',$errors)){ echo "<span class='error'>".ucfirst($errors['driver_code_prefix'])."</span>";}?>	  
		  <input type="text" style="width: 134px;padding: 7px;" readonly  maxlength="4" id="driver_code_suffix" name="driver_code_suffix" value="<?php if(isset($postvalue) && array_key_exists('driver_code_suffix',$postvalue)){ echo $postvalue['driver_code_suffix']; } else { echo $uniqueId;}?>" />
		  <?php if(isset($errors) && array_key_exists('driver_code_suffix',$errors)){ echo "<span class='error'>".ucfirst($errors['driver_code_suffix'])."</span>";}?>		  
		</div>
		</td>   	
	</tr>
	...
	<td>
	<div class="new_input_field">
              <input type="text" title="<?php echo __('entermobileno'); ?>" id="phone" name="phone" value="<?php if(isset($postvalue) && array_key_exists('phone',$postvalue)){ echo $postvalue['phone']; }?>" minlength="7" maxlength="10" />
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="60" minlength="4"  id="facebook_account" name="facebook_account" value="<?php if(isset($postvalue) && array_key_exists('facebook_account',$postvalue)){ echo $postvalue['facebook_account']; }?>" />
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="60" minlength="4" id="instagram_account" name="instagram_account" value="<?php if(isset($postvalue) && array_key_exists('instagram_account',$postvalue)){ echo $postvalue['instagram_account']; }?>" />
	...
	<td>
	<div class="new_input_field">
              <input type="text"  maxlength="60" minlength="4" id="twitter_account" name="twitter_account" value="<?php if(isset($postvalue) && array_key_exists('twitter_account',$postvalue)){ echo $postvalue['twitter_account']; }?>" />
	...
	<tr>
		...
		<td>
			<div class="new_input_field">
			<textarea maxlength="1000" name="driver_description" id="driver_description" rows="7" cols="35"><?php if(isset($postvalue) && array_key_exists('driver_description',$postvalue)){ echo $postvalue['driver_description']; }?></textarea>
	...
	<tr>
		...
		<td>
			<div class="new_input_field">
			<textarea maxlength="1000" name="driver_description_arabic" id="driver_description_arabic" rows="7" cols="35"><?php if(isset($postvalue) && array_key_exists('driver_description_arabic',$postvalue)){ echo $postvalue['driver_description_arabic']; }?></textarea>
	...
	<tr>
	<td valign="top" width="20%"><label><?php echo __('website_photo_label'); ?> (380 * 341) </label><span class="star"></span></td>        
	<td>
	<div class="new_input_field">
	...
	<?php 
		if(isset($postvalue['website_show']) && $postvalue['website_show'] ==1 ){
			$web_status = 'checked';
		}else{
			$web_status = '';
		}
...
$('#driver_code_prefix').bind('keypress', testInput);
