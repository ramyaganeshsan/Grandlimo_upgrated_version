...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		...
		?>		 
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>/manage/gift_card_logs">
...
<thead>
    ...
    <td align="left" style="text-align:left;" width="1%"><?php echo __('status_description'); ?></td>
    <td align="left" style="text-align:left;" width="1%"><?php echo __('status'); ?></td>
    <td align="left" style="text-align:left;" width="1%"><?php echo __('trip_id'); ?></td>
        <td align="left" style="text-align:left;" width="1%"><?php echo __('redemption_amount'); ?></td>
...
<tbody>	
     ...
     <!--  <td><?php echo isset($listings['passenger_email']) ? wordwrap($listings['passenger_email'],25,'<br />',1) : '-'; ?></td> -->
            ...
            <td><?php echo isset($listings['status_description']) ? $listings['status_description'] : '-'; ?></td>
            <td><?php echo isset($listings['status']) ? (($listings['status'] == 1)? "Success" : 'Failed') :'-' ; ?></td>

            <?php $trip_id= isset($listings['trip_id']) ? $listings['trip_id'] : '';
            if($trip_id != ''){ ?>
            <td><a title="<?php echo $trip_id; ?>" href="<?php echo URL_BASE.'transaction/transaction_details/'.$trip_id;?>"><?php echo $trip_id; ?></a></td>
            <?php } else { ?>
            <td>-</td>
            <?php } ?>
            <td><?php echo isset($listings['redemption_amount']) ? $listings['redemption_amount'] : '-'; ?></td>
            <td><?php echo isset($listings['redemption_trans_id']) ? $listings['redemption_trans_id'] : '-'; ?></td>
       ...
       <form  id="add-wallet" class="form-horizontal" role="form">
            <div class="form-group" style="margin-bottom:10px">
             ...
             <div class="form-group" style="margin-bottom:10px">
                ...
                <div class="easy-autocomplete eac-round"><textarea style="width: 70%;border-radius: 3px;" class="form-control " name="notes" id="notes" autofocus type="text" value="" maxlength="200" "></textarea>
