...
<script type="text/javascript" src="<?php echo URL_BASE;?>public/js/easy-autocomplete.min.js"></script>
<script type="text/javascript" src="<?php echo URL_BASE;?>public/js/alertify.js"></script>
<?php 
