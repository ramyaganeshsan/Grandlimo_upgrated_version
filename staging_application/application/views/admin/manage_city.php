...
<?php /* if($total_company > 0){ */ ?>
<?php if(count($all_cities_list) > 0){ ?>
<thead>
	...
	<tr>
		...
		<?php /* <td align="left" style="text-align:left;" width="15%"><?php echo __('country_label'); ?></td>
		...
		<?php /* <td align="left" style="text-align:left;" width="20%"><?php echo __('city_model_fare'); ?></td> */?>
		<td align="left" width="10%" ><?php echo __('action_label'); ?></td>
		<?php /* <td align="left" width="20%" ><?php echo __('default_city'); ?></td> */?>
	</tr>
	</thead>
	<tbody>
		<?php
		 ...
		 foreach($all_cities_list as $listings) {
		 //S.No Increment
		 //==============
		 $sno++;        
         //For Odd / Even Rows
        ...
        <tr class="<?php echo $trcolor; ?>">
                    <td align="center"><input type="checkbox" name="uniqueId[]" id="trxn_chk<?php echo $listings['city_id'];?>" value="<?php echo $listings['city_countryid'].'_'.$listings['city_stateid'].'_'.$listings['city_id'];?>" />
                    </td>
                    <td align="center"> 
                         <?php 
			...
			<?php /* <td align="left"><?php echo wordwrap(ucfirst($listings['country_name']),30,'<br/>',1); ?></td>
			...
			<?php /* <td align="left"><?php echo $listings['city_model_fare']; ?></td> */ ?>
			<td align="center" width="20"><a href='<?php echo URL_BASE."edit/city/".$listings['city_countryid']."/".$listings['city_stateid']."/".$listings['city_id'];?>' title ="Edit" class="editicon"></a></td>
			<?php /* <td align="center" width="20"><input type="radio" name="default_city" <?php if($listings['city_default'] == 1){?>checked = "checked"<?php }?> value="<?php echo $listings['city_countryid'].'_'.$listings['city_stateid'].'_'.$listings['city_id']; ?>"/></td> */ ?>
		</tr>
		<?php } /*
		if($sno >=1){
		?>
		...
		<?php }else { ?>
			<tr>
				<td colspan="10" align="center"><?php echo __('no_data');?></td>
			</tr>
		<?php } */
 		 } 
