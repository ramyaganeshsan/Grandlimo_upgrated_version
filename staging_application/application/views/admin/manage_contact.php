 ...
 <tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/contact'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<tbody>		
        ...
        <tr class="<?php echo $trcolor; ?>">
			...
			<td align="left"><a href="mailto:<?php echo $listings['email'];?>" title="mailto" target="_blank"><?php echo wordwrap($listings['name']); ?></a></td>
			...
			<td align="left"><?php echo Commonfunction::convertphpdate('Y-m-d h:i:s A',$listings['sent_date']); ?></td>
