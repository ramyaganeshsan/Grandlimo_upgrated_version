...
<?php if ($total_users > 0) { ?>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td><a title="<?php echo isset($listings['name'])?ucfirst($listings['name']):"-"; ?>" href="<?php echo URL_BASE.'manage/passengerinfo/'.$listings['_id'];?>"><?php echo isset($listings['name'])?wordwrap($listings['name'],30,'<br/>',1):"-"; ?></a></td>
		...
		<td align="center" colspan='3' ><?php echo '<a href='.URL_BASE.'admin/editpassenger/'.$listings['_id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
		</tr>
		<?php } 
 		 } 
		//For No Records
