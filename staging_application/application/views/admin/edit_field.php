...
<div class="container_content fl clr">
	...
	<div class="new_input_field">
              <input type="text" title="<?php echo __('enter_label_name'); ?>" name="field_labelname" id="field_labelname" value="<?php echo isset($company_details[0]['field_labelname']) &&!array_key_exists('field_labelname',$postvalue)? trim($company_details[0]['field_labelname']):$postvalue['field_labelname']; ?>" maxlength="20" />
	...
	<td>
	<div class="new_input_field">
               <input type="text" title="<?php echo __('enter_field_name'); ?>" name="field_name" id="field_name" value="<?php echo isset($company_details[0]['field_name']) &&!array_key_exists('field_name',$postvalue)? trim($company_details[0]['field_name']):$postvalue['field_name']; ?>" maxlength="20" />
	...
	<td>
		<?php $field_type ='';
		$field_type = isset($company_details[0]['field_type']) &&!array_key_exists('field_type',$postvalue)? trim($company_details[0]['field_type']):$postvalue['field_type']; ?>
	<div class="formRight">
	...
	<td>
	<div class="new_input_field">
               <textarea name="field_value" id="field_value"  title="<?php echo __('enter_field_value'); ?>" rows="7" cols="35"><?php echo isset($company_details[0]['field_value']) &&!array_key_exists('field_value',$postvalue)? trim($company_details[0]['field_value']):$postvalue['field_value']; ?></textarea>
