...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		...
		?>		 
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>manage/customer_accounts_report">
					...
					<tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/customer_accounts_report'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<tbody>	
        ...
        ?>     
			...
			<td align="left"><a title="<?php echo ucfirst($listings['name']); ?>" href="<?php echo URL_BASE.'manage/customer_accounts_detail?id='.$listings['passenger_id'].'&start_date='.$startdate.'&end_date='.$enddate;?>"><?php echo wordwrap($listings['name'],30,'<br/>',1); ?></a></td>
       <td><?php echo isset($listings['email']) ? wordwrap($listings['email'],25,'<br />',1) : '-'; ?></td> 
			<td><?php echo isset($listings['phone']) ? $listings['phone'] : '-'; ?></td>
			<td>
				<?php $opening_amount = ( $listings['wallet_amount'] + $listings['total_trip_amt'] ) - $listings['total_recharge_amt']; ?>
				<?php echo CURRENCY.round($opening_amount,3); ?>
            </td>
            <td>
				<?php echo CURRENCY.round($listings['total_recharge_amt'],3); ?>
            </td>
            <td>
				<?php echo CURRENCY.round($listings['total_trip_amt'],3); ?>
			</td>
            <td><?php echo CURRENCY.round($listings['wallet_amount'],3); ?></td>
           <?php $closing_amount += $listings['wallet_amount']; ?>
		...
		<tr>
			<td colspan="6"></td>
			<td><b>Payables</b><br><?php echo CURRENCY.round($closing_amount,3);?></td>
			<td><b>Receivables</b><br><?php echo CURRENCY.round($closing_amount,3);?></td>			
		</tr>
		<?php */ ?>
 		<?php } 
