...
<thead>
	<tr class="rowhead">
		...
		<td align="left" width="10%"><?php echo __('taxi_capacity'); ?></td>
		<td align="left" width="5%"><?php //echo str_replace('%currency%',CURRENCY,__('taxi_fare_km')); ?></td>
		<td align="left" width="5%"><?php echo __('no_taxi_photos'); ?></td> 
	...
	<tbody>	
        ...
        <tr class="<?php echo $trcolor; ?>">
			...
			<?php /* if($usertype != 'C') { ?>
				<td align="left"><a title="<?php echo ucfirst($listings['company_name']); ?>" href="<?php echo URL_BASE.'manage/companydetails/'.$listings['company_userid'];?>">		
...
<?php if(count($all_taxi_list) > 0)
       { ?>
          <div class="select_all">
                <b><a href="javascript:selectToggle(true, 'availabilitymanagetaxi');"><?php echo __('all_label');?></a></b><span class="pr2 pl2">|</span><b><a href="javascript:selectToggle(false, 'availabilitymanagetaxi');"><?php echo __('select_none');?></a></b>
