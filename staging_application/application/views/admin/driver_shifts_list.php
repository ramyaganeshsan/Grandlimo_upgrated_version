...
<div class="container_content fl clr">
    <div class="cont_container mt15 mt10">
        ...
        ?>       
        <form method="get" class="form" name="managedriver" id="managedriver" action="<?php echo URL_BASE; ?>manage/driver_shift_logs_list">
<table class="list_table1" border="0" width="65%" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/driver_shift_logs_list'" />
                            </div>
                        </td>
                    </tr>
                </table>
       ...
       <div style="width:auto; float:right;margin: -5px 3px;">
        <div ><?php if($total_company > 0){ $export_table_count=$total_company;
                    include_once(APPPATH.'views/admin/export_menu_drivershift.php'); } ?></div>                       
...
<?php if($total_company > 0){ ?>
    <div class= "overflow-block">
        ...
        <table cellspacing="1" cellpadding="1" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
            <thead>
                <tr>
                <td width="1%"><?php echo __('sno'); ?></td>
                <td><b><?php echo __('driver_name'); ?></b></td>
                <td><b><?php echo __('driver_code'); ?></b></td> 
                <td><b><?php echo __('shift_day'); ?></b></td>               
...
foreach($all_company_list as $val)
{
    ...
    ?>
                ...
                <td><?php echo ucfirst($driver_name)." ".ucfirst($driver_lastname); ?></td>
                <td><?php echo $driver_code; ?></td>
                <td><?php echo $create_day; ?></td>
                <td><?php echo $shift_start; ?></td>
                <td><?php echo 1; ?></td>

                <?php /* <td><?php echo $create_day; ?></td> */ ?>
                <?php /* <td><?php echo $status; ?></td> */ ?>
                <?php /* <td><?php echo $login_start;  ?></td>
