...
<div class="export_me_menu_div"> <a class="export_me_menu_div_close"></a>
    <ul>
        <li>
            ...
            <b>:</b>
            <div class="input_box">
                <input type="radio" class='records_type2'  checked value="1"><span>XLS</span>&nbsp;
                <!--<input class='records_type1' type="radio" value="2"><span>PDF</span>-->
                <br>
            </div>
        </li>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$( ".export_me_menu_download" ).live( "click", function() {
			...
			/* Sasi */
			let range = $("#range").val() ? $("#range").val() : "";
			/* End */
			
			$.ajax({
			url:"<?php echo URL_BASE;?>manage/set_ajax_session?set="+send+"&range="+range,
