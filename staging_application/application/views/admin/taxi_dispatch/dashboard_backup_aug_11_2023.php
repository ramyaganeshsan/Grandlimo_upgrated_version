            ...
            <div class="col-md-4 col-md-4-inner <?php echo $class; ?>">
                ...
                ?>
                    ...
                    ?>
                        ...
                        <form style="max-height: 80vh;overflow: auto;" id="defaultForm" method="post" class="form-horizontal" action="<?php echo URL_BASE; ?>taxidispatch/dashboard" enctype="multipart/form-data" --onSubmit="check_passengerexit()">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <?php $field_type = '';
                                    if (isset($postvalue) && array_key_exists('corporate_name', $postvalue)) {
                                        $field_type =  $postvalue['corporate_name'];
                                    } ?>
                                    <select style="padding:0;" name="corporate_name" id="corporate_name" class="form-control" title="<?php echo __('select_corporate_company'); ?>" >
                                        <option value=""><?php echo __('select_corporate_company'); ?></option>
                                        <?php
                                        foreach ($corporate_list as $list) { ?>
                                            <option value="<?php echo $list['corporate_name']; ?>" <?php if ($field_type == $list['corporate_name']) {
                                                                                                    echo 'selected=selected';
                                                                                                } ?>><?php echo ucfirst($list['corporate_name']); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <form id="defaultForm_edit" method="post" class="form-horizontal" action="<?php echo URL_BASE; ?>taxidispatch/dashboard" enctype="multipart/form-data" --onSubmit="change_email_phone_exit()">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <select style="padding:0;" name="edit_corporate_name" id="edit_corporate_name" class="form-control" title="<?php echo __('corporate_company'); ?>" >
                                            <option value=""><?php echo __('select_corporate_company'); ?></option>
                                            <?php
                                            foreach ($corporate_list as $list) { ?>
                                                <option value="<?php echo $list['corporate_name']; ?>" <?php if ($field_type == $list['corporate_name']) {
                    ...
                    <div class="total-earnings-outer">
                        <div class="tab-content">
                            <div class="tab-pane" id="total-earnings" style="display:block;visibility:visible;">
                                ...
                                <ul>
                                    <?php
                                    $total_amt = isset($total_sum[0]['total_sum']) ? $total_sum[0]['total_sum'] : 10000;
                                    $total_pending_amt = isset($total_sum[0]['total_pending']) ? $total_sum[0]['total_pending'] : 100000;
                                    ?>
 ...
 -->
    ...
    <script>
            ...
            $(".edit_reset_btn").on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#edit_corporate_name').val(details.corporate_name);
       ...
       // console.log(longitudeValue,latitudeValue, dropLatitudeValue, dropLongitudeValue, invalidForm );
            ...
            if (invalidForm) {
            var longitudeConfirmation = confirm(
                "There's an issue with fetching data from Google Maps. Do you want to continue?"
            );
