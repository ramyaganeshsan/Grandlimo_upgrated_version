    ...
    <div class="row">
        ...
        <div class="lft_outer">
            ...
            */ ?>
            ...
            <?php /*<div class="total-earnings-outer">
            <div class="tab-content">
                <div class="tab-pane" id="total-earnings" style="display:block;visibility:visible;">
                    ...
                    <ul>
                        <?php
                         $total_amt = isset($total_sum[0]['total_sum']);
                         $total_pending_amt = isset($total_sum[0]['total_pending']);
                         ?>
                        <li><?php echo CURRENCY.$total_amt; ?></li>
                    </ul>
                </div>
            </div>
        </div>*/ ?>
