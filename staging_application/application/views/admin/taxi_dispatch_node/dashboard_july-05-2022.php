  ...
  jQuery.validator.addMethod("country_code_plus", function(value, element) {
	...
	if(knet != 0 && (card != '0' || cash != '0'))
        ...
        if($("#add_err").text()== "")
        {
            ...
            var data = "add_amt="+add_amt+"&cash_pay="+cash+"&card_pay="+card+"&knet_pay="+knet+"&fare_note="+fare_note+"&edit_pass_logid="+findid+"&pending_pay="+pending_pay+"&wallet_pay="+wallet_pay+"&pass_id="+disp_edit_pass_id+"&trip_id="+disp_edit_trip_id+"&prev_pending_pay="+prev_pending_pay + "&discount_wallet=" + discount_wallet_pay;
			...
			//all_booking_manage_list();
                       ...
                       $("#cash_pay #card_pay #knet_pay #add_amt #discount_wallet_pay").val(0);
                       $("#fare_note").value('');
