 ...
 moment-picker="search.to_date" ng-change="manageListing()"  value="" --onChange="all_booking_manage_list_all()"/>
	...
	<div class="taxi_scroll_one_top taxi_scroll_one_top_manage_booking">
		<table cellspacing="0" cellpadding="0" width="100%" align="center" class="dispatch_icons">
			<tr>
				<td>
					<div class="heading_icon_one"><input type="checkbox" name="status_color" value="0" checklist-model="search.status_color"  checklist-value="0" ng-change="manageListing()" --onchange="all_booking_manage_list_all()"></div>
					<label>Assign</label>
				</td>
				<td>
