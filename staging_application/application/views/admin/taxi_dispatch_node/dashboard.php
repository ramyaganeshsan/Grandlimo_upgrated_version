...
<script type="text/javascript" src="<?php echo URL_BASE; ?>public/js/angular/dashboard.js"></script>

<!-- Sasidharan aug 15 2022 -->
<!-- Modal -->
<div class="modal fade" id="last_four_drivers" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><?php echo __('Driver list for last 4 trips'); ?></h4>
            </div>
            <div class="modal-body">
                <div id="last_four_drivers_list">
                </div>
            </div>
...
<div class="container taxi_dispatcher" ng-controller="DashboardController">
    <div class="row">
        <!-- form: -->
        <div class="lft_outer">
                    ...
                    <div>
                        ...
                        <div class="payment_info_content">
                            <table>
                                <tr>
                                    <td>
                                        <label><?php echo __('cash'); ?>:&nbsp;</label>
                                    </td>
                                    <td><input class="form-control pay" type="text" name="cash_pay" id="cash_pay" value=0></td>
                                </tr>
                                <tr>
                                    <td><label><?php echo __('card'); ?>:&nbsp;</label></td>
                                    <td><input class="form-control pay" type="text" name="card_pay" id="card_pay" value=0></td>
                                </tr>
                                <tr>
                                    <td><label><?php echo __('online_knet'); ?>:&nbsp;</label></td>
                                    <td><input readonly="readonly" class="form-control pay" type="text" name="knet_pay_show_show" id='knet_pay' value=0></td>
                                </tr>
                                <tr>
                                    <td><label><?php echo __('wallet_label'); ?>:&nbsp;</label></td>
                                    <td><input readonly="readonly" class="form-control pay" type="text" name="wallet_pay_show" id='wallet_pay' value=0></td>
                                </tr>
                                <tr>
                                    <td><label><?php echo __('discount_wallet_label'); ?>:&nbsp;</label></td>
                                    <td><input readonly="readonly" class="form-control pay" type="text" name="discount_wallet_show" id='discount_wallet' value=0></td>
                                </tr>
                                <tr>
                                    <td><label><?php echo __('pending_payment_label'); ?>:&nbsp;</label></td>
                                    <td><input class="form-control pay" type="text" name="pending_pay" id='pending_pay' value=0></td>
                                </tr>
                                ...
                                <tr>
                                    <td> <label><?php echo __('additional_amount'); ?>:&nbsp;</label></td>
                                    <td><input class="form-control pay" type="text" name="add_amt" id="add_amt" value=''></td>
                                </tr>
                                ...
                                <tr>
                                    <td><label><?php echo __('fare_note'); ?>:&nbsp;</label></td>
                                    <td><textarea rows='2' cols='20' name='fare_note' id='fare_note'></textarea></td>
                                </tr>
            ...
            <div class="col-md-4 col-md-4-inner <?php echo $class; ?>">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <?php if ($_SESSION['user_type'] == "A") { ?>
                        <li>
                            <select style="cursor:pointer;" name="select_company" id="select_company" ng-model="search.company_id" onchange="all_booking_manage_list();driver_list_with_status();">
                                <option value="0">All Company</option>
                                <?php foreach ($get_active_company_details as $company) { ?>
                                    <option value="<?php echo $company['cid']; ?>" <?php if ($company['cid'] == COMPANY_CID) {
                                                                                        echo "selected";
                                                                                    } ?>><?php echo ucfirst($company['company_name']); ?></option>
                                <?php } ?>
                            </select>
                        </li>

                        <li>
                            <select style="cursor:pointer;" name="select_taxi_model" id="select_taxi_model" ng-change="refreshListing()" ng-model="search.model_id" ">
                                <option value="">All Vehicle</option>
                                <?php foreach ($model_details as $model) { ?>
                                        <option value=" <?php echo $model['model_id']; ?>"><?php echo ucfirst($model['model_name']); ?></option>
                            <?php } ?>
                            </select>
                            <select style="cursor:pointer;" name="select_trip_type" id="select_trip_type" ng-change="refreshListing()" ng-model="search.trip_type">
                                ...
                                <option value="<?php echo __('book_later_hourly'); ?>"><?php echo __('book_later_hourly'); ?></option>
                                <option value="<?php echo __('airport'); ?>"><?php echo __('airport'); ?></option>
                                <option value="<?php echo __('zone'); ?>"><?php echo __('zone'); ?></option>
                ...
                ?>
                    ...
                    ?>
                        ...
                        <form id="defaultForm" method="post" class="form-horizontal" action="<?php echo URL_BASE; ?>taxidispatchnode/dashboard" enctype="multipart/form-data" --onSubmit="check_passengerexit()">
                            <div class="row">
                            ...
                            <div class="form-group col-lg-5_taxi_dispatcher">
                                <div class="col-lg-12">
                                    <select style="padding:0;" name="fav_locations" id="fav_locations" class="form-control" title="<?php echo __('select_favourite_location'); ?>">
                                        <option value=""><?php echo __('Select favorite locations'); ?></option>
                                    </select>
                                </div>

                                <!--<div class="col-lg-12">
                                                    <input type="radio" name="choose_fav_place" value="1" onclick="AddPickupDropPlace(1);"> Pickup<br>
                                                    <input type="radio" name="choose_fav_place" value="2" onclick="AddPickupDropPlace(2);"> Drop<br>
                                                </div> -->

                                <div class="col-lg-12">
                                    <div class="tab">
                                        <a onclick="AddPickupDropPlace(1);">Pickup</a>
                                        <a onclick="AddPickupDropPlace(2);">Drop</a>
                                    </div>
                                </div>
                               ...
                               <div class="col-lg-12">
                                  <div class="tab">
                                     <a onclick="getAirportPickupLocation(1);">Airport Pickup</a>
                                     <a onclick="getAirportPickupLocation(2);">Airport Drop</a>
                                  </div>
                               </div>
                                ...
                                <div class="col-lg-12">
                                    <?php $field_type = '';
                                    if (isset($postvalue) && array_key_exists('taxi_model', $postvalue)) {
                                        $field_type =  $postvalue['taxi_model'];
                                    } ?>
                                ...
                                <?php if (GIFT_CARD_ENABLE == 1) { ?>
                                    <div class="col-lg-12">
                                        <input type="radio" name="choose_giftcard" value="1" onclick="chooseGiftCard(1);">Promocode <br>
                                        <input type="radio" name="choose_giftcard" value="2" onclick="chooseGiftCard(2);">Gift card<br>
                                    </div>
                                    <div class="col-lg-12" id="promo_block">
                                    ...
                                    <div class="col-lg-12" id="giftcard_block">
                                        <input type="text" class="form-control" name="giftcard" id="giftcard" OnChange="validate_giftcard(this.value);" autocomplete="off" placeholder="<?php echo __('giftcardnumber'); ?>" />
                                    </div>
                               ...
                               <div class="col-lg-12">
                                  <input type="text" class="form-control" name="corporate_promocode" id="corporate_promocode" maxlength="30" placeholder="<?php echo __('corporate_promocode'); ?>" autocomplete="off" />
                               </div>
                                ...
                                <div class="<?php echo $payment_class; ?> row_payment" style="width:100%; padding-left: 0px;">
                                    <div class="col-lg-5">
                                        ...
                                        <ul class="payment_inner">
                                            ...
                                            <li>
                                                <label><?php echo __('distance'); ?>:&nbsp;</label><span id="find_km"><?php //echo __('zero_distance'); 
                                                                                                                        ?></span>
                                            </li>
                            ...
                            <input type="hidden" name="airport_pickup" id="airport_pickup" value="">
                            <input type="hidden" name="airport_type" id="airport_type" value="">
                            <input type="hidden" name="zone_fare_applicable" id="zone_fare_applicable" value="">
                            <input type="hidden" name="zone_fare_type" id="zone_fare_type" value="">
                        ...
                        <div id="edit_book_tab" class="<?php echo $edit_book_tab; ?>">
                            ...
                            ?>
                            <form id="defaultForm_edit" method="post" class="form-horizontal" action="<?php echo URL_BASE; ?>taxidispatchnode/dashboard" enctype="multipart/form-data" --onSubmit="change_email_phone_exit()">
                                <div class="row">
                                    <h4><?php echo strtoupper(__('passengers_information')); ?></h4>
                                    <div class="form-group">
                                ...
                                <div class="form-group col-lg-5_taxi_dispatcher">
                                    <div class="col-lg-12">
                                        <select style="padding:0;" name="edit_fav_locations" id="edit_fav_locations" class="form-control" title="<?php echo __('select_favourite_location'); ?>">
                                            <option value=""><?php echo __('Select favorite locations'); ?></option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="tab">
                                            <a onclick="EditPickupDropPlace(1);">Pickup</a>
                                            <a onclick="EditPickupDropPlace(2);">Drop</a>
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-lg-12">
                                      <div class="tab">
                                         <a onclick="getAirportPickupLocationEdit(1);">Airport Pickup</a>
                                         <a onclick="getAirportPickupLocationEdit(2);">Airport Drop</a>
                                      </div>
                                   </div>
                                    ...
                                    <?php if (GIFT_CARD_ENABLE == 1) { ?>
                                        <div class="col-lg-12">
                                            <input type="radio" name="edit_choose_giftcard" value="1" onclick="editChooseGiftCard(1);">Promocode <br>
                                            <input type="radio" name="edit_choose_giftcard" value="2" onclick="editChooseGiftCard(2);">Gift card<br>
                                        </div>
                                        <div class="col-lg-12" id="edit_promo_block">
                                                ...
                                                <?php if (count($promo_res_edit)) {
                                                    ...
                                                    foreach ($promo_res_edit as $val) {
                                                        ...
                                                        if (!in_array($val['promocode'], $promo_arr)) {
                                                            ...
                                                            <option value="<?php echo $val['promocode']; ?>"><?php echo $disp_data; ?></option>';
                                                <?php   }
                                                    }
                                                } ?>
                                            </select>
                                        ...
                                        <div class="col-lg-12" id="edit_giftcard_block">
                                            <input type="text" class="form-control" name="edit_giftcard" id="edit_giftcard" OnChange="validate_giftcard(this.value);" autocomplete="off" placeholder="<?php echo __('giftcardnumber'); ?>" />
                                        </div>
                                    ...
                                    <!--  Sasidharan aug 7 2022  -->
                                     <div class="col-lg-12">
                                        <input type="text" class="form-control" name="edit_corporate_promocode" id="edit_corporate_promocode" maxlength="30" placeholder="<?php echo __('corporate_promocode'); ?>" autocomplete="off" />
                                     </div>
                                ...
                                <input type="hidden" name="edit_airport_pickup" id="edit_airport_pickup" value="">
                                <input type="hidden" name="edit_airport_type" id="edit_airport_type" value="">
                                <input type="hidden" name="edit_zone_fare_applicable" id="edit_zone_fare_applicable" value="">
                                <input type="hidden" name="edit_zone_fare_type" id="edit_zone_fare_type" value="">
            ...
            */ ?>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <div class="tab-pane" id="active_driver"></div> -->
                            ...
                            <div class="tab-pane active" id="all_drivers">
                                <h4><?php echo __('driver_details'); ?><span id="driver_dets_count">(A - {{activecount}}, In - {{freeincount}}, Out - {{freeoutcount}}, B - {{busycount}})</span> </h4>
                                <ul class="driver_details" ng-if="driverlist.length > 0">
                                    <li class="driver_status_li_one" ng-repeat="dl in driverlist">
                                        <span style="width:45%;margin-right:5px"><a href="<?php echo URL_BASE; ?>/manage/driverinfo/{{ dl.driver_id }}" target="_blank" title="">{{ dl.name | capitalize}}</a> - {{ dl.driver_code | capitalize }}
                                            <p style="color:GoldenRod;">{{ dl.model_name | capitalize }}</p>
                                        </span>
                                        <span ng-if="dl.gps_enable == 1" style="width:23px;margin-right:5px">
                                            <p><img src="<?php echo URL_BASE; ?>/public/images/gps_green.png"></p>
                                        </span>
                                        <span ng-if="dl.gps_enable == 0" style="width:23px;margin-right:5px">
                                            <p><img src="<?php echo URL_BASE; ?>/public/images/gps_red.png"></p>
                                        </span>
                                        <span ng-if="dl.updatetime_difference > 15" style="width:23px;margin-right:5px">
                                            <p><img src="<?php echo URL_BASE; ?>/public/images/internet_red.png"></p>
                                        </span>
                                        <span ng-if="dl.updatetime_difference <= 15" style="width:23px;margin-right:5px">
                                            <p><img src="<?php echo URL_BASE; ?>/public/images/internet_green.png"></p>
                                        </span>
                                        <span ng-if="dl.driver_status == 'F' && dl.shift_status == 'IN'" class="driver_status_in"><?php echo  __('free_in'); ?></span>
                                        <span ng-if="dl.driver_status == 'A'" class="driver_status_active"><?php echo  __('active'); ?></span>
                                        <span ng-if="dl.driver_status == 'F' && dl.shift_status == 'OUT'" class="driver_status_out"><?php echo  __('free_out'); ?></span>
                                        <span ng-if="dl.driver_status == 'B'" class="driver_status_busy"><?php echo "Busy"; ?></span>
                                    </li>
                                </ul>
                                <!--   <ul ng-if="driverlist.length === undefined  "> -->
                                <ul ng-if="driverlist.length == 0 ">
                                    <li>
                                        <center>No Drivers<center>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="total-earnings-outer">
                        <div class="tab-content">
                            <div class="tab-pane" id="total-earnings" style="display:block;visibility:visible;">
                                ...
                                $month_name = date("M");
                                ?>
                                <h4 class="earning-title">Earnings(<?php echo ucfirst($month_name); ?>)</h4>
                                <ul>
                                    <?php
                                    ...
                                    ?>
                                    <li style="font-size:18;font-weight: 500"><b><span class="currency_amt"><?php echo CURRENCY . ' ' . $total_amt; ?></span><span class='pending_payment_class'>(<?php echo CURRENCY . $total_pending_amt; ?>)</span></b></li>
                                </ul>
                            </div>
                        </div>

                        <div class="tab-content" style="border-left:2px solid green;height: 500px;">
                            <div class="tab-pane" id="total-earnings" style="display:block;visibility:visible;">
                                <?php
                                $day_number = date("d");
                                ...
                                if (($day_number % 100) >= 11 && ($day_number % 100) <= 13)
                                    ...
                                    $day_abbreviation = $day_number . $ends[$day_number % 10];

                                $day_name = $day_abbreviation . ' - ' . date("l");

                                ?>
                                <h4 class="earning-title"><?php echo $day_name; ?></h4>
                                <ul>
                                    <?php
                                    $total_amt_day = isset($total_sum_day[0]['total_sum']) ? $total_sum_day[0]['total_sum'] : 0;
                                    $total_pending_amt_day = isset($total_sum_day[0]['total_pending']) ? $total_sum_day[0]['total_pending'] : 0;
                                    ?>
                                    <li style="font-size:18;font-weight: 500"><b><span><?php echo CURRENCY . ' ' . $total_amt_day; ?></span></b></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="manage_booking_bottom_outer" id="booking_list">
                        <div class="manage_booking_bottom manage_booking_bottom_scroll">
                            ...
                            <div class="taxi_scroll_one_top">
                                <table cellspacing="0" cellpadding="0" width="100%" align="center" class="dispatch_icons">
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            <td>
                                                <div class="heading_icon_one"><input type="checkbox" checklist-model="search.status_color" checklist-value="11" name="status_color" checked value="0, 6, 7, 10" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                                        ...
                                        ?>
                                            <td>
                                                <div class="heading_icon_one"><input type="checkbox" checklist-model="search.status_color" checklist-value="0" name="status_color" checked value="0" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                                                <label>Assign</label>
                                            </td>
                                            <td>
                                                <div class="heading_icon_two"><input type="checkbox" checklist-model="search.status_color" checklist-value="11" name="status_color" checked value="6, 7, 10" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                                        ...
                                        */ ?>
                                        ...
                                        <td>
                                            <div class="heading_icon_four"><input type="checkbox" checklist-model="search.status_color" checklist-value="9" name="status_color" checked value="9" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                                            <label>Trip Confirmed</label>
                                        </td>
                                        <td>
                                            <div class="heading_icon_five"><input type="checkbox" checklist-model="search.status_color" checklist-value="3" name="status_color" checked value="3" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                                            <label>Start To Pickup</label>
                                        </td>
                                        <td>
                                            <div class="heading_icon_six"><input type="checkbox" checklist-model="search.status_color" checklist-value="2" name="status_color" checked value="2" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                                            <label>In Progress</label>
                                        </td>
                                        <td>
                                            <div class="heading_icon_sevan"><input type="checkbox" checklist-model="search.status_color" checklist-value="1" name="status_color" checked value="1" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                                            <label>Trip Completed</label>
                                        </td>
                                        <td>
                                            <div class="heading_icon_eight"><input type="checkbox" checklist-model="search.status_color" checklist-value="5" checked value="5" ng-change="bookingListing()" --onchange="all_booking_manage_list(search)"></div>
                                            <label>Waiting for Payment</label>
                                        </td>
                                        <td>
                                            <input type="hidden" name="status_color_cancel" id="status_color_cancel" value="8">
                                            <div class="heading_icon_nine"><input type="checkbox" checklist-model="search.status_color" checklist-value="8" checked name="status_cancel" id="status_cancel" value="C,R" ng-change="bookingListing()" --onchange="all_booking_manage_list()"></div>
                            ...
                            <div class="manage_booking_outer col-md-12 map_manage_booking" id="map_manage_booking">
                                <md-progress-linear md-mode="indeterminate" ng-show="determinateValue"></md-progress-linear>
                                    ...
                                    <div class="button greyishB"></div>
                                            ...
                                            <div class="overflow-block overflow-block_outer">
                                                ...
                                                <table cellspacing="0" cellpadding="0" class="scroll" width="100%" align="center" id="changetr">
                                                    <thead id="list_thead">
                                                        <tr>
                                                            <td align="center"><?php echo __('booking_time'); ?>
                                                            </td>
 ...
 -->
                                                    ...
                                                    <tbody class="all_booking_manage_scroll" id="all_booking_manage_list">
                                                        ...
                                                        <!--              <tbody class="all_booking_manage_scroll">
                                     <tr ng-repeat="tl in tripList | filter:'' track by $index"  {{tl.bgstyle}}   align="center" class="{{tl.trColorClass}} {{tl.trIconClass}}" id="addtr_{{tl.tripId}}">
                                        <td width="10%" style="border-left:5px solid {{tl.statusColor}}">{{tl.bookingTime}}</td>
                                        <td width="10%" >{{tl.pickupTime}}</td>
                                        <td ng-if="tl.tl.travelStatus == 1" width="5%" style="color:blue;text-decoration:none;"><a style="text-decoration:none;" href="<?php echo URL_BASE ?>/'transaction/transaction_details/{{ tl.tripId }}">{{ tl.tripId }}</a></td>
                                        <td ng-if="tl.tl.travelStatus != 1" width="5%" style="color:blue;">{{ tl.tripId }}</td>
                                        <td width="7%"><span><a style="text-decoration:none;" href="<?php echo URL_BASE; ?>/manage/passengerinfo/{{tl.passengerId}}" target="_blank">{{tl.passengerName }}</a><br/></span>
                                            <span ng-if="tl.passengerWalletAmount >= 0" class='fixed_payment_class'></span>
                                            <span ng-if="passengerWalletAmount < 0" class='pending_payment_class'></span>
                                        </td>
                                        <td width="7%" ng-if="tl.driverName != 0">{{ tl.driverName }} {{ tl.driverPhone }}</td>
                                        <td width="7%" ng-if="tl.driverName == 0">-</td>
                                        <td width="5%">{{ tl.modelName }}</td>
                                        <td width="10%">{{ tl.passengerPhone }}</td>
                                        <td width="11%">{{tl.currentLocation}}<a target="blank" href="{{tl.pickupLink}}">{{tl.pickupLatitude }} {{tl.pickupLongitude}}</a></td>
                                        <td width="11%">{{tl.dropLocation}}<a target="blank" href="{{tl.dropLink}}">{{tl.pickupLatitude }} {{tl.pickupLongitude}}</a></td>
                                        <td width="5%">{{ tl.tripMinutes }} <span ng-bind="updateTimer(tl.estimateTimeRemaining)"></span></td>
                                        <td width="5%">{{ tl.paymentTypeMsg }}</td>
                                        <td width="10%" id = "fare_{{tl.tripId}}">

                                            <span ng-if="tl.travelStatus == 1">{{tl.fare }}</span>
                                            <span ng-if="tl.travelStatus == 1" class='fixed_payment_class' >({{tl.fixedEditFare }})</span>
                                            <span ng-if="tl.travelStatus == 1" class='pending_payment_class'>({{tl.pendingEditFare }})</span>

                                            <a ng-if="tl.travelStatus == 1" class="edit-ico status oddtr" ng-click="editClick(tl.tripId)" name="edit" id="addtrfare_{{tl.tripId}}'" value="Dispatch" ><i class="glyphicon glyphicon-edit">&nbsp;</i></a></td>
                                        <td width="5%">{{ tl.createdUser }}</td>
                                        <td width="6%" title="{{ tl.trIconTitle }}"><div style="color:{{tl.statusColor}}">{{tl.trIconTitle}}</div></td>
                                        <td width="6%" title="{{ tl.tag }}">{{tl.link}}</td>
                                        <td width="5%"><a ng-if="tl.notes != 0 && tl.notes != ''" href="javascript:void(0)" style="color:#000;text-decoration:none;cursor:default;" title=""><img src="<?php echo URL_BASE; ?>/public/images/notes.jpg"></a></td>
                                        <td width="6%">
                                        <a ng-if='tl.edit == 1' class="edit-ico status oddtr" ng-click="editClick(tl.tripId)" name="edit" id="addtr_{{tl.tripId}}'" value="{{ tl.trIconTitle }}" ><i class="glyphicon glyphicon-edit">&nbsp;</i></a>
                                        <a ng-if='tl.cancel == 1' ng-click="cancelClick()" class="remove-ico status cancelBtn" name="cancel" id="cancel_{{tl.tripId}}_{{tl.driverId}}" value="{{ tl.trIconTitle }}" ><i class="glyphicon glyphicon-remove">&nbsp;</i></a>
                                        </td>
                                        <td width="6%">
                                        <button ng-if="tl.travelStatus == 0" type="submit" class="btn btn-outline btn-primary btn-xs update_dispatch" name="update_dispatch" id="update_dispatch_{{tl.tripID}}_{{tl.companyId}}" value="Dispatch" >{{tl.trIconTitle}}</button>

                                        <button ng-if="tl.travelStatus == 1" type="submit" class="btn btn-outline btn-primary btn-xs completed" name="update_dispatch" id="update_dispatch_{{tl.tripId}}" value="Dispatch" >{{tl.trIconTitle}}</button>

                                        <button ng-if="tl.travelStatus == 2" type="submit" class="btn btn-outline btn-primary btn-xs inprogress" name="update_dispatch" id="update_dispatch_{{tl.tipID}}" value="Dispatch" >{{tl.trIconTitle}}</button>

                                        <button ng-if="tl.travelStatus == 3" type="submit" class="btn btn-outline btn-primary btn-xs inprogress" name="update_dispatch" id="update_dispatch_{{tl.tipID}}" value="Dispatch" >{{tl.trIconTitle}}</button>

                                        <button ng-if="tl.travelStatus == 4" type="submit" class="btn btn-outline btn-primary btn-xs cancelled" name="update_dispatch" id="update_dispatch_{{tl.tipID}}" value="Dispatch" >{{tl.trIconTitle}}</button>

                                        <button ng-if="tl.travelStatus == 5" type="submit" class="btn btn-outline btn-primary btn-xs cancelled" name="update_dispatch" id="update_dispatch_{{tl.tipID}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>

                                        <button ng-if="tl.travelStatus == 6" type="submit" class="btn btn-outline btn-primary btn-xs update_dispatch" name="update_dispatch" id="update_dispatch_{{tl.tripID}}_{{tl.companyId}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.travelStatus == 7" type="submit" class="btn btn-outline btn-primary btn-xs waiting_response" name="update_dispatch" id="update_dispatch_{{tl.tripID}}_{{tl.companyId}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.tl.travelStatus == 7 && tl.driverReply == 'C' && tl.driverReply == 'R'" type="submit" class="btn btn-outline btn-primary btn-xs waiting_response" name="update_dispatch" id="update_dispatch_{{tl.tripID}}_{{tl.companyId}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.tl.travelStatus == 7" type="submit" class="btn btn-outline btn-primary btn-xs update_dispatch" name="update_dispatch" id="update_dispatch_{{tl.tripID}}_{{tl.driverId}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.tl.travelStatus == 8" type="submit" class="btn btn-outline btn-primary btn-xs cancelled" name="update_dispatch" id="update_dispatch_{{tl.tripID}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.tl.travelStatus == 9 && tl.driverReply == 'A'" type="submit" class="btn btn-outline btn-primary btn-xs inprogress" name="update_dispatch" id="update_dispatch_{{tl.tripID}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.tl.travelStatus == 9 && tl.driverReply == 'C'" type="submit" class="btn btn-outline btn-primary btn-xs cancelled" name="update_dispatch" id="update_dispatch_{{tl.tripID}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.tl.travelStatus == 9 && tl.driverReply == 'R'" type="submit" class="btn btn-outline btn-primary btn-xs cancelled" name="update_dispatch" id="update_dispatch_{{tl.tripID}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="tl.tl.travelStatus == 10" type="submit" class="btn btn-outline btn-primary btn-xs update_dispatch" name="update_dispatch" id="update_dispatch_{{tl.tripID}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        <button ng-if="confirmStatus == 1" style="background:green;cursor:pointer" type="submit" class="btn btn-outline btn-primary btn-xs confirmBtn"  name="update_confirm" id="confirm_'{{tl.tripId}}_{{tl.companyId}}" value="{{tl.trIconTitle}}" >{{tl.trIconTitle}}</button>
                                        </td>
                                        <td width="5%"></td>
                                        </tr>
                                    </tbody> -->
    ...
    <script type="text/javascript" src="<?php echo URL_BASE; ?>public/js/tdispatchnode_addbooking_new.js"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            /* Sasidharan aug 7 2022 */
              $('#edit_corporate_promocode').click( () => {
                 $('#edit_corporate_promocode').val("");
              });
           ...
           jQuery.validator.addMethod("greaterThenCurrentTime", function(value, element) {
              const currentDate = calcTime('Arabia Standard Time', '+03');
              currentDate.setSeconds(0);
              if(new Date(value) < currentDate) {
                return false;
              }
              return true;
            }, "Pickup date and time should be greater then current date and time.");
            ...
            $("#pay_submit").on('click', function(e) {
                ...
                if ($("#add_err").text() == "") {
                    ...
                    var url_path = "<?php echo URL_BASE; ?>taxidispatchnode/pay_details";
                    $.ajax({
                        type: "POST",
                        url: url_path,
                        data: data,
            ...
            $(".edit_reset_btn").on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#edit_airport_type').val(details.airport_type);
                        $('#edit_airport_pickup').val(details.airport_pickup);
                        $('#edit_zone_fare_applicable').val(details.zone_fare_applicable);
                        $('#edit_zone_fare_type').val(details.zone_fare_type);

                        if (details.gift_card_status == 1) {
                            editChooseGiftCard(2);
                            $('#edit_giftcard').html(details.promocode);
                        } else {
                            editChooseGiftCard(1);
                        }
                    }
                });
            });
...
//Ramya Aug-11-2023
{var confirmationMessage = "There's an issue with fetching data from Google Maps. Kindly refresh your page.";

$("#dispatch").on('click',function(){   
 event.preventDefault();        
    var addValid = $("#defaultForm").valid();
    if(addValid) {
                          var latitudeValue = document.getElementById("pickup_lat").value;
                          var longitudeValue = document.getElementById("pickup_lng").value;
                          var dropLatitudeValue = document.getElementById("drop_lat").value;
                          var dropLongitudeValue = document.getElementById("drop_lng").value;
        ...
        if(dropLocation !== "" ){
           if (dropLatitudeValue !== "" && isNaN(dropLatitudeValue)) {
            invalidForm = true;
           }

            if (dropLongitudeValue !== "" && isNaN(dropLongitudeValue)) {
            invalidForm = true;
             }
          }
        if (invalidForm) {
        var longitudeConfirmation = confirm(confirmationMessage
        );

        if (longitudeConfirmation) {
            location.reload();
        } else { 
...
$("#update_dispatch").on('click',function(){
    ...
    if(editValid) {
    var latitudeValue = document.getElementById("edit_pickup_lat").value;
                        var longitudeValue = document.getElementById("edit_pickup_lng").value;
                        var dropLatitudeValue = document.getElementById("edit_drop_lat").value;
                        var dropLongitudeValue = document.getElementById("edit_drop_lng").value;
                        var dropLocation = document.getElementById("edit_drop_location").value;
        let invalidForm = false;
        ...
        if (longitudeConfirmation) {
            ...
            document.getElementById("edit_pickup_lat").value = "";
            document.getElementById("edit_pickup_lng").value = "";
            document.getElementById("edit_current_location").value = "";
           document.getElementById(" edit_drop_lat").value = "";
           document.getElementById(" edit_drop_lng").value = "";
           document.getElementById("edit_drop_location").value = "";
        }
        } else {  
...
$("#update_submit").on('click', function() {
        ...
        if (longitudeConfirmation) {
            ...
            document.getElementById("edit_current_location").value = "";
           document.getElementById(" edit_drop_lat").value = "";
           document.getElementById(" edit-drop_lng").value = "";
           document.getElementById("edit_drop_location").value = "";
        }
        } else {  

                $('#update_submit').attr('disabled', 'disabled');
                $('#update_submit_id').val("Dispatch");
                document.getElementById('defaultForm_edit').submit();
            }
            }
            return editValid;
...
$("#create").on('click',function(){
      ...
      //   latitudeValue = "sdkjshd";
      // longitudeValue = "dwhdjwh";
      //  dropLatitudeValue = "erewrewr";
      //   dropLongitudeValue = "dsfds";
    ...
    console.log(longitudeValue,latitudeValue, dropLatitudeValue, dropLongitudeValue, invalidForm );
                        ...
                        $.ajax({
                            ...
                            if(details.additional_amount != ''){ $(add_amt).val(details.additional_amount);}*/
                                    ...
                                    if (typeof details.pay == "undefined") {
                                        ...
                                        if (details.faretype == 1) {
                                            $("#cash_pay").val(fare);
                                            $("#cash_pay_show").val(fare);
                                        } else {
                                            $("#cash_pay").val(0);
                                            $("#cash_pay_show").val(0);
                                        }
                                        if (details.faretype == 6) {
                                            $("#card_pay").val(fare);
                                            $("#card_pay_show").val(fare);
                                        } else {
                                            $("#card_pay").val(0);
                                            $("#card_pay_show").val(0);
                                        }
                                        if (details.faretype == 3) {
                                            $("#knet_pay").val(fare);
                                            $("#knet_pay_show").val(fare);
                                        } else {
                                            $("#knet_pay").val(0);
                                            $("#knet_pay_show").val(0);
                                        }
                    ...
                    $("#cancel_reason_submit").unbind('click').click(function(e) {
                        ...
                        if (cancel_reason != '') {
                            ...
                            $.post(url_path, function(response) {
                                ...
                                //socket.emit('check_trip_status',socket_array);								
                                document.location.href = URL_BASE + "taxidispatch/dashboard";
                            });
        ...
        function setMarkers(locObj) {
            //console.log("herereee",locObj);
            $.each(locObj, function(key, loc) {
                // console.log('loc',loc);
                if (!locations[key] && loc.lat !== undefined && loc.lng !== undefined) {
                    //Marker has not yet been made (and there's enough data to create one).
                    console.log("herereeyye");
        ...
        function edit_booking_from_manage(findid) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    /* Sasidharan Nov 4 2022 */
                   let corporate_promocode = details.promocode + "-()()()";
                      if(details?.applied_corporate_promocode != 0) {
                      $('#edit_corporate_promocode').val(corporate_promocode);
                   } else {
                      $('#edit_corporate_promocode').val("");
                   }
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <script type="text/javascript">
                    ...
                    $('#driver_details p').click(function() {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "<?php echo URL_BASE; ?>taxidispatchnode/updatebooking",
                            data: dataS,
                            cache: false,
                            dataType: 'html',
                            success: function(response) {
                                ...
                                window.location = "<?php echo URL_BASE; ?>taxidispatchnode/dashboard";
                            }
            ...
            <div class="modal fade" id="myUpcoming" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" style="display:none">
                ...
                <script type="text/javascript">
                    $('.oddtr').on('click', function() {
                        ...
                        $.ajax({
                            type: "GET",
                            url: BASE_URL + "/taxidispatchnode/edit_booking",
                            data: dataS,
                            cache: false,
                            async: true,
                            contentType: "application/json; charset=utf-8",
                            ...
                            if(details.additional_amount != ''){ $(add_amt).val(details.additional_amount);}*/
                                    ...
                                    if (details.company_id != 0) {
                                        ...
                                        driver_status_dets();*/
                                        //driver_list_with_status();
                                        SocketService.emit('update_booking_list', {});
                                    }
                                }
                    ...
                    $('.update_dispatch').click(function() {
                        ...
                        var logid = thisid.split('_');
                        var data = "company_id=" + logid[3];
                        var url_path = BASE_URL + "taxidispatchnode/checkdispatchsettings";
                        $.ajax({
                            type: "POST",
                            url: url_path,
                            data: data,
                            ...
                            success: function(res) {
                                ...
                                if (setArr.length > 1) {
                                    ...
                                    $(".dispatch_sel").on('click', function() {
                                        var seleVal = $(this).val();
                                        window.location.href = BASE_URL + "taxidispatchnode/dashboard?splid=" + logid[2] + "&taxi_company=" + logid[3] + "&dispatch_type=" + seleVal;
                                    });
                                    //
                                } else {
                                    window.location.href = BASE_URL + "taxidispatchnode/dashboard?splid=" + logid[2] + "&taxi_company=" + logid[3] + "&dispatch_type=" + setArr[0];
                                }
                                ////console.log(setArr.length);return false;
                            },
                            error: function() {
                    ...
                    $(".cancelBtn").on('click', function() {
                        ...
                        var cancel_Submit = confirm('Are you sure you want to Cancel this Booking?');
                        if (cancel_Submit == true) {
                            var cancelArr = $(this).attr('id').split("_");
                            var pass_logid = cancelArr[1];
                            var driver_id = cancelArr[2];
                    ...
                    $("#cancel_reason_submit").unbind('click').click(function(e) {
                        ...
                        $('#cancelmodal').modal('hide');
                        if (cancel_reason != '') {
                            var url_path = URL_BASE + "taxidispatchnode/cancel_booking/?pass_logid=" + pass_logid + "&reason=" + cancel_reason;
                            $.post(url_path, function(response) {
                                ...
                                socket.emit('dispatcher_cancel', driver_id);
                                socket.emit('check_trip_status', socket_array);
                                document.location.href = URL_BASE + "taxidispatchnode/dashboard";
                            });
                    ...
                    $(".confirmBtn").on('click', function() {
                        ...
                        var confirm_Submit = confirm('Are you sure you want to Confirm this Booking? Once confirmed, Notification will be sent to the corresponding Passenger ');
                        if (confirm_Submit == true) {
                            var confirmArr = $(this).attr('id').split("_");
                            var pass_logid = confirmArr[1];
                            var url = URL_BASE + "taxidispatchnode/confirm_booking/?pass_logid=" + pass_logid;
                    ...
                    function validate_giftcard(val, type = 0) {

                        if (val) {
                            var pass_id = $('#passenger_id').val();
                            var dataS = "giftcard=" + trim(val) + '&passenger_id=' + pass_id;
                            $.ajax({
                                type: "GET",
                                url: "<?php echo URL_BASE; ?>taxidispatch/validate_giftcard",
                                data: dataS,
                                cache: false,
                                async: true,
                                contentType: "application/json; charset=utf-8",
                    ...
                    function get_promocode_list(id, phone, $type = 0) {
                        ...
                        var url = SrcPath + "taxidispatch/get_past_places?id=" + id + "&phone=" + phone;
                        $.get(url, {}, function(response) {

                            if ($type == 0) {
                                $('#fav_locations').html(response);
                            } else {
                                $('#edit_fav_locations').html(response);
                            }
                            //console.log(response);
                    ...
                    function GetFavPlace(id) {

                        var url = SrcPath + "taxidispatch/get_past_places?id=" + id;
                        $.get(url, {}, function(response) {
                    ...
                    function ChangePickupDrop(pick_val) {

                        if (pick_val) {
                            var favValue = $("input[name='choose_fav_place']:checked").val();
                            if (favValue) {
                                AddPickupDropPlace(favValue);
                            }
                        }
                    }

                    function chooseGiftCard(val) {
                    ...
                    function editChooseGiftCard(val) {

                        if (val == 2) {
                            $("#edit_promo_block").hide();
                            $("#edit_giftcard_block").show();

                        } else {
                            $("#edit_promo_block").show();
                            $("#edit_giftcard_block").hide();
                        }
                    }

                    function AddPickupDropPlace(val) {

                        var fav_place = $('#fav_locations').val();

                        if (fav_place != '') {

                            var fav_lat = $('select#fav_locations').find(':selected').data('lat');
                            var fav_lng = $('select#fav_locations').find(':selected').data('lng');

                            if (val == 1) {

                                $('#current_location').val(fav_place);
                                $('#pickup_lat').val(fav_lat);
                                $('#pickup_lng').val(fav_lng);
                                $('#current_location').focus();
                                GeocodeFromAddress();

                            } else {

                                $('#drop_location').val(fav_place);
                                $('#drop_lat').val(fav_lat);
                                $('#drop_lng').val(fav_lng);
                                $('#drop_location').focus();
                                GeocodeToAddress();
                            }
                        }
                    ...
                    function EditPickupDropPlace(val) {

                        var fav_place = $('#edit_fav_locations').val();

                        if (fav_place != '') {

                            var fav_lat = $('select#edit_fav_locations').find(':selected').data('lat');
                            var fav_lng = $('select#edit_fav_locations').find(':selected').data('lng');

                            if (val == 1) {

                                $('#edit_current_location').val(fav_place);
                                $('#edit_pickup_lat').val(fav_lat);
                                $('#edit_pickup_lng').val(fav_lng);
                                $('#edit_current_location').focus();
                                //GeocodeFromAddress();

                            } else {

                                $('#edit_drop_location').val(fav_place);
                                $('#edit_drop_lat').val(fav_lat);
                                $('#edit_drop_lng').val(fav_lng);
                                $('#edit_drop_location').focus();
                                //GeocodeToAddress();
                            }
                        }
                    }
                ...
                /* Sasidharan Sep 07 2022 */
   const getAirportPickupLocation = (id) => {

      var terminalDetails = <?php echo json_encode($airportTerminals); ?>;

      Swal.fire({
        title: 'Select Location',
        input: 'select',
        inputOptions: terminalDetails,
        inputPlaceholder: 'Airport Locations',
        ...
        inputValidator: function (value) {
          return new Promise(function (resolve, reject) {
            if (value !== '') {
              ...
              resolve('Please select the location.');
            }
          });
        }
      }).then(function (result) {
        if (result.isConfirmed) {
            let splitLocation = result.value.split("@-@");
            let location = splitLocation[0];
            let latitude = splitLocation[1];
            let longitude = splitLocation[2];

            if (id == 1) {
               $('#current_location').val(location);
               $('#pickup_lat').val(latitude);
               $('#pickup_lng').val(longitude);
               $('#current_location').focus();
               GeocodeFromAddress();
               let latlng = new google.maps.LatLng({lat: parseFloat(latitude), lng: parseFloat(longitude)});

               if($('#drop_lat').val() != "" && $('#drop_lng').val() != "") {
                let latlng_drop = new google.maps.LatLng({lat: parseFloat($('#drop_lat').val()), lng: parseFloat($('#drop_lng').val())});
                    CalculateRoute(latlng,latlng_drop);
               } else {
                GotoLocation(latlng,1);
               }
               ...
               if($('#pickup_lat').val() != "" && $('#pickup_lng').val() != "") {
                let latlng_pickup = new google.maps.LatLng({lat: parseFloat($('#pickup_lat').val()), lng: parseFloat($('#pickup_lng').val())});
                    CalculateRoute(latlng_pickup,latlng);
               } else {
                GotoLocation(latlng,2);
               }
            }
         }
      });
   ...
   const getAirportPickupLocationEdit = (id) => {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            if (id == 1) {
               ...
               $('#edit_pickup_lat').val(latitude);
               $('#edit_pickup_lng').val(longitude);
               $('#edit_current_location').focus();
               edit_GeocodeFromAddress();
               let latlng = new google.maps.LatLng({lat: parseFloat(latitude), lng: parseFloat(longitude)});

               if($('#edit_drop_lat').val() != "" && $('#edit_drop_lng').val() != "") {
                let latlng_drop = new google.maps.LatLng({lat: parseFloat($('#edit_drop_lat').val()), lng: parseFloat($('#edit_drop_lng').val())});
                    edit_CalculateRoute(latlng,latlng_drop);
               } else {
                edit_GotoLocation(latlng,1);
               }

            } else {
               $('#edit_drop_location').val(location);
               $('#edit_drop_lat').val(latitude);
               $('#edit_drop_lng').val(longitude);
               $('#edit_drop_location').focus();
               let latlng = new google.maps.LatLng({lat: parseFloat(latitude), lng: parseFloat(longitude)});
               edit_GeocodeToAddress(latlng);
               if($('#edit_pickup_lat').val() != "" && $('#edit_pickup_lng').val() != "") {
                let latlng_pickup = new google.maps.LatLng({lat: parseFloat($('#edit_pickup_lat').val()), lng: parseFloat($('#edit_pickup_lng').val())});
                    edit_CalculateRoute(latlng_pickup,latlng);
               } else {
                edit_GotoLocation(latlng,2);
               }
            }
         }
      });
...
<!-- Sasidharan oct 1 2022 -->
<script type="text/javascript">
   $(document).on('click', '.fare_info_image', function () {
      let tripId = $(this).attr("data-id");
      var url_path = "<?php echo URL_BASE; ?>taxidispatch/get_trip_info?trip_id="+tripId;
      $.ajax({
          type: "GET",
          url: url_path,
          async: true,
