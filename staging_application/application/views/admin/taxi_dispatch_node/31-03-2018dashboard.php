    ...
    $("#pay_submit").on('click',function(e)
     {
        ...
        var cash_tot = parseFloat(card)+parseFloat(cash)+parseFloat(knet);
        ...
        if($("#add_err").text()== "")
        {
            ...
            var data = "add_amt="+add_amt+"&cash_pay="+cash+"&card_pay="+card+"&knet_pay="+knet+"&fare_note="+fare_note+"&edit_pass_logid="+findid;
