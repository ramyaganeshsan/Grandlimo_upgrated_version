                ...
                <div class="tab-content">
                    ...
                    <ul  class="driver_details" ng-if="driverlist.length > 0">
                        <li class="driver_status_li_one" ng-repeat="dl in driverlist">
                            <span style="width:45%;margin-right:5px"><a href="<?php echo URL_BASE; ?>/manage/driverinfo/{{ dl.driver_id }}" target="_blank" title="">{{ dl.name | capitalize}}</a> - {{ dl.driver_code | capitalize }}<p style="color:GoldenRod;">{{ dl.model_name | capitalize }}</p></span>
