...
<link rel="stylesheet" href="<?php echo URL_BASE;?>public/js/angular/css/angular-moment.css"/>
<link rel="stylesheet" href="<?php echo URL_BASE;?>public/js/angular/css/angular-material.min.css"/>
<link rel="stylesheet" href="<?php echo URL_BASE;?>public/js/angular/css/angular-ngtable.css"/>
...
<div class="taxi_dispatcher_inner" ng-controller="HeaderController">
    <div class="row"> 
        <div class="col-lg-5">
<div id="wrapper" class="toggled">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="<?php echo URL_BASE; ?>taxidispatchnode/dashboard">Dashboard</a>

                </li>
                <li>
                    <a href="<?php echo URL_BASE; ?>taxidispatchnode/manage_booking"><?php echo __('manage_booking'); ?></a>
                </li>
                <li>
                    <a href="<?php echo URL_BASE; ?>taxidispatchnode/manage_complete_booking"><?php echo __('manage_complete_booking'); ?></a>
                </li>
				<li>
                    <a href="<?php echo URL_BASE; ?>taxidispatchnode/recurrent_booking"><?php echo __('recurrent_booking'); ?></a>
                </li>
               <?php /* <li>
                ...
                <li>
                    <a href="<?php echo URL_BASE;?>taxidispatchnode/tdispatch_settings/"><?php echo __('tdispatch_setting'); ?></a>
                </li>
                <?php } ?>
            </ul>
        </div>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 new_menu_top">                       
                        <a href="#menu-toggle" id="menu-toggle">Menu</a>
                        <?php //03 Feb 2020 ?> 
                       
                       <?php if(SURGE_PRICING == 1) { ?>
							<?php //26 feb 2021 echo new View("admin/surge_pricing/surge_pricing_top"); ?>
                       <?php } ?>
                       <?php //03 Feb 2020 ?> 
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <a class="logo" href="<?php echo URL_BASE; ?>taxidispatchnode/dashboard" title="logo">
            <?php if(COMPANY_CID > 1)
			{ 
				$company_logo = $_SERVER['DOCUMENT_ROOT'].'/'.SITE_LOGO_IMGPATH.SUBDOMAIN.'.png';
				if(file_exists($company_logo))
        ...
        <div class="col-lg-5 rgt_menu">       
            ...
            <ul>
				<?php if($_SESSION['user_type']=="A") { ?>
					<li><a href="<?php echo URL_BASE; ?>admin/dashboard" title="Go to">Goto Admin</a>                    
</li>
				...
				<?php }	else if($_SESSION['user_type']=="M") { ?>
					<?php /*<li><a href="<?php echo URL_BASE; ?>manager/dashboard" title="Go to">Goto Dispatcher</a></li>*/ ?>
					<li><a href="<?php echo URL_BASE; ?>manager/logout" title="Logout">Logout</a></li>
				<?php }  ?>
                <li><button class="btn btn-primary" ng-click="refreshListing()">Refresh</button>
                    </li>
...
<?php //03 Feb 2020 ?> 
<?php if(SURGE_PRICING == 1) { ?>
	<?php echo new View("admin/surge_pricing/surge_pricing_bottom"); ?>
<?php } ?>
<?php //03 Feb 2020 ?>   
