                ...
                <div class="tab-content">
                    ...
                    <ul  class="driver_details" ng-if="driverlist.length > 0">
                        <li class="driver_status_li_one" ng-repeat="dl in driverlist">
                            <span style="width:45%;margin-right:5px"><a href="<?php echo URL_BASE; ?>/manage/driverinfo/{{ dl.driver_id }}" target="_blank" title="">{{ dl.name | capitalize}}</a> - {{ dl.driver_code | capitalize }}<p style="color:GoldenRod;">{{ dl.model_name | capitalize }}</p>
                            <p ng-if="dl.trip_remaining_time" style="color:green;">{{ dl.trip_remaining_time }}</p>
                            </span>
                            <span ng-if="dl.gps_enable == 1" style="width:23px;margin-right:5px"><p><img src="<?php echo URL_BASE; ?>/public/images/gps_green.png"></p></span>
                            <span ng-if="dl.gps_enable == 0" style="width:23px;margin-right:5px"><p><img src="<?php echo URL_BASE; ?>/public/images/gps_red.png"></p></span>
                            <span ng-if="dl.updatetime_difference > 15" style="width:23px;margin-right:5px"><p><img src="<?php echo URL_BASE; ?>/public/images/internet_red.png"></p></span>
                            <span ng-if="dl.updatetime_difference <= 15" style="width:23px;margin-right:5px"><p><img src="<?php echo URL_BASE; ?>/public/images/internet_green.png"></p></span>
                  ...
                  <!--   <ul ng-if="driverlist.length === undefined  "> -->
                    <ul ng-if="driverlist.length == 0 ">
                        <li><center>No Drivers<center></li>
                    </ul>
                </div>
                   ...
                   /* Sasidharan Dec 2 2022 */
                    ...
                    $.ajax({
                        ...
                        success: function(response) 
                        {
                            ...
                            /* Sasidharan Jan 31 2023 */
                            let enable_fare_edit = false;
                            if(details.travel_status == 1 && enable_fare_edit)
                            {
