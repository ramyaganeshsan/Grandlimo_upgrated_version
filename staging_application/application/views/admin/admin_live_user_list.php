...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		...
		<form method="get" class="form" name="frmusers" id="frmusers" action="live_users">
...
<?php if ($total_users > 0) { ?>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td><?php echo $sno; ?></td>
		<td><a href="<?php echo URL_BASE.'manage/userinfo/'.$listings['_id'];?>"><?php echo wordwrap(ucfirst($listings['name']),30,'<br/>',1); ?></a></td>
