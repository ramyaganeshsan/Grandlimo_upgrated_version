    ...
    <div class="cont_container mt15 mt10">
       <div class="content_middle">    
         <form name="edit_sms_template" id="edit_sms_template" class="form" action="" method="post" enctype="multipart/form-data">
			<table border="0" cellpadding="5" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td>
						...
						<input type="text"  maxlength="30" minlength="2"  title="Enter the name" placeholder="Enter the name" name="name" value="<?php echo isset($post_values['name'])?$post_values['name']:''; ?>" required/>
              <?php if(isset($errors) && array_key_exists('name',$errors)){ echo "<span class='error'>".ucfirst($errors['name'])."</span>";}?>
				...
				<tr>
					...
					<td>
						<div class="new_input_field2" style="width:50%">
						<input type="text"  maxlength="30" minlength="2"  title="Enter skype detail" placeholder="Enter skype detail" id="skype" name="skype" value="<?php echo isset($post_values['skype'])?$post_values['skype']:''; ?>" required/>
              <?php if(isset($errors) && array_key_exists('skype',$errors)){ echo "<span class='error'>".ucfirst($errors['skype'])."</span>";}?>
				...
				<tr>
					...
					<td>
						...
						<textarea rows="7" cols="35" style="width: 50% !important;" placeholder="Please enter text within 200 characters" maxlength="200" required name="description" id="description" rows="7" cols="35"><?php echo isset($post_values['description'])?$post_values['description']:'';?></textarea>
				...
				<tr>
					...
					<td>
						<div class="new_input_field2">
						<textarea rows="7" cols="35" style="width: 50% !important;" placeholder="Please enter text within 200 characters" maxlength="200" required name="description_arabic" id="description_arabic" rows="7" cols="35"><?php echo isset($post_values['description_arabic'])?$post_values['description_arabic']:'';?></textarea>
				...
				<tr>
					<td valign="top" width="20%"><label><?php echo __('image'); ?> ( 89 * 89 )</label><span class="star">*</span></td>
					<td>
						<div class="new_input_field2">
			...
			<?php 
				if(isset($post_values['status']) && $post_values['status'] ==1 ){
					$status = 'checked';
				}else{
					$status = '';
				}
