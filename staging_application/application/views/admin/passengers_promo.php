		   ...
		   <tr>
			   ...
			   <td>
				   ...
				   <div class="new_input_field">
					 <select name="company" id="company" onchange="checkpromocode('');get_users('');" style="width:200px;" > <!--class="required" onchange="get_company_promo(this.value)" -->
			   ...
			   <td>
				   ...
				   <div class="new_input_field">
					 <select name="mail_type" id="mail_type" onchange="get_users(this.value);" style="width:200px;" class="required">
                                    		...
                                    		<?php /* <option value="1" selected><?php echo __('all_passenger');?></option> */?>                                    		<option value="2"><?php echo __('corporate_account');?></option>  
									</select>
					  <?php /* if(isset($errors) && array_key_exists('country_name',$errors)){ echo "<span class='error'>".ucfirst($errors['country_name'])."</span>";} */?>
				   </div>
				</td>
...
<!--			  <input type="hidden" name="mail_type" id="mail_type" value="2" />-->
		  ...
		  <tr>
			<td valign="top" width="20%"><label><?php echo __('coupon_packages'); ?></label><span class="star">*</span></td>        
			   <td>
			   <div class="new_input_field">
		   	  <select name="package" id="package" class="required" style="width:200px;" onchange="show_fixed_fare();"><option value=""><?php echo __('select'); ?></option>	
           ...
           <td valign="top" width="20%"><label><?php echo __('fixed_fare_amount'); ?><span class="star">*</span></td>        
			   <td>
			   <div class="new_input_field">
           ...
           <!-- Sasidharan api 15 2022 -->
           <tr>
           		<td valign="top" width="20%"><label><?php echo __('total_airport_trips'); ?></label><span class="star">*</span></td>        
			   <td>
			   	<div class="new_input_field">
					<input type="text" class="required onlynumbers" title="" name="total_airport_trips" id="total_airport_trips" min="0" value="" maxlength="5"  />
		   		</div>
           		</td>   	
           </tr>
          	<tr>
				<td></td>
				<td>
	              <label><input value="1" type="checkbox" name="corporate_promocode" id="corporate_promocode"  />
           ...
           <tr>
				<td></td>
				<td>
	              <label><input value="1" type="checkbox" name="register_promocode" id="register_promocode"  />
		   ...
		   <tr>
				<td></td>
				<td>
	              <label><input value="1" type="checkbox" name="skipCard" id="skipCard"  />
           ...
           <tr>
				<td></td>
				<td>
	              <label><input value="1" type="checkbox" name="apply_user_limit" id="apply_user_limit"  />
           ...
           <tr>
			   	...
			   	<td>
				   	<div class="new_input_field">
				   		<input disabled type="text" class="required onlynumbers" title="" name="maximum_allowed_limit" id="maximum_allowed_limit" min="0" value="0" maxlength="5"  />
           ...
           <tr>
			   	...
			   	<td>
			           ...
			           <select disabled id="corporate_group" name="corporate_group">
				           	<option value="">Corporate Group</option>
				           	<?php foreach($corporateGroups as $value) { ?>
				           		<option value="<?php echo $value['_id'] ?>"><?php echo $value['group_name'] ?></option>
				           	<?php } ?>
			           </select>
			           	<br />
...
$("#send_promocode").click( (event) => {
	...
	// console.log(corporatePromocode, corporateGroup);
		submitStatus = false;
