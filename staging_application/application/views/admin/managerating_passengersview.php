			...
			if($ListCount>0){
			   ...
			   <div class="review" style="float:left;width:100%"/>
				   ...
				   <div class="review-text">
					   ...
					   <?php if($comments){ ?> 
					   <div style="float:right;display:none;"><a title="<?php echo __('del_comment'); ?>" href="<?php echo URL_BASE.'manage/update_comments/'.$passengers_log_id; ?>" class="deleteicon"></a></div>
					   <?php } 
					    echo $title;
					    ?>
