...
<?php if ($total_users >0 && is_array($promocode_list)) { ?>
   ...
   ?>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td align="center" width="20" colspan='0' ><?php echo '<a href='.URL_BASE.'edit/promocode/'.$promodetails['passenger_promoid'].' " title ="Edit" class="editicon"></a>' ; ?> 
		<?php echo '<a href='.URL_BASE.'manage/delete_promocode/'.$promodetails['passenger_promoid'].' " title ="Edit" class="deleteicon" onclick="return confirm(`Are you sure to delete?`)"></a>' ; ?>
