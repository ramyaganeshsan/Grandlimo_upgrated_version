...
<!--			  <input type="hidden" name="mail_type" id="mail_type" value="2" />-->
		  ...
		  <tr>
			<td valign="top" width="20%"><label><?php echo __('coupon_packages'); ?></label><span class="star">*</span></td>        
			   <td>
			   <div class="new_input_field">
		   	  <select name="package" id="package" class="required" style="width:200px;"><option value=""><?php echo __('select'); ?></option>	
		   	  <?php foreach($avail_package as $package){ ?>
				  <option value="<?php echo $package['_id'];?>"><?php echo ucfirst($package['coupon_package_name']);?></option>
				  <?php } ?>
		   	  </select>
