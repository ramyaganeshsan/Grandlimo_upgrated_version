...
?>
    ...
    <tr class="vip_user_section"  <?php if($vip_user == 0){ echo "style='display:none'"; }  ?>>
	...
	<div class="new_input_field">
              ...
              <?php if(isset($errors) && array_key_exists('lateral_start_date',$errors)){ echo "<span class='error'>".ucfirst($errors['lateral_start_date'])."</span>";}?>
	</div>
	</td>   	
	</tr>
	...
	<div class="new_input_field">
             <div class="new_input_field">
              ...
              <?php if(isset($errors) && array_key_exists('lateral_end_date',$errors)){ echo "<span class='error'>".ucfirst($errors['lateral_end_date'])."</span>";}?>
	</div>
	</div>
	</td>   	
	</tr>
...
<script type="text/javascript">
 $(document).ready(function(){
 	...
 	$("#lateral_end_date").datepicker({dateFormat: "yy-mm-dd",
        changeMonth: true,
        changeYear: true,
        maxDate: "80Y",
        //minDate: "-100Y",
 	...
 	$("#lateral_start_date").datepicker({dateFormat: "yy-mm-dd",
        changeMonth: true,
        changeYear: true,
        maxDate: "80Y",
        //minDate: "-100Y",
