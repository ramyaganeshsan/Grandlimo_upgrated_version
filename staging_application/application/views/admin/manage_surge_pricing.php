...
<div class="container_content fl clr">
	<div class="cont_container mt15 mt10">
		<div class="content_middle">
			<form method="get" class="form" name="manage_model" id="manage_model" action="surge_pricing">
			...
			<span><?php echo __('status_label'); ?></span>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/surge_pricing'" />
                            </div>
                        </td>
                    </tr>
                </table>
	...
	<tbody>			
        ...
        <tr class="<?php echo $trcolor; ?>">
                    ...
                    <td align="center" width="100"> 
                         <?php 
                            if($listings['surge_pricing_status']=='A') {
								$txt = "Active"; $class ="unsuspendicon";
							} elseif($listings['surge_pricing_status']=='T'){
			...
			<td align="center" width="20" colspan='3' ><?php echo '<a href='.URL_BASE.'edit/surge_pricing/'.$listings['_id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
          ...
          <div class="select_all">
                ...
                <span style="padding-left:10px;">
                    <select name="more_action" id="more_action">
                        ...
                        <option value="block_surge_pricing_model_request" ><?php echo __('Block'); ?></option>
                        <option value="active_surge_pricing_model_request" ><?php echo __('Active'); ?></option>                        
                    </select>
                 </span>
	        </div>
<?php } ?>
...
$('#more_action').change(function() {
	...
	switch (selected_val){
		...
		//===================================
		case "block_surge_pricing_model_request":
			...
			if($('input[type="checkbox"]').is(':checked')) {
				 ...
				 if(ans){
					 document.manage_model.action="<?php echo URL_BASE;?>manage/block_surge_pricing_model_request/index";
		...
		//=========================
		case "active_surge_pricing_model_request":
			...
			if($('input[type="checkbox"]').is(':checked')) {
				 var ans = confirm(confirm_msg)
				 if(ans){
					 document.manage_model.action="<?php echo URL_BASE;?>manage/active_surge_pricing_model_request/index";
					 document.manage_model.submit();
				 }else{
					$('#more_action').val('');
				 }		
