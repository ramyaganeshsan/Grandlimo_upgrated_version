			...
			<table class="0" cellpadding="5" cellspacing="0">
				<tr>
					<td>
						...
						<input type="text" class="required" title="<?php echo __('enter_account_type_label'); ?>" name="account_type" id="account_type" value="<?php if(isset($postvalue) && array_key_exists('account_type',$postvalue)){ echo $postvalue['account_type']; }?>" >					
				...
				<tr>
					<td>
						...
						<div class="new_input_field">
						<input type="text" class="required" title="<?php echo __('enter_account_type_label'); ?>" name="account_type_arabic" id="account_type_arabic" value="<?php if(isset($postvalue) && array_key_exists('account_type_arabic',$postvalue)){ echo $postvalue['account_type_arabic']; }?>" >					
