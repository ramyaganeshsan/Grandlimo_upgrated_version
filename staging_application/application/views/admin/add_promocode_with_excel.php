...
<div class="container_content fl clr">
   <div class="cont_container mt15 mt10">
      ...
      <?php if(!isset($appliedStatus)) { ?>

      <div class="content_middle">
         <form method="POST" class="form" name="frmusers" id="frmusers" action="add_promocode_with_excel_file">
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
               ...
               <tr>
                  ...
                  <td>
                     <div class="new_input_field">
                        <input type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" title="<?php echo __('enterthepromocode'); ?>" name="promo_code_file" id="promo_code_file" />
                     </div>
                  </td>
               </tr>
               <!-- <input type="hidden" name="promo_code" value="uuukkd" /> -->
      ...
      <?php if(isset($appliedStatus) && count($appliedStatus) > 0) { ?>
         <div class="table" id="table"> 
            <table cellspacing="1" cellpadding="10" width="100%" style="border-top:1px solid #cdcdcd;" align="center" class="sTable responsive">
               ...
               <tbody>
                  <?php
                     $sno=$Offset; 
                     foreach($appliedStatus as $listings) {
                        $sno++;
                        $trcolor=($sno%2==0) ? 'oddtr' : 'eventr'; 
                  ?>
                     <tr class="<?php echo $trcolor; ?>">
                        <td align="center"><?php echo $sno; ?></td>
                        <td><?php echo isset($listings['promocode']) ? $listings['promocode'] : '-'; ?></td>
                        <td><?php echo isset($listings['status']) ? $listings['status'] : '-'; ?></td>
                     </tr>
                  <?php } ?>
               </tbody>
            </table>
