...
<td>
<div class="new_input_field">
      <input type="text" title="<?php echo __('enter_coupon_package_name_ar'); ?>" 
             class="required" 
             name="coupon_package_name_ar" 
             id="coupon_package_name_ar"
             value="<?php if(isset($postvalue) && array_key_exists('coupon_package_name_ar',$postvalue)){ 
                 echo $postvalue['coupon_package_name_ar']; 
             }?>"  
             maxlength="100" />
      <?php 
      if(isset($errors) && array_key_exists('coupon_package_name_ar',$errors)){ 
          echo "<span class='error'>".ucfirst($errors['coupon_package_name_ar'])."</span>";
      }
      ?>
</div>
</td>   	
...
<td>
<div class="new_input_field">
      <textarea name="coupon_package_description_ar" 
                id="coupon_package_description_ar" 
                class="required" 
                title="<?php echo __('enter_coupon_package_description_ar'); ?>" 
                rows="7" cols="35"><?php 
                if(isset($postvalue) && array_key_exists('coupon_package_description_ar',$postvalue)){ 
                    echo $postvalue['coupon_package_description_ar']; 
                }?></textarea>

      <?php 
      if(isset($errors) && array_key_exists('coupon_package_description_ar',$errors)){ 
          echo "<span class='error'>".ucfirst($errors['coupon_package_description_ar'])."</span>";
      }
      ?>
</div>
</td>   	
	...
	<tr>
	<td valign="top" width="20%"><label><?php echo __('fixed_fare_apply_this_coupon'); ?></label></td>        
	<td>
	<div class="new_input_field">
		     <input type="checkbox"  maxlength="20" minlength="7"  title="<?php echo __('fixed_fare_apply'); ?>" id="fixed_fare_apply" name="fixed_fare_apply" <?php if($fixed_fare_apply == 1){ echo "checked"; } ?> value="1" /> Apply fixed fare for package 
