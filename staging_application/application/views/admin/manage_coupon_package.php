...
<thead>
	<tr>
		...
		<td align="left" style="text-align:left;" width="12%"><?php echo __('coupon_package_name'); ?></td>
		    <td align="left" style="text-align:left;" width="12%"><?php echo __('coupon_package_name_ar'); ?></td>

		<td align="left" width="18%" style="text-align:left;" width="25%"><?php echo __('coupon_package_description'); ?></td>
		    <td align="left" width="18%" style="text-align:left;"><?php echo __('coupon_package_description_ar'); ?></td>

		<td align="left" width="10%"><?php echo __('corporate_commission').'(%)'; ?></td>
		<td align="left" width="10%"><?php echo __('passenger_commission').'(%)'; ?></td>
		<td align="left" width="10%"><?php echo __('fixed_package'); ?></td>
...
<tbody>		
        ...
        $fixed_fare_apply = isset($listings['fixed_fare_apply'])?$listings['fixed_fare_apply']:0;
        if($fixed_fare_apply==1){
    ...
    <td><?php echo wordwrap(ucfirst($listings['coupon_package_name_ar']),30,'<br/>',1); ?></td>
    <td><?php echo wordwrap($listings['coupon_package_description'],25,1); ?></td>
    <td><?php echo wordwrap($listings['coupon_package_description_ar'],25,1); ?></td>
			...
			<td align="center"><?php echo $fixed_package; ?></td>
