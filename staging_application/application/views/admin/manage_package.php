...
<tbody>		
        ...
        <tr class="<?php echo $trcolor; ?>">
			...
			<td align="center" width="20" colspan='3'><?php echo '<a href='.URL_BASE.'edit/package/'.$listings['_id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
...
function change_order(val)
{
	...
	document.managepackage_form.action="<?php echo URL_BASE;?>manage/order_field_request/index";
		...
		var selected_val= $('#more_action').val();
			...
			switch (selected_val){
					...
					if($('input[type="checkbox"]').is(':checked'))
					{
				   		 ...
				   		 if(ans){
							 document.managepackage_form.action="<?php echo URL_BASE;?>manage/block_package_request/index";
							 document.managepackage_form.submit();
						 }else{
						 	$('#more_action').val('');
						 }
					...
					var confirm_msg =  "<?php echo __('Are you sure want to Activate Request(s)?');?>";
						...
						if($('input[type="checkbox"]').is(':checked'))
						{
					   		 var ans = confirm(confirm_msg)
					   		 if(ans){
								 document.managepackage_form.action="<?php echo URL_BASE;?>manage/active_package_request/index";
								 document.managepackage_form.submit();
							 }else{
							 	$('#more_action').val('');
							 }		
					...
					var confirm_msg =  "<?php echo __('Are you sure want to move Request(s) to Trash ?');?>";
						...
						if($('input[type="checkbox"]').is(':checked'))
						{
					   		 var ans = confirm(confirm_msg)
					   		 if(ans){
								 document.managepackage_form.action="<?php echo URL_BASE;?>manage/trash_package_request/index";
								 document.managepackage_form.submit();
							 }else{
							 	$('#more_action').val('');
							 }		
