...
<table class="list_table1" border="0" width="100%" cellpadding="5" cellspacing="0">
			...
			<div class="selector" id="uniform-user_type">
                            <select class="select2" name="status" id="status" onchange="this.form.submit()">
		                        ...
		                        <option value="D" <?php if($status_val=='D'){ echo 'selected'; } ?>><?php echo __('Block'); ?></option>
		                        <option value="A" <?php if($status_val=='A'){ echo 'selected'; } ?>><?php echo __('Active'); ?></option>
                            </select>
                            </div>
                        </td>
                        </tr>
                        ...
                        <td>
                            ...
                            <div class="button blueB">
                                <input type="button" value="<?php echo __('button_cancel'); ?>" title="<?php echo __('button_cancel'); ?>" onclick="location.href = '<?php echo URL_BASE; ?>manage/careers'" />
                            </div>
                        </td>
                    </tr>
                </table>
...
<?php } ?>
	...
	<thead>
		    <tr>
				...
				<td align="left" style="text-align:left;" width="12%"><?php echo ucfirst(__('careers_decription')); ?></td>				
...
<?php if ($total_users > 0 && count($careers_list)) { ?>
	...
	<tr class="<?php echo $trcolor; ?>">
		...
		<td><?php echo isset($listings['description'])?wordwrap(ucfirst($listings['description']),30,'<br/>',1):""; ?></td>		
		<td><?php echo isset($listings['created_date'])?wordwrap($listings['created_date'],25,'<br />',1):"-"; ?></td>
		
		<td align="center" colspan='3' ><?php echo '<a href='.URL_BASE.'manage/edit_careers/'.$listings['_id'].' " title ="Edit" class="editicon"></a>' ; ?></td>
		</tr>
		<?php } 
 		 } 		 
		//For No Records
