...
<tbody>	
        ...
        ?>     
			...
			<td align="left"><a title="<?php echo ucfirst($listings['driver_name']); ?>" href="<?php echo URL_BASE.'manage/driverinfo/'.$listings['driver__id'];?>"><?php echo wordwrap($listings['driver_name'],30,'<br/>',1); ?></a></td>
      <td><?php echo CURRENCY.$listings['total_amount']; ?>
            <td><?php
               echo CURRENCY.$listings['total_pending_amt']; 
            ?></td>
		</tr>
		<?php } 
 		 } 
