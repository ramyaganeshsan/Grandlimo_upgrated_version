...
<table class="list_table1" border="0" width="65%" cellpadding="5" cellspacing="0">
 <tr>
            ...
            <div class="selector" id="uniform-user_type">
                            <select class="select2" name="recharge_type" id="recharge_type" onchange="this.form.submit()">
                                <option value=""><?php echo __('select_label'); ?></option>    
                                <?php
                                foreach ($recharge_type_array as $status_key => $allstatus) {

                                    $selected_status = ($selected_recharge_type == $status_key) ? ' selected="selected" ' : " ";
                                    ?>  
...
<thead>
    ...
    <td align="left" style="text-align:left;" width="1%"><?php echo __('current_wallet_amt'); ?></td>
        <td align="left" style="text-align:left;" width="1%"><?php echo __('amount_credit'); ?></td>
        <td align="left" style="text-align:left;" width="1%"><?php echo __('amount_debit'); ?></td>
        ...
        <!-- June 8 2023 -->
        <td align="left" style="text-align:left;" width="1%"><?php echo __('redeem_points'); ?></td>
        <td align="left" style="text-align:left;" width="1%"><?php echo __('notes'); ?></td>
...
<tbody>	
		...
		$sno=$Offset; 
         ...
         $fromTap = isset($listings['fromTap']) ? $listings['fromTap'] : 0;
         $initiated_payment = isset($listings['initiated_payment']) ? $listings['initiated_payment'] : 0;
         $tapPaymentGayeway = isset($listings['tapPaymentGayeway']) ? $listings['tapPaymentGayeway'] : 0;
         $paid_status = isset($listings['paid_status']) ? $listings['paid_status'] : 0;
         $paymentToken = (isset($listings['paymentToken']) && !empty($listings['paymentToken'])) ? $listings['paymentToken'] : "";
         $dateTime = new DateTime('2024-09-07 00:00:00');
         $logDate = new DateTime(Commonfunction::convertphpdate('Y-m-d h:i:s',$listings['created_date']));
     ...
     <!--  <td><?php echo isset($listings['passenger_email']) ? wordwrap($listings['passenger_email'],25,'<br />',1) : '-'; ?></td> -->
      ...
      <td><?php echo (is_nan($listings['wallet_amount']) == 1) ?  CURRENCY."0" : CURRENCY.round($listings['wallet_amount'],3); ?>
            <td><?php
            ...
            <td><?php 
             if($listings['change_amount'] < 0)
            {
             echo CURRENCY.'<span class="negative">'.abs($listings['change_amount']).'</span>';
            }
            ?></td>
            ...
            echo $transaction_id;
             ...
             <!-- June 8 2023 -->
            <td><?php echo isset($listings['redeem_points'])?$listings['redeem_points']:'-'; ?></td>

              <td><?php 
            if($listings['recharge_type'] == 10 ){
            echo "Customer intiated payment for adding ".CURRENCY.round($listings['change_amount'],3)." to wallet";
            } else {
            echo isset($listings['notes'])?$listings['notes']:'-';
            }
      ...
      <div class="control-group">       
       ...
       <form  id="add-wallet" class="form-horizontal" role="form">
            <div class="form-group" style="margin-bottom:10px">
                ...
                <div class="col-sm-3"><label><b>Current Discount Wallet Amount</b></label>:  <span ><b id="discount_wallet">KWD 0.00</b></span>
                </div>
              ...
              <div class="col-sm-4">
                Type
                <label class="checkbox"><input class="form-control " name="wallet_type" id="search_by"  type="radio" value="1" checked="checked" maxlength="5" ></label>
                Wallet
                <label class="checkbox"><input class="form-control " name="wallet_type" id="search_by"  type="radio" value="2" maxlength="5" ></label>
                Discount Wallet
              </div> 
         ...
         var options = {
                ...
                list: {
                    onSelectItemEvent: function() {
                        ...
                        /* Sasidharan June 17 2023 */
                        var discount_wallet = $("#passenger_name").getSelectedItemData().discount_wallet;

                        $("#passenger_id").val(selectedItemValue).trigger("change");
                        $("#wallet_amount").html(wallet_amount).trigger("change");

                        /* Sasidharan June 17 2023 */
                        $("#discount_wallet").html(discount_wallet).trigger("change");
                    },
