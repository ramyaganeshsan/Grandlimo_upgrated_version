...
<p><small><?php echo __('Displayed :start-:end of :total', array(':start' => $current_first_item, ':end' => $current_last_item, ':total' => $total_items))?></small></p>
    	...
    	<?php if ($first_page !== FALSE): ?>
    		<li class="fl">
                ...
                <div class="page_mid fl"> <a href="javascript: void(0)" onclick="pagin_transinfo(<?php echo HTML::chars($first_page) ?>)" rel="first" title="First"><strong><?php echo __('First') ?></strong></a></div>
    	...
    	<?php if ($previous_page !== FALSE): ?>
    		<li class="fl">
                  <div class="page_lft fl"></div>
    		<div class="page_mid fl"><a href="javascript: void(0)" onclick="pagin_transinfo(<?php echo HTML::chars($previous_page) ?>)" rel="last" title="Previous"><img src="<?php echo IMGPATH; ?>pagination-right.png" width="5" height="7" alt="Previous" /></a> </div>
                <div class="page_rgt fl"></div>
            </li>
        <?php else: ?>
    	   <li class="fl">
    	...
    	<?php foreach ($links as $number => $content): ?>
    		...
    		<?php else: ?>
    			<div class="page_lft fl"></div>
                <div class="page_mid fl"><a href="javascript: void(0)" onclick="pagin_transinfo(<?php echo HTML::chars($number) ?>)"><?php echo $content ?></a></div>
                <div class="page_rgt fl"></div>
    		<?php endif ?>
            </li>
    	<?php endforeach ?>
		...
		<div class="page_lft fl"></div>
                <div class="page_mid fl"><a href="javascript: void(0)" onclick="pagin_transinfo(<?php echo HTML::chars($next_page) ?>)" rel="Next" title="Next" ><img src="<?php echo IMGPATH; ?>pagination-left.png" width="5" height="7" alt="Next" /></a> </div>
                <div class="page_rgt fl"></div>
    	<?php else: ?>
		<div class="page_lft fl"></div>
		...
		<div class="page_lft fl"></div>
    		<div class="page_mid fl"><a href="javascript: void(0)" onclick="pagin_transinfo(<?php echo HTML::chars($last_page) ?>)" rel="last" title="Last"><strong><?php echo __('Last') ?></strong></a> </div>
                <div class="page_rgt fl"></div>
    	<?php else: ?>
		<div class="page_lft fl"></div>
